...
public class AcceptanceOfOfferForGoodsBuilder {
  ...
  public AcceptanceOfOfferForGoodsBuilder(final IRI iri) {
    this.acceptanceOfOfferForGoods =
        SpatioTemporalExtentServices.createAcceptanceOfOfferForGoods(iri);
  }
   ...
   * @return This builder.
   */
  public final AcceptanceOfOfferForGoodsBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.acceptanceOfOfferForGoods.addValue(AGGREGATED_INTO,
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.acceptanceOfOfferForGoods.addValue(CONSISTS__OF,
                                            spatioTemporalExtent.getId());
    return this;
  }
   ...
   * type where an
   * {@link Activity} {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#CONSISTS_OF} one or more
   * {@link Participant}s.
   *
  ...
  consists_Of_Participant(final Participant participant) {
    this.acceptanceOfOfferForGoods.addValue(CONSISTS_OF_PARTICIPANT,
                                            participant.getId());
    return this;
  }
  ...
  public final AcceptanceOfOfferForGoodsBuilder member_Of(
      final ClassOfSociallyConstructedActivity
          classOfSociallyConstructedActivity) {
    this.acceptanceOfOfferForGoods.addValue(
  ...
  member_Of_Kind_M(final KindOfActivity kindOfActivity) {
    this.acceptanceOfOfferForGoods.addValue(MEMBER_OF_KIND,
                                            kindOfActivity.getId());
    this.acceptanceOfOfferForGoods.addValue(RDFS.RDF_TYPE,
                                            kindOfActivity.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.acceptanceOfOfferForGoods.addValue(PART__OF,
                                            spatioTemporalExtent.getId());
    return this;
  }
   ...
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} relationship type
   * where an
   * {@link AcceptanceOfOfferForGoods} is a {@link
   ...
   */
  public final AcceptanceOfOfferForGoodsBuilder
  part_Of_M(final OfferAndAcceptanceForGoods offerAndAcceptanceForGoods) {
    this.acceptanceOfOfferForGoods.addValue(PART_OF,
                                            offerAndAcceptanceForGoods.getId());
    return this;
  }
  ...
  part_Of_(final AgreementExecution agreementExecution) {
    this.acceptanceOfOfferForGoods.addValue(PART_OF_,
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.acceptanceOfOfferForGoods.addValue(PART_OF_POSSIBLE_WORLD,
                                            possibleWorld.getId());
    return this;
  }
   ...
   */
  public final AcceptanceOfOfferForGoodsBuilder
  references_M(final OfferForGoods offerForGoods) {
  ...
  temporal_Part_Of(final Individual individual) {
    this.acceptanceOfOfferForGoods.addValue(TEMPORAL_PART_OF,
                                            individual.getId());
    return this;
  }

  /**
   * Returns an instance of AcceptanceOfOfferForGoods created from the
   * properties set on this builder.
   *
   * @return The built AcceptanceOfOfferForGoods.
   * @throws HqdmException If the AcceptanceOfOfferForGoods is missing any
