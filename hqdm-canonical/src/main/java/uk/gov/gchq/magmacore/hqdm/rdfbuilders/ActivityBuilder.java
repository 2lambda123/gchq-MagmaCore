...
public class ActivityBuilder {
   ...
   */
  public final ActivityBuilder
  member_Of(final ClassOfActivity classOfActivity) {
   ...
   * where one
   * {@link Activity} may be a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} one or more others.
   *
   * @param activity The Activity.
   * @return This builder.
   */
  ...
  /**
   * Returns an instance of Activity created from the properties set on this
   * builder.
   *
