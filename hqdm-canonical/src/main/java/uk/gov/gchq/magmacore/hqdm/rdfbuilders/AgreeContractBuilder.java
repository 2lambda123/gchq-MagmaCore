...
public class AgreeContractBuilder {
   ...
   * @return This builder.
   */
  public final AgreeContractBuilder
   ...
   */
  public final AgreeContractBuilder
  consists_Of(final AcceptanceOfOffer acceptanceOfOffer) {
   ...
   * type where an
   * {@link AgreeContract} may be a {@link
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.agreeContract.addValue(TEMPORAL__PART_OF,
  ...
  /**
   * Returns an instance of AgreeContract created from the properties set on
   * this builder.
   *
   * @return The built AgreeContract.
   * @throws HqdmException If the AgreeContract is missing any mandatory
   *     properties.
   */
