...
public class AgreementProcessBuilder {
  ...
  public AgreementProcessBuilder(final IRI iri) {
    this.agreementProcess =
        SpatioTemporalExtentServices.createAgreementProcess(iri);
  }
   ...
   * @return This builder.
   */
  public final AgreementProcessBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.agreementProcess.addValue(AGGREGATED_INTO,
   ...
   */
  public final AgreementProcessBuilder
  consists_Of(final ReachingAgreement reachingAgreement) {
   ...
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#CONSISTS_OF} relationship
   * type where an
   * {@link AgreementProcess} consists of at least one {@link
   * AgreementExecution}.
   *
   ...
   */
  public final AgreementProcessBuilder
  consists_Of_(final AgreementExecution agreementExecution) {
  ...
  consists_Of_Participant(final Participant participant) {
    this.agreementProcess.addValue(CONSISTS_OF_PARTICIPANT,
                                   participant.getId());
    return this;
  }
   ...
   * type where an
   * {@link AgreementProcess} may be a {@link
   ...
   */
  public final AgreementProcessBuilder
  member_Of(final ClassOfAgreementProcess classOfAgreementProcess) {
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.agreementProcess.addValue(PART_OF_POSSIBLE_WORLD,
                                   possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.agreementProcess.addValue(TEMPORAL__PART_OF,
                                   spatioTemporalExtent.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of AgreementProcess created from the properties set on
   * this builder.
   *
   * @return The built AgreementProcess.
   * @throws HqdmException If the AgreementProcess is missing any mandatory
   *     properties.
   */
