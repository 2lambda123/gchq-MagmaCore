...
public class AmountOfMoneyBuilder {
   ...
   * @return This builder.
   */
  public final AmountOfMoneyBuilder
   ...
   * type where an
   * {@link AmountOfMoney} may be a {@link
   ...
   */
  public final AmountOfMoneyBuilder
  member_Of(final ClassOfAmountOfMoney classOfAmountOfMoney) {
   ...
   */
  public final AmountOfMoneyBuilder
  member_Of_Currency(final Currency currency) {
  ...
  public final AmountOfMoneyBuilder member_Of_Kind(
    ...
    this.amountOfMoney.addValue(MEMBER_OF_KIND,
                                kindOfSociallyConstructedObject.getId());
    this.amountOfMoney.addValue(RDFS.RDF_TYPE,
                                kindOfSociallyConstructedObject.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.amountOfMoney.addValue(TEMPORAL__PART_OF,
  ...
  /**
   * Returns an instance of AmountOfMoney created from the properties set on
   * this builder.
   *
   * @return The built AmountOfMoney.
   * @throws HqdmException If the AmountOfMoney is missing any mandatory
   *     properties.
   */
