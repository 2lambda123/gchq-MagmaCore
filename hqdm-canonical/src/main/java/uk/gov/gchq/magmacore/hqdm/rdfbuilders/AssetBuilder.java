...
public class AssetBuilder {
  ...
  /**
   * Returns an instance of Asset created from the properties set on this
   * builder.
   *
  ...
  public Asset build() throws HqdmException {
    ...
    if (this.asset.hasValue(ENDING) && this.asset.values(ENDING).isEmpty()) {
