...
public class AssociationBuilder {
   ...
   * @return This builder.
   */
  public final AssociationBuilder
   ...
   * type where an
   * {@link Association} may be a {@link
  ...
  /**
   * Returns an instance of Association created from the properties set on this
   * builder.
   *
   * @return The built Association.
   * @throws HqdmException If the Association is missing any mandatory
   *     properties.
   */
