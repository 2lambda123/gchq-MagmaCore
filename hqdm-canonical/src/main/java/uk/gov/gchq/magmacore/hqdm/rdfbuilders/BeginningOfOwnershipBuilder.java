...
public class BeginningOfOwnershipBuilder {
  ...
  public BeginningOfOwnershipBuilder(final IRI iri) {
    this.beginningOfOwnership =
        SpatioTemporalExtentServices.createBeginningOfOwnership(iri);
  }
   ...
   * @return This builder.
   */
  public final BeginningOfOwnershipBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.beginningOfOwnership.addValue(AGGREGATED_INTO,
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.beginningOfOwnership.addValue(CONSISTS__OF,
                                       spatioTemporalExtent.getId());
    return this;
  }
   ...
   */
  public final BeginningOfOwnershipBuilder
  member_Of(final ClassOfEvent classOfEvent) {
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.beginningOfOwnership.addValue(PART_OF_POSSIBLE_WORLD,
                                       possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.beginningOfOwnership.addValue(TEMPORAL__PART_OF,
                                       spatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of BeginningOfOwnership created from the properties set
   * on this builder.
   *
   * @return The built BeginningOfOwnership.
   * @throws HqdmException If the BeginningOfOwnership is missing any mandatory
   *     properties.
   */
