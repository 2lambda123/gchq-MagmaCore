...
public class BiologicalObjectBuilder {
  ...
  public BiologicalObjectBuilder(final IRI iri) {
    this.biologicalObject =
        SpatioTemporalExtentServices.createBiologicalObject(iri);
  }
   ...
   * @return This builder.
   */
  public final BiologicalObjectBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.biologicalObject.addValue(AGGREGATED_INTO,
   ...
   */
  public final BiologicalObjectBuilder
  member_Of(final ClassOfBiologicalObject classOfBiologicalObject) {
  ...
  member_Of_Kind(final KindOfBiologicalObject kindOfBiologicalObject) {
    this.biologicalObject.addValue(MEMBER_OF_KIND,
                                   kindOfBiologicalObject.getId());
    this.biologicalObject.addValue(RDFS.RDF_TYPE,
                                   kindOfBiologicalObject.getId());
    return this;
  }
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.biologicalObject.addValue(PART_OF_POSSIBLE_WORLD,
                                   possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.biologicalObject.addValue(TEMPORAL__PART_OF,
                                   spatioTemporalExtent.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of BiologicalObject created from the properties set on
   * this builder.
   *
   * @return The built BiologicalObject.
   * @throws HqdmException If the BiologicalObject is missing any mandatory
   *     properties.
   */
