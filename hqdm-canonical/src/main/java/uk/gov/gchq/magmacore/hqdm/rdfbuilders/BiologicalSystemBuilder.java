...
public class BiologicalSystemBuilder {
  ...
  public BiologicalSystemBuilder(final IRI iri) {
    this.biologicalSystem =
        SpatioTemporalExtentServices.createBiologicalSystem(iri);
  }
   ...
   * @return This builder.
   */
  public final BiologicalSystemBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.biologicalSystem.addValue(AGGREGATED_INTO,
   ...
   * type where a
   * {@link BiologicalSystem} may be a {@link
   ...
   */
  public final BiologicalSystemBuilder
  member_Of(final ClassOfBiologicalSystem classOfBiologicalSystem) {
   ...
   */
  public final BiologicalSystemBuilder
  member_Of_Kind(final KindOfBiologicalSystem kindOfBiologicalSystem) {
    this.biologicalSystem.addValue(MEMBER_OF_KIND,
                                   kindOfBiologicalSystem.getId());
    this.biologicalSystem.addValue(RDFS.RDF_TYPE,
                                   kindOfBiologicalSystem.getId());
    return this;
  }
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.biologicalSystem.addValue(PART_OF_POSSIBLE_WORLD,
                                   possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.biologicalSystem.addValue(TEMPORAL__PART_OF,
                                   spatioTemporalExtent.getId());
    return this;
  }
   ...
   * relationship type where a
   * {@link uk.gov.gchq.magmacore.hqdm.model.StateOfOrdinaryBiologicalObject}
   * may be a
   ...
   */
  public final BiologicalSystemBuilder
  temporal_Part_Of(final OrdinaryBiologicalObject ordinaryBiologicalObject) {
    this.biologicalSystem.addValue(TEMPORAL_PART_OF,
                                   ordinaryBiologicalObject.getId());
    return this;
  }

  /**
   * Returns an instance of BiologicalSystem created from the properties set on
   * this builder.
   *
   * @return The built BiologicalSystem.
   * @throws HqdmException If the BiologicalSystem is missing any mandatory
   *     properties.
   */
