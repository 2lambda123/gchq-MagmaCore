...
public class BiologicalSystemComponentBuilder {
  ...
  public BiologicalSystemComponentBuilder(final IRI iri) {
    this.biologicalSystemComponent =
        SpatioTemporalExtentServices.createBiologicalSystemComponent(iri);
  }
   ...
   * @return This builder.
   */
  public final BiologicalSystemComponentBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.biologicalSystemComponent.addValue(AGGREGATED_INTO,
   ...
   */
  public final BiologicalSystemComponentBuilder
  component_Of_M(final BiologicalSystem biologicalSystem) {
    this.biologicalSystemComponent.addValue(COMPONENT_OF,
                                            biologicalSystem.getId());
    return this;
  }
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.biologicalSystemComponent.addValue(CONSISTS__OF,
                                            spatioTemporalExtent.getId());
    return this;
  }
   ...
   *
   * @param classOfBiologicalSystemComponent The
  ...
  public final BiologicalSystemComponentBuilder member_Of(
    ...
    this.biologicalSystemComponent.addValue(
        MEMBER_OF, classOfBiologicalSystemComponent.getId());
    return this;
  }
   ...
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} relationship
   * type where a
   * {@link BiologicalObject} may be a {@link
   ...
   */
  public final BiologicalSystemComponentBuilder
  member_Of_Kind(final KindOfBiologicalObject kindOfBiologicalObject) {
    this.biologicalSystemComponent.addValue(MEMBER_OF_KIND,
                                            kindOfBiologicalObject.getId());
    this.biologicalSystemComponent.addValue(RDFS.RDF_TYPE,
                                            kindOfBiologicalObject.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.biologicalSystemComponent.addValue(PART__OF,
                                            spatioTemporalExtent.getId());
    return this;
  }
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.biologicalSystemComponent.addValue(PART_OF_POSSIBLE_WORLD,
                                            possibleWorld.getId());
    return this;
  }
   ...
   */
  public final BiologicalSystemComponentBuilder
  temporal_Part_Of(final BiologicalObject biologicalObject) {
    this.biologicalSystemComponent.addValue(TEMPORAL_PART_OF,
                                            biologicalObject.getId());
    return this;
  }

  /**
   * Returns an instance of BiologicalSystemComponent created from the
   * properties set on this builder.
   *
   * @return The built BiologicalSystemComponent.
   * @throws HqdmException If the BiologicalSystemComponent is missing any
