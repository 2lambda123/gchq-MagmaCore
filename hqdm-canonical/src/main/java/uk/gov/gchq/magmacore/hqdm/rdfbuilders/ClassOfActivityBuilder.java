...
public class ClassOfActivityBuilder {
   ...
   * @return This builder.
   */
  public final ClassOfActivityBuilder
  ...
  public final ClassOfActivityBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfActivity.addValue(MEMBER_OF_,
  ...
  public final ClassOfActivityBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.classOfActivity.addValue(PART__OF_BY_CLASS,
                                  classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of ClassOfActivity created from the properties set on
   * this builder.
   *
   * @return The built ClassOfActivity.
   * @throws HqdmException If the ClassOfActivity is missing any mandatory
   *     properties.
   */
