...
public class ClassOfAgreeContractBuilder {
   ...
   * @return This builder.
   */
  public final ClassOfAgreeContractBuilder
  ...
  public final ClassOfAgreeContractBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfAgreeContract.addValue(
   ...
   * ClassOfAgreeContract} may be a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} a
  ...
  part_Of_By_Class(final ClassOfContractProcess classOfContractProcess) {
    this.classOfAgreeContract.addValue(PART_OF_BY_CLASS,
  ...
  /**
   * Returns an instance of ClassOfAgreeContract created from the properties set
   * on this builder.
   *
   * @return The built ClassOfAgreeContract.
   * @throws HqdmException If the ClassOfAgreeContract is missing any mandatory
   *     properties.
   */
