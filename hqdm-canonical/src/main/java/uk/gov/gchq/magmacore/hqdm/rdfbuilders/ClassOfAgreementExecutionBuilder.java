...
public class ClassOfAgreementExecutionBuilder {
  ...
  public ClassOfAgreementExecutionBuilder(final IRI iri) {
    this.classOfAgreementExecution =
        ClassServices.createClassOfAgreementExecution(iri);
  }
  ...
  public final ClassOfAgreementExecutionBuilder consists__Of_By_Class(
    ...
    this.classOfAgreementExecution.addValue(
   ...
   * ClassOfAgreementExecution} may be a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} a
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} the {@link
   ...
   */
  public final ClassOfAgreementExecutionBuilder
  part_Of_By_Class(final ClassOfAgreementProcess classOfAgreementProcess) {
  ...
  /**
   * Returns an instance of ClassOfAgreementExecution created from the
   * properties set on this builder.
   *
   * @return The built ClassOfAgreementExecution.
   * @throws HqdmException If the ClassOfAgreementExecution is missing any
