...
public class ClassOfAgreementProcessBuilder {
  ...
  public ClassOfAgreementProcessBuilder(final IRI iri) {
    this.classOfAgreementProcess =
        ClassServices.createClassOfAgreementProcess(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfAgreementProcessBuilder
  ...
  public final ClassOfAgreementProcessBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfAgreementProcess.addValue(
  ...
  /**
   * Returns an instance of ClassOfAgreementProcess created from the properties
   * set on this builder.
   *
   * @return The built ClassOfAgreementProcess.
   * @throws HqdmException If the ClassOfAgreementProcess is missing any
