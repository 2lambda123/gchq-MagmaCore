...
public class ClassOfAssociationBuilder {
   ...
   * @return This builder.
   */
  public final ClassOfAssociationBuilder
  ...
  public final ClassOfAssociationBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfAssociation.addValue(
  ...
  /**
   * Returns an instance of ClassOfAssociation created from the properties set
   * on this builder.
   *
   * @return The built ClassOfAssociation.
   * @throws HqdmException If the ClassOfAssociation is missing any mandatory
   *     properties.
   */
