...
public class ClassOfBiologicalObjectBuilder {
  ...
  public ClassOfBiologicalObjectBuilder(final IRI iri) {
    this.classOfBiologicalObject =
        ClassServices.createClassOfBiologicalObject(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfBiologicalObjectBuilder
  ...
  public final ClassOfBiologicalObjectBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfBiologicalObject.addValue(
  ...
  /**
   * Returns an instance of ClassOfBiologicalObject created from the properties
   * set on this builder.
   *
   * @return The built ClassOfBiologicalObject.
   * @throws HqdmException If the ClassOfBiologicalObject is missing any
