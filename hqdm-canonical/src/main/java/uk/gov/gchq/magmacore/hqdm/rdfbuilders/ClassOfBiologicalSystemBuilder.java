...
public class ClassOfBiologicalSystemBuilder {
  ...
  public ClassOfBiologicalSystemBuilder(final IRI iri) {
    this.classOfBiologicalSystem =
        ClassServices.createClassOfBiologicalSystem(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfBiologicalSystemBuilder
  ...
  public final ClassOfBiologicalSystemBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfBiologicalSystem.addValue(
  ...
  /**
   * Returns an instance of ClassOfBiologicalSystem created from the properties
   * set on this builder.
   *
   * @return The built ClassOfBiologicalSystem.
   * @throws HqdmException If the ClassOfBiologicalSystem is missing any
