...
public class ClassOfBiologicalSystemComponentBuilder {
  ...
  private final ClassOfBiologicalSystemComponent
  ...
  public ClassOfBiologicalSystemComponentBuilder(final IRI iri) {
    this.classOfBiologicalSystemComponent =
        ClassServices.createClassOfBiologicalSystemComponent(iri);
  }
  ...
  public final ClassOfBiologicalSystemComponentBuilder consists__Of_By_Class(
    ...
    this.classOfBiologicalSystemComponent.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfBiologicalSystemComponentBuilder
  has_Superclass(final Class clazz) {
    this.classOfBiologicalSystemComponent.addValue(HAS_SUPERCLASS,
                                                   clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfBiologicalSystemComponent.addValue(MEMBER_OF,
                                                   classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfBiologicalSystemComponent created from the
   * properties set on this builder.
   *
   * @return The built ClassOfBiologicalSystemComponent.
   * @throws HqdmException If the ClassOfBiologicalSystemComponent is missing
   *     any mandatory
   *                       properties.
   */
  public ClassOfBiologicalSystemComponent build() throws HqdmException {
    if (this.classOfBiologicalSystemComponent.hasValue(HAS_SUPERCLASS) &&
        this.classOfBiologicalSystemComponent.values(HAS_SUPERCLASS)
            .isEmpty()) {
    ...
    if (this.classOfBiologicalSystemComponent.hasValue(PART__OF_BY_CLASS) &&
        this.classOfBiologicalSystemComponent.values(PART__OF_BY_CLASS)
            .isEmpty()) {
