...
public class ClassOfClassOfSpatioTemporalExtentBuilder {
  ...
  private final ClassOfClassOfSpatioTemporalExtent
   ...
   * @return This builder.
   */
  public final ClassOfClassOfSpatioTemporalExtentBuilder
  has_Superclass(final Class clazz) {
    this.classOfClassOfSpatioTemporalExtent.addValue(HAS_SUPERCLASS,
                                                     clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfClassOfSpatioTemporalExtent.addValue(MEMBER_OF,
                                                     classOfClass.getId());
    return this;
  }

  /**
   * Returns an instance of ClassOfClassOfSpatioTemporalExtent created from the
   * properties set on this builder.
   *
   * @return The built ClassOfClassOfSpatioTemporalExtent.
   * @throws HqdmException If the ClassOfClassOfSpatioTemporalExtent is missing
   *     any mandatory
   *                       properties.
   */
  public ClassOfClassOfSpatioTemporalExtent build() throws HqdmException {
    if (this.classOfClassOfSpatioTemporalExtent.hasValue(HAS_SUPERCLASS) &&
        this.classOfClassOfSpatioTemporalExtent.values(HAS_SUPERCLASS)
            .isEmpty()) {
