...
public class ClassOfContractExecutionBuilder {
  ...
  public ClassOfContractExecutionBuilder(final IRI iri) {
    this.classOfContractExecution =
        ClassServices.createClassOfContractExecution(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfContractExecutionBuilder
  ...
  public final ClassOfContractExecutionBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfContractExecution.addValue(
   ...
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} the {@link
   * ClassOfContractExecution} may be a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} a
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} the {@link
   * ClassOfContractProcess}.
   *
   * @param classOfContractProcess The ClassOfContractProcess.
   * @return This builder.
   */
  public final ClassOfContractExecutionBuilder
  part_Of_By_Class(final ClassOfContractProcess classOfContractProcess) {
  ...
  /**
   * Returns an instance of ClassOfContractExecution created from the properties
   * set on this builder.
   *
   * @return The built ClassOfContractExecution.
   * @throws HqdmException If the ClassOfContractExecution is missing any
