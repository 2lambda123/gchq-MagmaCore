...
public class ClassOfContractProcessBuilder {
  ...
  public ClassOfContractProcessBuilder(final IRI iri) {
    this.classOfContractProcess =
        ClassServices.createClassOfContractProcess(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfContractProcessBuilder
  ...
  public final ClassOfContractProcessBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfContractProcess.addValue(
  ...
  /**
   * Returns an instance of ClassOfContractProcess created from the properties
   * set on this builder.
   *
   * @return The built ClassOfContractProcess.
   * @throws HqdmException If the ClassOfContractProcess is missing any
