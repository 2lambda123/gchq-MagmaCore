...
public class ClassOfEventBuilder {
  ...
  public final ClassOfEventBuilder consists__Of_By_Class(
    ...
    this.classOfEvent.addValue(CONSISTS__OF_BY_CLASS,
  ...
  public final ClassOfEventBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfEvent.addValue(MEMBER_OF_,
  ...
  public final ClassOfEventBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.classOfEvent.addValue(PART__OF_BY_CLASS,
                               classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of ClassOfEvent created from the properties set on this
   * builder.
   *
   * @return The built ClassOfEvent.
   * @throws HqdmException If the ClassOfEvent is missing any mandatory
   *     properties.
   */
