...
public class ClassOfFunctionalObjectBuilder {
  ...
  public ClassOfFunctionalObjectBuilder(final IRI iri) {
    this.classOfFunctionalObject =
        ClassServices.createClassOfFunctionalObject(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfFunctionalObjectBuilder
  ...
  public final ClassOfFunctionalObjectBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfFunctionalObject.addValue(
  ...
  /**
   * Returns an instance of ClassOfFunctionalObject created from the properties
   * set on this builder.
   *
   * @return The built ClassOfFunctionalObject.
   * @throws HqdmException If the ClassOfFunctionalObject is missing any
