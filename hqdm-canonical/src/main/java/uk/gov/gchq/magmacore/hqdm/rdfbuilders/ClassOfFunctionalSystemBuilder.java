...
public class ClassOfFunctionalSystemBuilder {
  ...
  public ClassOfFunctionalSystemBuilder(final IRI iri) {
    this.classOfFunctionalSystem =
        ClassServices.createClassOfFunctionalSystem(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfFunctionalSystemBuilder
  ...
  public final ClassOfFunctionalSystemBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfFunctionalSystem.addValue(
  ...
  /**
   * Returns an instance of ClassOfFunctionalSystem created from the properties
   * set on this builder.
   *
   * @return The built ClassOfFunctionalSystem.
   * @throws HqdmException If the ClassOfFunctionalSystem is missing any
