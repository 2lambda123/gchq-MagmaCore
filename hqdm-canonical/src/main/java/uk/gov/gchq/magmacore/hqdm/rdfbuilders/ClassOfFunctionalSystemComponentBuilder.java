...
public class ClassOfFunctionalSystemComponentBuilder {
  ...
  private final ClassOfFunctionalSystemComponent
  ...
  public ClassOfFunctionalSystemComponentBuilder(final IRI iri) {
    this.classOfFunctionalSystemComponent =
        ClassServices.createClassOfFunctionalSystemComponent(iri);
  }
  ...
  public final ClassOfFunctionalSystemComponentBuilder consists__Of_By_Class(
    ...
    this.classOfFunctionalSystemComponent.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfFunctionalSystemComponentBuilder
  has_Superclass(final Class clazz) {
    this.classOfFunctionalSystemComponent.addValue(HAS_SUPERCLASS,
                                                   clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfFunctionalSystemComponent.addValue(MEMBER_OF,
                                                   classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfFunctionalSystemComponent created from the
   * properties set on this builder.
   *
   * @return The built ClassOfFunctionalSystemComponent.
   * @throws HqdmException If the ClassOfFunctionalSystemComponent is missing
   *     any mandatory
   *                       properties.
   */
  public ClassOfFunctionalSystemComponent build() throws HqdmException {
    if (this.classOfFunctionalSystemComponent.hasValue(HAS_SUPERCLASS) &&
        this.classOfFunctionalSystemComponent.values(HAS_SUPERCLASS)
            .isEmpty()) {
    ...
    if (this.classOfFunctionalSystemComponent.hasValue(PART__OF_BY_CLASS) &&
        this.classOfFunctionalSystemComponent.values(PART__OF_BY_CLASS)
            .isEmpty()) {
