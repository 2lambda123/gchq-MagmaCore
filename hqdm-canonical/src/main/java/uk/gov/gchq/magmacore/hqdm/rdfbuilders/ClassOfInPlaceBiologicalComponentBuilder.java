...
public class ClassOfInPlaceBiologicalComponentBuilder {
  ...
  private final ClassOfInPlaceBiologicalComponent
  ...
  public ClassOfInPlaceBiologicalComponentBuilder(final IRI iri) {
    this.classOfInPlaceBiologicalComponent =
        ClassServices.createClassOfInPlaceBiologicalComponent(iri);
  }
  ...
  public final ClassOfInPlaceBiologicalComponentBuilder consists__Of_By_Class(
    ...
    this.classOfInPlaceBiologicalComponent.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfInPlaceBiologicalComponentBuilder
  has_Superclass(final Class clazz) {
    this.classOfInPlaceBiologicalComponent.addValue(HAS_SUPERCLASS,
                                                    clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfInPlaceBiologicalComponent.addValue(MEMBER_OF,
                                                    classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfInPlaceBiologicalComponent created from the
   * properties set on this builder.
   *
   * @return The built ClassOfInPlaceBiologicalComponent.
   * @throws HqdmException If the ClassOfInPlaceBiologicalComponent is missing
   *     any mandatory
   *                       properties.
   */
  public ClassOfInPlaceBiologicalComponent build() throws HqdmException {
    if (this.classOfInPlaceBiologicalComponent.hasValue(HAS_SUPERCLASS) &&
        this.classOfInPlaceBiologicalComponent.values(HAS_SUPERCLASS)
            .isEmpty()) {
    ...
    if (this.classOfInPlaceBiologicalComponent.hasValue(PART__OF_BY_CLASS) &&
        this.classOfInPlaceBiologicalComponent.values(PART__OF_BY_CLASS)
            .isEmpty()) {
