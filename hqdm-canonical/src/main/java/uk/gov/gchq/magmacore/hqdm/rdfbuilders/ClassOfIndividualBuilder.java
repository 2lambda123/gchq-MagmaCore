...
public class ClassOfIndividualBuilder {
  ...
  public final ClassOfIndividualBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfIndividual.addValue(MEMBER_OF_,
  ...
  public final ClassOfIndividualBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.classOfIndividual.addValue(PART__OF_BY_CLASS,
                                    classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of ClassOfIndividual created from the properties set on
   * this builder.
   *
   * @return The built ClassOfIndividual.
   * @throws HqdmException If the ClassOfIndividual is missing any mandatory
   *     properties.
   */
