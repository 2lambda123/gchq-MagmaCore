...
public class ClassOfInstalledFunctionalSystemComponentBuilder {
  ...
  private final ClassOfInstalledFunctionalSystemComponent
      classOfInstalledFunctionalSystemComponent;
  ...
  public ClassOfInstalledFunctionalSystemComponentBuilder(final IRI iri) {
    this.classOfInstalledFunctionalSystemComponent =
        ClassServices.createClassOfInstalledFunctionalSystemComponent(iri);
  }
  ...
  consists__Of_By_Class(
    ...
    this.classOfInstalledFunctionalSystemComponent.addValue(
  ...
  has_Superclass(final Class clazz) {
    this.classOfInstalledFunctionalSystemComponent.addValue(HAS_SUPERCLASS,
                                                            clazz.getId());
    return this;
  }
  ...
  member__Of(final Class clazz) {
    this.classOfInstalledFunctionalSystemComponent.addValue(MEMBER__OF,
                                                            clazz.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfInstalledFunctionalSystemComponent created
   * from the properties set on this builder.
   *
   * @return The built ClassOfInstalledFunctionalSystemComponent.
   * @throws HqdmException If the ClassOfInstalledFunctionalSystemComponent is
   *     missing any mandatory
   *                       properties.
   */
  public ClassOfInstalledFunctionalSystemComponent build()
      throws HqdmException {
    if (this.classOfInstalledFunctionalSystemComponent.hasValue(
            HAS_SUPERCLASS) &&
        this.classOfInstalledFunctionalSystemComponent.values(HAS_SUPERCLASS)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: has_superclass");
    }
    if (this.classOfInstalledFunctionalSystemComponent.hasValue(MEMBER__OF) &&
        this.classOfInstalledFunctionalSystemComponent.values(MEMBER__OF)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member__of");
    }
    if (this.classOfInstalledFunctionalSystemComponent.hasValue(MEMBER_OF) &&
        this.classOfInstalledFunctionalSystemComponent.values(MEMBER_OF)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member_of");
    }
    if (this.classOfInstalledFunctionalSystemComponent.hasValue(MEMBER_OF_) &&
        this.classOfInstalledFunctionalSystemComponent.values(MEMBER_OF_)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member_of_");
    }
    if (this.classOfInstalledFunctionalSystemComponent.hasValue(
            PART__OF_BY_CLASS) &&
        this.classOfInstalledFunctionalSystemComponent.values(PART__OF_BY_CLASS)
            .isEmpty()) {
