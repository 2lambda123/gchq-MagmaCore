...
public class ClassOfInstalledObjectBuilder {
  ...
  public ClassOfInstalledObjectBuilder(final IRI iri) {
    this.classOfInstalledObject =
        ClassServices.createClassOfInstalledObject(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfInstalledObjectBuilder
  ...
  public final ClassOfInstalledObjectBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfInstalledObject.addValue(
  ...
  /**
   * Returns an instance of ClassOfInstalledObject created from the properties
   * set on this builder.
   *
   * @return The built ClassOfInstalledObject.
   * @throws HqdmException If the ClassOfInstalledObject is missing any
