...
public class ClassOfIntentionallyConstructedObjectBuilder {
  ...
  private final ClassOfIntentionallyConstructedObject
  ...
  public ClassOfIntentionallyConstructedObjectBuilder(final IRI iri) {
    this.classOfIntentionallyConstructedObject =
        ClassServices.createClassOfIntentionallyConstructedObject(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfIntentionallyConstructedObjectBuilder
  consists__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.classOfIntentionallyConstructedObject.addValue(
  ...
  has_Superclass(final Class clazz) {
    this.classOfIntentionallyConstructedObject.addValue(HAS_SUPERCLASS,
                                                        clazz.getId());
    return this;
  }
  ...
  member__Of(final Class clazz) {
    this.classOfIntentionallyConstructedObject.addValue(MEMBER__OF,
                                                        clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfIntentionallyConstructedObject.addValue(MEMBER_OF,
                                                        classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfIntentionallyConstructedObject created from
   * the properties set on this builder.
   *
   * @return The built ClassOfIntentionallyConstructedObject.
   * @throws HqdmException If the ClassOfIntentionallyConstructedObject is
  ...
  public ClassOfIntentionallyConstructedObject build() throws HqdmException {
    if (this.classOfIntentionallyConstructedObject.hasValue(HAS_SUPERCLASS) &&
        this.classOfIntentionallyConstructedObject.values(HAS_SUPERCLASS)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: has_superclass");
    }
    if (this.classOfIntentionallyConstructedObject.hasValue(MEMBER__OF) &&
        this.classOfIntentionallyConstructedObject.values(MEMBER__OF)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member__of");
    }
    if (this.classOfIntentionallyConstructedObject.hasValue(MEMBER_OF) &&
        this.classOfIntentionallyConstructedObject.values(MEMBER_OF)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member_of");
    }
    if (this.classOfIntentionallyConstructedObject.hasValue(MEMBER_OF_) &&
        this.classOfIntentionallyConstructedObject.values(MEMBER_OF_)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member_of_");
    }
    if (this.classOfIntentionallyConstructedObject.hasValue(
            PART__OF_BY_CLASS) &&
        this.classOfIntentionallyConstructedObject.values(PART__OF_BY_CLASS)
            .isEmpty()) {
