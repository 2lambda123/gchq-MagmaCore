...
public class ClassOfOfferBuilder {
  ...
  public final ClassOfOfferBuilder consists__Of_By_Class(
    ...
    this.classOfOffer.addValue(CONSISTS__OF_BY_CLASS,
  ...
  public final ClassOfOfferBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfOffer.addValue(MEMBER_OF_,
  ...
  public final ClassOfOfferBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.classOfOffer.addValue(PART__OF_BY_CLASS,
                               classOfSpatioTemporalExtent.getId());
    return this;
  }
   ...
   * @return This builder.
   */
  public final ClassOfOfferBuilder
  part_Of_By_Class(final ClassOfReachingAgreement classOfReachingAgreement) {
    this.classOfOffer.addValue(PART_OF_BY_CLASS,
  ...
  part_Of_By_Class_(final ClassOfAgreementExecution classOfAgreementExecution) {
    this.classOfOffer.addValue(PART_OF_BY_CLASS_,
                               classOfAgreementExecution.getId());
    return this;
  }

  /**
   * Returns an instance of ClassOfOffer created from the properties set on this
   * builder.
   *
   * @return The built ClassOfOffer.
   * @throws HqdmException If the ClassOfOffer is missing any mandatory
   *     properties.
   */
