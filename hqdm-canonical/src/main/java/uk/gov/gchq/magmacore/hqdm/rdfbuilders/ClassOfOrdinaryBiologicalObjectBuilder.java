...
public class ClassOfOrdinaryBiologicalObjectBuilder {
  ...
  public ClassOfOrdinaryBiologicalObjectBuilder(final IRI iri) {
    this.classOfOrdinaryBiologicalObject =
        ClassServices.createClassOfOrdinaryBiologicalObject(iri);
  }
  ...
  public final ClassOfOrdinaryBiologicalObjectBuilder consists__Of_By_Class(
    ...
    this.classOfOrdinaryBiologicalObject.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfOrdinaryBiologicalObjectBuilder
  has_Superclass(final Class clazz) {
    this.classOfOrdinaryBiologicalObject.addValue(HAS_SUPERCLASS,
                                                  clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfOrdinaryBiologicalObject.addValue(MEMBER_OF,
                                                  classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfOrdinaryBiologicalObject created from the
   * properties set on this builder.
   *
   * @return The built ClassOfOrdinaryBiologicalObject.
   * @throws HqdmException If the ClassOfOrdinaryBiologicalObject is missing any
  ...
  public ClassOfOrdinaryBiologicalObject build() throws HqdmException {
    ...
    if (this.classOfOrdinaryBiologicalObject.hasValue(PART__OF_BY_CLASS) &&
        this.classOfOrdinaryBiologicalObject.values(PART__OF_BY_CLASS)
            .isEmpty()) {
