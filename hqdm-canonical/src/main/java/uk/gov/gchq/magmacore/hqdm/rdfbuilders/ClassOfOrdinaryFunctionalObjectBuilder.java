...
public class ClassOfOrdinaryFunctionalObjectBuilder {
  ...
  public ClassOfOrdinaryFunctionalObjectBuilder(final IRI iri) {
    this.classOfOrdinaryFunctionalObject =
        ClassServices.createClassOfOrdinaryFunctionalObject(iri);
  }
  ...
  public final ClassOfOrdinaryFunctionalObjectBuilder consists__Of_By_Class(
    ...
    this.classOfOrdinaryFunctionalObject.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfOrdinaryFunctionalObjectBuilder
  has_Superclass(final Class clazz) {
    this.classOfOrdinaryFunctionalObject.addValue(HAS_SUPERCLASS,
                                                  clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfOrdinaryFunctionalObject.addValue(MEMBER_OF,
                                                  classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfOrdinaryFunctionalObject created from the
   * properties set on this builder.
   *
   * @return The built ClassOfOrdinaryFunctionalObject.
   * @throws HqdmException If the ClassOfOrdinaryFunctionalObject is missing any
  ...
  public ClassOfOrdinaryFunctionalObject build() throws HqdmException {
    ...
    if (this.classOfOrdinaryFunctionalObject.hasValue(PART__OF_BY_CLASS) &&
        this.classOfOrdinaryFunctionalObject.values(PART__OF_BY_CLASS)
            .isEmpty()) {
