...
public class ClassOfOrdinaryPhysicalObjectBuilder {
  ...
  public ClassOfOrdinaryPhysicalObjectBuilder(final IRI iri) {
    this.classOfOrdinaryPhysicalObject =
        ClassServices.createClassOfOrdinaryPhysicalObject(iri);
  }
  ...
  public final ClassOfOrdinaryPhysicalObjectBuilder consists__Of_By_Class(
    ...
    this.classOfOrdinaryPhysicalObject.addValue(
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfOrdinaryPhysicalObject.addValue(MEMBER_OF,
                                                classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfOrdinaryPhysicalObject created from the
   * properties set on this builder.
   *
   * @return The built ClassOfOrdinaryPhysicalObject.
   * @throws HqdmException If the ClassOfOrdinaryPhysicalObject is missing any
  ...
  public ClassOfOrdinaryPhysicalObject build() throws HqdmException {
    ...
    if (this.classOfOrdinaryPhysicalObject.hasValue(PART__OF_BY_CLASS) &&
        this.classOfOrdinaryPhysicalObject.values(PART__OF_BY_CLASS)
            .isEmpty()) {
