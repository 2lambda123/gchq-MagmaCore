...
public class ClassOfParticipantBuilder {
  ...
  public final ClassOfParticipantBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfParticipant.addValue(
  ...
  /**
   * Returns an instance of ClassOfParticipant created from the properties set
   * on this builder.
   *
   * @return The built ClassOfParticipant.
   * @throws HqdmException If the ClassOfParticipant is missing any mandatory
   *     properties.
   */
