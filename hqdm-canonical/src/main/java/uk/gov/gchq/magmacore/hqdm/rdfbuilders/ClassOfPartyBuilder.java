...
public class ClassOfPartyBuilder {
  ...
  public final ClassOfPartyBuilder consists__Of_By_Class(
    ...
    this.classOfParty.addValue(CONSISTS__OF_BY_CLASS,
  ...
  public final ClassOfPartyBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfParty.addValue(MEMBER_OF_,
  ...
  public final ClassOfPartyBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.classOfParty.addValue(PART__OF_BY_CLASS,
                               classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of ClassOfParty created from the properties set on this
   * builder.
   *
   * @return The built ClassOfParty.
   * @throws HqdmException If the ClassOfParty is missing any mandatory
   *     properties.
   */
