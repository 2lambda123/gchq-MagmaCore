...
public class ClassOfPeriodOfTimeBuilder {
   ...
   * @return This builder.
   */
  public final ClassOfPeriodOfTimeBuilder
  ...
  public final ClassOfPeriodOfTimeBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfPeriodOfTime.addValue(
  ...
  /**
   * Returns an instance of ClassOfPeriodOfTime created from the properties set
   * on this builder.
   *
   * @return The built ClassOfPeriodOfTime.
   * @throws HqdmException If the ClassOfPeriodOfTime is missing any mandatory
   *     properties.
   */
