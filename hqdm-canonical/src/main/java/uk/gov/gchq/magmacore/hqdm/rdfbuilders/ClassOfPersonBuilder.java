...
public class ClassOfPersonBuilder {
  ...
  public final ClassOfPersonBuilder consists__Of_By_Class(
    ...
    this.classOfPerson.addValue(CONSISTS__OF_BY_CLASS,
  ...
  public final ClassOfPersonBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfPerson.addValue(MEMBER_OF_,
  ...
  public final ClassOfPersonBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.classOfPerson.addValue(PART__OF_BY_CLASS,
                                classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of ClassOfPerson created from the properties set on
   * this builder.
   *
   * @return The built ClassOfPerson.
   * @throws HqdmException If the ClassOfPerson is missing any mandatory
   *     properties.
   */
