...
public class ClassOfPersonInPositionBuilder {
  ...
  public ClassOfPersonInPositionBuilder(final IRI iri) {
    this.classOfPersonInPosition =
        ClassServices.createClassOfPersonInPosition(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfPersonInPositionBuilder
  ...
  public final ClassOfPersonInPositionBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfPersonInPosition.addValue(
  ...
  /**
   * Returns an instance of ClassOfPersonInPosition created from the properties
   * set on this builder.
   *
   * @return The built ClassOfPersonInPosition.
   * @throws HqdmException If the ClassOfPersonInPosition is missing any
