...
public class ClassOfPointInTimeBuilder {
   ...
   * @return This builder.
   */
  public final ClassOfPointInTimeBuilder
  ...
  public final ClassOfPointInTimeBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfPointInTime.addValue(
  ...
  /**
   * Returns an instance of ClassOfPointInTime created from the properties set
   * on this builder.
   *
   * @return The built ClassOfPointInTime.
   * @throws HqdmException If the ClassOfPointInTime is missing any mandatory
   *     properties.
   */
