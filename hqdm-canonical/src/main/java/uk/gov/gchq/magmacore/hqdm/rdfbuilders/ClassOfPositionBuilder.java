...
public class ClassOfPositionBuilder {
   ...
   * @return This builder.
   */
  public final ClassOfPositionBuilder
  ...
  public final ClassOfPositionBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfPosition.addValue(MEMBER_OF_,
  ...
  public final ClassOfPositionBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.classOfPosition.addValue(PART__OF_BY_CLASS,
                                  classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of ClassOfPosition created from the properties set on
   * this builder.
   *
   * @return The built ClassOfPosition.
   * @throws HqdmException If the ClassOfPosition is missing any mandatory
   *     properties.
   */
