...
public class ClassOfPossibleWorldBuilder {
   ...
   * @return This builder.
   */
  public final ClassOfPossibleWorldBuilder
  ...
  public final ClassOfPossibleWorldBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfPossibleWorld.addValue(
  ...
  /**
   * Returns an instance of ClassOfPossibleWorld created from the properties set
   * on this builder.
   *
   * @return The built ClassOfPossibleWorld.
   * @throws HqdmException If the ClassOfPossibleWorld is missing any mandatory
   *     properties.
   */
