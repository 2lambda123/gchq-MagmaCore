...
public class ClassOfReachingAgreementBuilder {
  ...
  public ClassOfReachingAgreementBuilder(final IRI iri) {
    this.classOfReachingAgreement =
        ClassServices.createClassOfReachingAgreement(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfReachingAgreementBuilder
  ...
  public final ClassOfReachingAgreementBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfReachingAgreement.addValue(
   ...
   * ClassOfReachingAgreement} may be a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} a
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} a {@link
  ...
  /**
   * Returns an instance of ClassOfReachingAgreement created from the properties
   * set on this builder.
   *
   * @return The built ClassOfReachingAgreement.
   * @throws HqdmException If the ClassOfReachingAgreement is missing any
