...
public class ClassOfSalesProductInstanceBuilder {
  ...
  public ClassOfSalesProductInstanceBuilder(final IRI iri) {
    this.classOfSalesProductInstance =
        ClassServices.createClassOfSalesProductInstance(iri);
  }
  ...
  public final ClassOfSalesProductInstanceBuilder consists__Of_By_Class(
    ...
    this.classOfSalesProductInstance.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfSalesProductInstanceBuilder
  ...
  /**
   * Returns an instance of ClassOfSalesProductInstance created from the
   * properties set on this builder.
   *
   * @return The built ClassOfSalesProductInstance.
   * @throws HqdmException If the ClassOfSalesProductInstance is missing any
