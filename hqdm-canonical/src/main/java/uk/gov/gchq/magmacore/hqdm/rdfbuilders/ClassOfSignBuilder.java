...
public class ClassOfSignBuilder {
  ...
  public final ClassOfSignBuilder consists__Of_By_Class(
    ...
    this.classOfSign.addValue(CONSISTS__OF_BY_CLASS,
  ...
  public final ClassOfSignBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfSign.addValue(MEMBER_OF_,
  ...
  public final ClassOfSignBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.classOfSign.addValue(PART__OF_BY_CLASS,
                              classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of ClassOfSign created from the properties set on this
   * builder.
   *
   * @return The built ClassOfSign.
   * @throws HqdmException If the ClassOfSign is missing any mandatory
   *     properties.
   */
