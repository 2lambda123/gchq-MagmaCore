...
public class ClassOfSociallyConstructedActivityBuilder {
  ...
  private final ClassOfSociallyConstructedActivity
  ...
  public ClassOfSociallyConstructedActivityBuilder(final IRI iri) {
    this.classOfSociallyConstructedActivity =
        ClassServices.createClassOfSociallyConstructedActivity(iri);
  }
  ...
  public final ClassOfSociallyConstructedActivityBuilder consists__Of_By_Class(
    ...
    this.classOfSociallyConstructedActivity.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfSociallyConstructedActivityBuilder
  has_Superclass(final Class clazz) {
    this.classOfSociallyConstructedActivity.addValue(HAS_SUPERCLASS,
                                                     clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfSociallyConstructedActivity.addValue(MEMBER_OF,
                                                     classOfClass.getId());
    return this;
  }
  ...
  part_Of_By_Class(final ClassOfReachingAgreement classOfReachingAgreement) {
    this.classOfSociallyConstructedActivity.addValue(
        PART_OF_BY_CLASS, classOfReachingAgreement.getId());
    return this;
  }
  ...
  part_Of_By_Class_(final ClassOfAgreementExecution classOfAgreementExecution) {
    this.classOfSociallyConstructedActivity.addValue(
        PART_OF_BY_CLASS_, classOfAgreementExecution.getId());
    return this;
  }

  /**
   * Returns an instance of ClassOfSociallyConstructedActivity created from the
   * properties set on this builder.
   *
   * @return The built ClassOfSociallyConstructedActivity.
   * @throws HqdmException If the ClassOfSociallyConstructedActivity is missing
   *     any mandatory
   *                       properties.
   */
  public ClassOfSociallyConstructedActivity build() throws HqdmException {
    if (this.classOfSociallyConstructedActivity.hasValue(HAS_SUPERCLASS) &&
        this.classOfSociallyConstructedActivity.values(HAS_SUPERCLASS)
            .isEmpty()) {
    ...
    if (this.classOfSociallyConstructedActivity.hasValue(PART__OF_BY_CLASS) &&
        this.classOfSociallyConstructedActivity.values(PART__OF_BY_CLASS)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: part__of_by_class");
    }
    if (this.classOfSociallyConstructedActivity.hasValue(PART_OF_BY_CLASS) &&
        this.classOfSociallyConstructedActivity.values(PART_OF_BY_CLASS)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: part_of_by_class");
    }
    if (this.classOfSociallyConstructedActivity.hasValue(PART_OF_BY_CLASS_) &&
        this.classOfSociallyConstructedActivity.values(PART_OF_BY_CLASS_)
            .isEmpty()) {
