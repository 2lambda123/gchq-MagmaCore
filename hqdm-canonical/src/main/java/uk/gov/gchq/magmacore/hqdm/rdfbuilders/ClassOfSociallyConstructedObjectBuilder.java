...
public class ClassOfSociallyConstructedObjectBuilder {
  ...
  private final ClassOfSociallyConstructedObject
  ...
  public ClassOfSociallyConstructedObjectBuilder(final IRI iri) {
    this.classOfSociallyConstructedObject =
        ClassServices.createClassOfSociallyConstructedObject(iri);
  }
  ...
  public final ClassOfSociallyConstructedObjectBuilder consists__Of_By_Class(
    ...
    this.classOfSociallyConstructedObject.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfSociallyConstructedObjectBuilder
  has_Superclass(final Class clazz) {
    this.classOfSociallyConstructedObject.addValue(HAS_SUPERCLASS,
                                                   clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfSociallyConstructedObject.addValue(MEMBER_OF,
                                                   classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfSociallyConstructedObject created from the
   * properties set on this builder.
   *
   * @return The built ClassOfSociallyConstructedObject.
   * @throws HqdmException If the ClassOfSociallyConstructedObject is missing
   *     any mandatory
   *                       properties.
   */
  public ClassOfSociallyConstructedObject build() throws HqdmException {
    if (this.classOfSociallyConstructedObject.hasValue(HAS_SUPERCLASS) &&
        this.classOfSociallyConstructedObject.values(HAS_SUPERCLASS)
            .isEmpty()) {
    ...
    if (this.classOfSociallyConstructedObject.hasValue(PART__OF_BY_CLASS) &&
        this.classOfSociallyConstructedObject.values(PART__OF_BY_CLASS)
            .isEmpty()) {
