...
public class ClassOfSpatioTemporalExtentBuilder {
  ...
  public ClassOfSpatioTemporalExtentBuilder(final IRI iri) {
    this.classOfSpatioTemporalExtent =
        ClassServices.createClassOfSpatioTemporalExtent(iri);
  }
  ...
  public final ClassOfSpatioTemporalExtentBuilder consists__Of_By_Class(
    ...
    this.classOfSpatioTemporalExtent.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfSpatioTemporalExtentBuilder
  ...
  /**
   * Returns an instance of ClassOfSpatioTemporalExtent created from the
   * properties set on this builder.
   *
   * @return The built ClassOfSpatioTemporalExtent.
   * @throws HqdmException If the ClassOfSpatioTemporalExtent is missing any
