...
public class ClassOfStateBuilder {
  ...
  public final ClassOfStateBuilder consists__Of_By_Class(
    ...
    this.classOfState.addValue(CONSISTS__OF_BY_CLASS,
  ...
  public final ClassOfStateBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfState.addValue(MEMBER_OF_,
  ...
  public final ClassOfStateBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.classOfState.addValue(PART__OF_BY_CLASS,
                               classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of ClassOfState created from the properties set on this
   * builder.
   *
   * @return The built ClassOfState.
   * @throws HqdmException If the ClassOfState is missing any mandatory
   *     properties.
   */
