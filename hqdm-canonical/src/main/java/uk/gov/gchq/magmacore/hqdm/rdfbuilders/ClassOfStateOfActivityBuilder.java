...
public class ClassOfStateOfActivityBuilder {
  ...
  public ClassOfStateOfActivityBuilder(final IRI iri) {
    this.classOfStateOfActivity =
        ClassServices.createClassOfStateOfActivity(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfStateOfActivityBuilder
  ...
  public final ClassOfStateOfActivityBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfStateOfActivity.addValue(
  ...
  /**
   * Returns an instance of ClassOfStateOfActivity created from the properties
   * set on this builder.
   *
   * @return The built ClassOfStateOfActivity.
   * @throws HqdmException If the ClassOfStateOfActivity is missing any
