...
public class ClassOfStateOfAmountOfMoneyBuilder {
  ...
  public ClassOfStateOfAmountOfMoneyBuilder(final IRI iri) {
    this.classOfStateOfAmountOfMoney =
        ClassServices.createClassOfStateOfAmountOfMoney(iri);
  }
  ...
  public final ClassOfStateOfAmountOfMoneyBuilder consists__Of_By_Class(
    ...
    this.classOfStateOfAmountOfMoney.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfStateOfAmountOfMoneyBuilder
  ...
  /**
   * Returns an instance of ClassOfStateOfAmountOfMoney created from the
   * properties set on this builder.
   *
   * @return The built ClassOfStateOfAmountOfMoney.
   * @throws HqdmException If the ClassOfStateOfAmountOfMoney is missing any
