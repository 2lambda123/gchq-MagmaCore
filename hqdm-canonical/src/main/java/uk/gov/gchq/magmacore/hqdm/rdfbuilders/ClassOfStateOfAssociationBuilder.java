...
public class ClassOfStateOfAssociationBuilder {
  ...
  public ClassOfStateOfAssociationBuilder(final IRI iri) {
    this.classOfStateOfAssociation =
        ClassServices.createClassOfStateOfAssociation(iri);
  }
  ...
  public final ClassOfStateOfAssociationBuilder consists__Of_By_Class(
    ...
    this.classOfStateOfAssociation.addValue(
  ...
  /**
   * Returns an instance of ClassOfStateOfAssociation created from the
   * properties set on this builder.
   *
   * @return The built ClassOfStateOfAssociation.
   * @throws HqdmException If the ClassOfStateOfAssociation is missing any
