...
public class ClassOfStateOfBiologicalObjectBuilder {
  ...
  public ClassOfStateOfBiologicalObjectBuilder(final IRI iri) {
    this.classOfStateOfBiologicalObject =
        ClassServices.createClassOfStateOfBiologicalObject(iri);
  }
  ...
  public final ClassOfStateOfBiologicalObjectBuilder consists__Of_By_Class(
    ...
    this.classOfStateOfBiologicalObject.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfStateOfBiologicalObjectBuilder
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfStateOfBiologicalObject.addValue(MEMBER_OF,
                                                 classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfStateOfBiologicalObject created from the
   * properties set on this builder.
   *
   * @return The built ClassOfStateOfBiologicalObject.
   * @throws HqdmException If the ClassOfStateOfBiologicalObject is missing any
  ...
  public ClassOfStateOfBiologicalObject build() throws HqdmException {
    ...
    if (this.classOfStateOfBiologicalObject.hasValue(PART__OF_BY_CLASS) &&
        this.classOfStateOfBiologicalObject.values(PART__OF_BY_CLASS)
            .isEmpty()) {
