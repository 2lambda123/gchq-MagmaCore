...
public class ClassOfStateOfBiologicalSystemBuilder {
  ...
  public ClassOfStateOfBiologicalSystemBuilder(final IRI iri) {
    this.classOfStateOfBiologicalSystem =
        ClassServices.createClassOfStateOfBiologicalSystem(iri);
  }
  ...
  public final ClassOfStateOfBiologicalSystemBuilder consists__Of_By_Class(
    ...
    this.classOfStateOfBiologicalSystem.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfStateOfBiologicalSystemBuilder
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfStateOfBiologicalSystem.addValue(MEMBER_OF,
                                                 classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfStateOfBiologicalSystem created from the
   * properties set on this builder.
   *
   * @return The built ClassOfStateOfBiologicalSystem.
   * @throws HqdmException If the ClassOfStateOfBiologicalSystem is missing any
  ...
  public ClassOfStateOfBiologicalSystem build() throws HqdmException {
    ...
    if (this.classOfStateOfBiologicalSystem.hasValue(PART__OF_BY_CLASS) &&
        this.classOfStateOfBiologicalSystem.values(PART__OF_BY_CLASS)
            .isEmpty()) {
