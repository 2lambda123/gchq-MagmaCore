...
public class ClassOfStateOfBiologicalSystemComponentBuilder {
  ...
  private final ClassOfStateOfBiologicalSystemComponent
      classOfStateOfBiologicalSystemComponent;
  ...
  public ClassOfStateOfBiologicalSystemComponentBuilder(final IRI iri) {
    this.classOfStateOfBiologicalSystemComponent =
        ClassServices.createClassOfStateOfBiologicalSystemComponent(iri);
  }
  ...
  consists__Of_By_Class(
    ...
    this.classOfStateOfBiologicalSystemComponent.addValue(
  ...
  has_Superclass(final Class clazz) {
    this.classOfStateOfBiologicalSystemComponent.addValue(HAS_SUPERCLASS,
                                                          clazz.getId());
    return this;
  }
  ...
  member__Of(final Class clazz) {
    this.classOfStateOfBiologicalSystemComponent.addValue(MEMBER__OF,
                                                          clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfStateOfBiologicalSystemComponent.addValue(MEMBER_OF,
                                                          classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfStateOfBiologicalSystemComponent created from
   * the properties set on this builder.
   *
   * @return The built ClassOfStateOfBiologicalSystemComponent.
   * @throws HqdmException If the ClassOfStateOfBiologicalSystemComponent is
  ...
  public ClassOfStateOfBiologicalSystemComponent build() throws HqdmException {
    ...
    if (this.classOfStateOfBiologicalSystemComponent.hasValue(MEMBER__OF) &&
        this.classOfStateOfBiologicalSystemComponent.values(MEMBER__OF)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member__of");
    }
    if (this.classOfStateOfBiologicalSystemComponent.hasValue(MEMBER_OF) &&
        this.classOfStateOfBiologicalSystemComponent.values(MEMBER_OF)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member_of");
    }
    if (this.classOfStateOfBiologicalSystemComponent.hasValue(MEMBER_OF_) &&
        this.classOfStateOfBiologicalSystemComponent.values(MEMBER_OF_)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member_of_");
    }
    if (this.classOfStateOfBiologicalSystemComponent.hasValue(
            PART__OF_BY_CLASS) &&
