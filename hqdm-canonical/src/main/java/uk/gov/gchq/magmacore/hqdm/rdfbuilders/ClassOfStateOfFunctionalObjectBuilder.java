...
public class ClassOfStateOfFunctionalObjectBuilder {
  ...
  public ClassOfStateOfFunctionalObjectBuilder(final IRI iri) {
    this.classOfStateOfFunctionalObject =
        ClassServices.createClassOfStateOfFunctionalObject(iri);
  }
  ...
  public final ClassOfStateOfFunctionalObjectBuilder consists__Of_By_Class(
    ...
    this.classOfStateOfFunctionalObject.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfStateOfFunctionalObjectBuilder
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfStateOfFunctionalObject.addValue(MEMBER_OF,
                                                 classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfStateOfFunctionalObject created from the
   * properties set on this builder.
   *
   * @return The built ClassOfStateOfFunctionalObject.
   * @throws HqdmException If the ClassOfStateOfFunctionalObject is missing any
  ...
  public ClassOfStateOfFunctionalObject build() throws HqdmException {
    ...
    if (this.classOfStateOfFunctionalObject.hasValue(PART__OF_BY_CLASS) &&
        this.classOfStateOfFunctionalObject.values(PART__OF_BY_CLASS)
            .isEmpty()) {
