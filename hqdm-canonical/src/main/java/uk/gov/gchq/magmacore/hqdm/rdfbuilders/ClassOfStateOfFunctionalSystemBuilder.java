...
public class ClassOfStateOfFunctionalSystemBuilder {
  ...
  public ClassOfStateOfFunctionalSystemBuilder(final IRI iri) {
    this.classOfStateOfFunctionalSystem =
        ClassServices.createClassOfStateOfFunctionalSystem(iri);
  }
  ...
  public final ClassOfStateOfFunctionalSystemBuilder consists__Of_By_Class(
    ...
    this.classOfStateOfFunctionalSystem.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfStateOfFunctionalSystemBuilder
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfStateOfFunctionalSystem.addValue(MEMBER_OF,
                                                 classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfStateOfFunctionalSystem created from the
   * properties set on this builder.
   *
   * @return The built ClassOfStateOfFunctionalSystem.
   * @throws HqdmException If the ClassOfStateOfFunctionalSystem is missing any
  ...
  public ClassOfStateOfFunctionalSystem build() throws HqdmException {
    ...
    if (this.classOfStateOfFunctionalSystem.hasValue(PART__OF_BY_CLASS) &&
        this.classOfStateOfFunctionalSystem.values(PART__OF_BY_CLASS)
            .isEmpty()) {
