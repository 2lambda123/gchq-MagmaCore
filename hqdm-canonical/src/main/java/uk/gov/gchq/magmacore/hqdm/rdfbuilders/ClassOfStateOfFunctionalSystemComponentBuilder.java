...
public class ClassOfStateOfFunctionalSystemComponentBuilder {
  ...
  private final ClassOfStateOfFunctionalSystemComponent
      classOfStateOfFunctionalSystemComponent;
  ...
  public ClassOfStateOfFunctionalSystemComponentBuilder(final IRI iri) {
    this.classOfStateOfFunctionalSystemComponent =
        ClassServices.createClassOfStateOfFunctionalSystemComponent(iri);
  }
  ...
  consists__Of_By_Class(
    ...
    this.classOfStateOfFunctionalSystemComponent.addValue(
  ...
  has_Superclass(final Class clazz) {
    this.classOfStateOfFunctionalSystemComponent.addValue(HAS_SUPERCLASS,
                                                          clazz.getId());
    return this;
  }
  ...
  member__Of(final Class clazz) {
    this.classOfStateOfFunctionalSystemComponent.addValue(MEMBER__OF,
                                                          clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfStateOfFunctionalSystemComponent.addValue(MEMBER_OF,
                                                          classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfStateOfFunctionalSystemComponent created from
   * the properties set on this builder.
   *
   * @return The built ClassOfStateOfFunctionalSystemComponent.
   * @throws HqdmException If the ClassOfStateOfFunctionalSystemComponent is
  ...
  public ClassOfStateOfFunctionalSystemComponent build() throws HqdmException {
    ...
    if (this.classOfStateOfFunctionalSystemComponent.hasValue(MEMBER__OF) &&
        this.classOfStateOfFunctionalSystemComponent.values(MEMBER__OF)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member__of");
    }
    if (this.classOfStateOfFunctionalSystemComponent.hasValue(MEMBER_OF) &&
        this.classOfStateOfFunctionalSystemComponent.values(MEMBER_OF)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member_of");
    }
    if (this.classOfStateOfFunctionalSystemComponent.hasValue(MEMBER_OF_) &&
        this.classOfStateOfFunctionalSystemComponent.values(MEMBER_OF_)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member_of_");
    }
    if (this.classOfStateOfFunctionalSystemComponent.hasValue(
            PART__OF_BY_CLASS) &&
