...
public class ClassOfStateOfIntentionallyConstructedObjectBuilder {
  ...
  private final ClassOfStateOfIntentionallyConstructedObject
      classOfStateOfIntentionallyConstructedObject;

  /**
   * Constructs a Builder for a new
   * ClassOfStateOfIntentionallyConstructedObject.
   *
  ...
  public ClassOfStateOfIntentionallyConstructedObjectBuilder(final IRI iri) {
    this.classOfStateOfIntentionallyConstructedObject =
        ClassServices.createClassOfStateOfIntentionallyConstructedObject(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfStateOfIntentionallyConstructedObjectBuilder
  consists__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.classOfStateOfIntentionallyConstructedObject.addValue(
  ...
  member__Of(final Class clazz) {
    this.classOfStateOfIntentionallyConstructedObject.addValue(MEMBER__OF,
                                                               clazz.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfStateOfIntentionallyConstructedObject created
   * from the properties set on this builder.
   *
   * @return The built ClassOfStateOfIntentionallyConstructedObject.
   * @throws HqdmException If the ClassOfStateOfIntentionallyConstructedObject
   *     is missing any
   *                       mandatory properties.
   */
  public ClassOfStateOfIntentionallyConstructedObject build()
      throws HqdmException {
    if (this.classOfStateOfIntentionallyConstructedObject.hasValue(
            HAS_SUPERCLASS) &&
