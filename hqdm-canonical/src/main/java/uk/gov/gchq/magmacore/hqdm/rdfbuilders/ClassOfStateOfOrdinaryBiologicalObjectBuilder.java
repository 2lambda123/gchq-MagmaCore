...
public class ClassOfStateOfOrdinaryBiologicalObjectBuilder {
  ...
  private final ClassOfStateOfOrdinaryBiologicalObject
  ...
  public ClassOfStateOfOrdinaryBiologicalObjectBuilder(final IRI iri) {
    this.classOfStateOfOrdinaryBiologicalObject =
        ClassServices.createClassOfStateOfOrdinaryBiologicalObject(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfStateOfOrdinaryBiologicalObjectBuilder
  consists__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.classOfStateOfOrdinaryBiologicalObject.addValue(
  ...
  has_Superclass(final Class clazz) {
    this.classOfStateOfOrdinaryBiologicalObject.addValue(HAS_SUPERCLASS,
                                                         clazz.getId());
    return this;
  }
  ...
  member__Of(final Class clazz) {
    this.classOfStateOfOrdinaryBiologicalObject.addValue(MEMBER__OF,
                                                         clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfStateOfOrdinaryBiologicalObject.addValue(MEMBER_OF,
                                                         classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfStateOfOrdinaryBiologicalObject created from
   * the properties set on this builder.
   *
   * @return The built ClassOfStateOfOrdinaryBiologicalObject.
   * @throws HqdmException If the ClassOfStateOfOrdinaryBiologicalObject is
  ...
  public ClassOfStateOfOrdinaryBiologicalObject build() throws HqdmException {
    if (this.classOfStateOfOrdinaryBiologicalObject.hasValue(HAS_SUPERCLASS) &&
        this.classOfStateOfOrdinaryBiologicalObject.values(HAS_SUPERCLASS)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: has_superclass");
    }
    if (this.classOfStateOfOrdinaryBiologicalObject.hasValue(MEMBER__OF) &&
        this.classOfStateOfOrdinaryBiologicalObject.values(MEMBER__OF)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member__of");
    }
    if (this.classOfStateOfOrdinaryBiologicalObject.hasValue(MEMBER_OF) &&
        this.classOfStateOfOrdinaryBiologicalObject.values(MEMBER_OF)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member_of");
    }
    if (this.classOfStateOfOrdinaryBiologicalObject.hasValue(MEMBER_OF_) &&
        this.classOfStateOfOrdinaryBiologicalObject.values(MEMBER_OF_)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member_of_");
    }
    if (this.classOfStateOfOrdinaryBiologicalObject.hasValue(
            PART__OF_BY_CLASS) &&
