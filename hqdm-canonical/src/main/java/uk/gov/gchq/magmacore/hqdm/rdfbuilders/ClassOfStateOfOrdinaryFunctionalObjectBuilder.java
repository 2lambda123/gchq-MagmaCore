...
public class ClassOfStateOfOrdinaryFunctionalObjectBuilder {
  ...
  private final ClassOfStateOfOrdinaryFunctionalObject
  ...
  public ClassOfStateOfOrdinaryFunctionalObjectBuilder(final IRI iri) {
    this.classOfStateOfOrdinaryFunctionalObject =
        ClassServices.createClassOfStateOfOrdinaryFunctionalObject(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfStateOfOrdinaryFunctionalObjectBuilder
  consists__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.classOfStateOfOrdinaryFunctionalObject.addValue(
  ...
  has_Superclass(final Class clazz) {
    this.classOfStateOfOrdinaryFunctionalObject.addValue(HAS_SUPERCLASS,
                                                         clazz.getId());
    return this;
  }
  ...
  member__Of(final Class clazz) {
    this.classOfStateOfOrdinaryFunctionalObject.addValue(MEMBER__OF,
                                                         clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfStateOfOrdinaryFunctionalObject.addValue(MEMBER_OF,
                                                         classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfStateOfOrdinaryFunctionalObject created from
   * the properties set on this builder.
   *
   * @return The built ClassOfStateOfOrdinaryFunctionalObject.
   * @throws HqdmException If the ClassOfStateOfOrdinaryFunctionalObject is
  ...
  public ClassOfStateOfOrdinaryFunctionalObject build() throws HqdmException {
    if (this.classOfStateOfOrdinaryFunctionalObject.hasValue(HAS_SUPERCLASS) &&
        this.classOfStateOfOrdinaryFunctionalObject.values(HAS_SUPERCLASS)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: has_superclass");
    }
    if (this.classOfStateOfOrdinaryFunctionalObject.hasValue(MEMBER__OF) &&
        this.classOfStateOfOrdinaryFunctionalObject.values(MEMBER__OF)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member__of");
    }
    if (this.classOfStateOfOrdinaryFunctionalObject.hasValue(MEMBER_OF) &&
        this.classOfStateOfOrdinaryFunctionalObject.values(MEMBER_OF)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member_of");
    }
    if (this.classOfStateOfOrdinaryFunctionalObject.hasValue(MEMBER_OF_) &&
        this.classOfStateOfOrdinaryFunctionalObject.values(MEMBER_OF_)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member_of_");
    }
    if (this.classOfStateOfOrdinaryFunctionalObject.hasValue(
            PART__OF_BY_CLASS) &&
