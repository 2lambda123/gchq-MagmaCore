...
public class ClassOfStateOfOrdinaryPhysicalObjectBuilder {
  ...
  private final ClassOfStateOfOrdinaryPhysicalObject
  ...
  public ClassOfStateOfOrdinaryPhysicalObjectBuilder(final IRI iri) {
    this.classOfStateOfOrdinaryPhysicalObject =
        ClassServices.createClassOfStateOfOrdinaryPhysicalObject(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfStateOfOrdinaryPhysicalObjectBuilder
  consists__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.classOfStateOfOrdinaryPhysicalObject.addValue(
  ...
  has_Superclass(final Class clazz) {
    this.classOfStateOfOrdinaryPhysicalObject.addValue(HAS_SUPERCLASS,
                                                       clazz.getId());
    return this;
  }
  ...
  member__Of(final Class clazz) {
    this.classOfStateOfOrdinaryPhysicalObject.addValue(MEMBER__OF,
                                                       clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfStateOfOrdinaryPhysicalObject.addValue(MEMBER_OF,
                                                       classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfStateOfOrdinaryPhysicalObject created from
   * the properties set on this builder.
   *
   * @return The built ClassOfStateOfOrdinaryPhysicalObject.
   * @throws HqdmException If the ClassOfStateOfOrdinaryPhysicalObject is
  ...
  public ClassOfStateOfOrdinaryPhysicalObject build() throws HqdmException {
    if (this.classOfStateOfOrdinaryPhysicalObject.hasValue(HAS_SUPERCLASS) &&
        this.classOfStateOfOrdinaryPhysicalObject.values(HAS_SUPERCLASS)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: has_superclass");
    }
    if (this.classOfStateOfOrdinaryPhysicalObject.hasValue(MEMBER__OF) &&
        this.classOfStateOfOrdinaryPhysicalObject.values(MEMBER__OF)
            .isEmpty()) {
    ...
    if (this.classOfStateOfOrdinaryPhysicalObject.hasValue(MEMBER_OF_) &&
        this.classOfStateOfOrdinaryPhysicalObject.values(MEMBER_OF_)
            .isEmpty()) {
