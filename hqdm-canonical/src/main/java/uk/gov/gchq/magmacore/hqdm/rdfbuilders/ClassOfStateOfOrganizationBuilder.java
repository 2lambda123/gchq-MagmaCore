...
public class ClassOfStateOfOrganizationBuilder {
  ...
  public ClassOfStateOfOrganizationBuilder(final IRI iri) {
    this.classOfStateOfOrganization =
        ClassServices.createClassOfStateOfOrganization(iri);
  }
  ...
  public final ClassOfStateOfOrganizationBuilder consists__Of_By_Class(
    ...
    this.classOfStateOfOrganization.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfStateOfOrganizationBuilder
  ...
  /**
   * Returns an instance of ClassOfStateOfOrganization created from the
   * properties set on this builder.
   *
   * @return The built ClassOfStateOfOrganization.
   * @throws HqdmException If the ClassOfStateOfOrganization is missing any
