...
public class ClassOfStateOfOrganizationComponentBuilder {
  ...
  private final ClassOfStateOfOrganizationComponent
  ...
  public ClassOfStateOfOrganizationComponentBuilder(final IRI iri) {
    this.classOfStateOfOrganizationComponent =
        ClassServices.createClassOfStateOfOrganizationComponent(iri);
  }
  ...
  public final ClassOfStateOfOrganizationComponentBuilder consists__Of_By_Class(
    ...
    this.classOfStateOfOrganizationComponent.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfStateOfOrganizationComponentBuilder
  has_Superclass(final Class clazz) {
    this.classOfStateOfOrganizationComponent.addValue(HAS_SUPERCLASS,
                                                      clazz.getId());
    return this;
  }
  ...
  member__Of(final Class clazz) {
    this.classOfStateOfOrganizationComponent.addValue(MEMBER__OF,
                                                      clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfStateOfOrganizationComponent.addValue(MEMBER_OF,
                                                      classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfStateOfOrganizationComponent created from the
   * properties set on this builder.
   *
   * @return The built ClassOfStateOfOrganizationComponent.
   * @throws HqdmException If the ClassOfStateOfOrganizationComponent is missing
   *     any mandatory
   *                       properties.
   */
  public ClassOfStateOfOrganizationComponent build() throws HqdmException {
    if (this.classOfStateOfOrganizationComponent.hasValue(HAS_SUPERCLASS) &&
        this.classOfStateOfOrganizationComponent.values(HAS_SUPERCLASS)
            .isEmpty()) {
    ...
    if (this.classOfStateOfOrganizationComponent.hasValue(PART__OF_BY_CLASS) &&
        this.classOfStateOfOrganizationComponent.values(PART__OF_BY_CLASS)
            .isEmpty()) {
