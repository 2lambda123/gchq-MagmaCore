...
public class ClassOfStateOfPartyBuilder {
   ...
   * @return This builder.
   */
  public final ClassOfStateOfPartyBuilder
  ...
  public final ClassOfStateOfPartyBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfStateOfParty.addValue(
  ...
  /**
   * Returns an instance of ClassOfStateOfParty created from the properties set
   * on this builder.
   *
   * @return The built ClassOfStateOfParty.
   * @throws HqdmException If the ClassOfStateOfParty is missing any mandatory
   *     properties.
   */
