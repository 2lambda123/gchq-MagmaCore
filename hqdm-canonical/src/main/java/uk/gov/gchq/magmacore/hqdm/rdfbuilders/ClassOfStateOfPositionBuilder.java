...
public class ClassOfStateOfPositionBuilder {
  ...
  public ClassOfStateOfPositionBuilder(final IRI iri) {
    this.classOfStateOfPosition =
        ClassServices.createClassOfStateOfPosition(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfStateOfPositionBuilder
  ...
  public final ClassOfStateOfPositionBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfStateOfPosition.addValue(
  ...
  /**
   * Returns an instance of ClassOfStateOfPosition created from the properties
   * set on this builder.
   *
   * @return The built ClassOfStateOfPosition.
   * @throws HqdmException If the ClassOfStateOfPosition is missing any
