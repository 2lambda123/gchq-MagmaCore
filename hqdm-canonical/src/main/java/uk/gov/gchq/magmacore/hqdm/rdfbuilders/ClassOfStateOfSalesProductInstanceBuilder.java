...
public class ClassOfStateOfSalesProductInstanceBuilder {
  ...
  private final ClassOfStateOfSalesProductInstance
  ...
  public ClassOfStateOfSalesProductInstanceBuilder(final IRI iri) {
    this.classOfStateOfSalesProductInstance =
        ClassServices.createClassOfStateOfSalesProductInstance(iri);
  }
  ...
  public final ClassOfStateOfSalesProductInstanceBuilder consists__Of_By_Class(
    ...
    this.classOfStateOfSalesProductInstance.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfStateOfSalesProductInstanceBuilder
  has_Superclass(final Class clazz) {
    this.classOfStateOfSalesProductInstance.addValue(HAS_SUPERCLASS,
                                                     clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfStateOfSalesProductInstance.addValue(MEMBER_OF,
                                                     classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfStateOfSalesProductInstance created from the
   * properties set on this builder.
   *
   * @return The built ClassOfStateOfSalesProductInstance.
   * @throws HqdmException If the ClassOfStateOfSalesProductInstance is missing
   *     any mandatory
   *                       properties.
   */
  public ClassOfStateOfSalesProductInstance build() throws HqdmException {
    if (this.classOfStateOfSalesProductInstance.hasValue(HAS_SUPERCLASS) &&
        this.classOfStateOfSalesProductInstance.values(HAS_SUPERCLASS)
            .isEmpty()) {
    ...
    if (this.classOfStateOfSalesProductInstance.hasValue(PART__OF_BY_CLASS) &&
        this.classOfStateOfSalesProductInstance.values(PART__OF_BY_CLASS)
            .isEmpty()) {
