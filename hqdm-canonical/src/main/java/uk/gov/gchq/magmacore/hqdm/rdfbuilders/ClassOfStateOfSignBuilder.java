...
public class ClassOfStateOfSignBuilder {
   ...
   * @return This builder.
   */
  public final ClassOfStateOfSignBuilder
  ...
  public final ClassOfStateOfSignBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfStateOfSign.addValue(
  ...
  /**
   * Returns an instance of ClassOfStateOfSign created from the properties set
   * on this builder.
   *
   * @return The built ClassOfStateOfSign.
   * @throws HqdmException If the ClassOfStateOfSign is missing any mandatory
   *     properties.
   */
