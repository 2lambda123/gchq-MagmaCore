...
public class ClassOfStateOfSociallyConstructedActivityBuilder {
  ...
  private final ClassOfStateOfSociallyConstructedActivity
      classOfStateOfSociallyConstructedActivity;
  ...
  public ClassOfStateOfSociallyConstructedActivityBuilder(final IRI iri) {
    this.classOfStateOfSociallyConstructedActivity =
        ClassServices.createClassOfStateOfSociallyConstructedActivity(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfStateOfSociallyConstructedActivityBuilder
  consists__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.classOfStateOfSociallyConstructedActivity.addValue(
  ...
  has_Superclass(final Class clazz) {
    this.classOfStateOfSociallyConstructedActivity.addValue(HAS_SUPERCLASS,
                                                            clazz.getId());
    return this;
  }
  ...
  member__Of(final Class clazz) {
    this.classOfStateOfSociallyConstructedActivity.addValue(MEMBER__OF,
                                                            clazz.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfStateOfSociallyConstructedActivity created
   * from the properties set on this builder.
   *
   * @return The built ClassOfStateOfSociallyConstructedActivity.
   * @throws HqdmException If the ClassOfStateOfSociallyConstructedActivity is
   *     missing any mandatory
   *                       properties.
   */
  public ClassOfStateOfSociallyConstructedActivity build()
      throws HqdmException {
    if (this.classOfStateOfSociallyConstructedActivity.hasValue(
            HAS_SUPERCLASS) &&
    ...
    if (this.classOfStateOfSociallyConstructedActivity.hasValue(MEMBER__OF) &&
        this.classOfStateOfSociallyConstructedActivity.values(MEMBER__OF)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member__of");
    }
    if (this.classOfStateOfSociallyConstructedActivity.hasValue(MEMBER_OF) &&
        this.classOfStateOfSociallyConstructedActivity.values(MEMBER_OF)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member_of");
    }
    if (this.classOfStateOfSociallyConstructedActivity.hasValue(MEMBER_OF_) &&
        this.classOfStateOfSociallyConstructedActivity.values(MEMBER_OF_)
            .isEmpty()) {
