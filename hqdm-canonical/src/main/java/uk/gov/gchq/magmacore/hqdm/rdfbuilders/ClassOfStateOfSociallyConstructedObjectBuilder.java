...
public class ClassOfStateOfSociallyConstructedObjectBuilder {
  ...
  private final ClassOfStateOfSociallyConstructedObject
      classOfStateOfSociallyConstructedObject;
  ...
  public ClassOfStateOfSociallyConstructedObjectBuilder(final IRI iri) {
    this.classOfStateOfSociallyConstructedObject =
        ClassServices.createClassOfStateOfSociallyConstructedObject(iri);
  }
   ...
   * @return This builder.
   */
  public final ClassOfStateOfSociallyConstructedObjectBuilder
  consists__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.classOfStateOfSociallyConstructedObject.addValue(
  ...
  has_Superclass(final Class clazz) {
    this.classOfStateOfSociallyConstructedObject.addValue(HAS_SUPERCLASS,
                                                          clazz.getId());
    return this;
  }
  ...
  member__Of(final Class clazz) {
    this.classOfStateOfSociallyConstructedObject.addValue(MEMBER__OF,
                                                          clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfStateOfSociallyConstructedObject.addValue(MEMBER_OF,
                                                          classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfStateOfSociallyConstructedObject created from
   * the properties set on this builder.
   *
   * @return The built ClassOfStateOfSociallyConstructedObject.
   * @throws HqdmException If the ClassOfStateOfSociallyConstructedObject is
  ...
  public ClassOfStateOfSociallyConstructedObject build() throws HqdmException {
    ...
    if (this.classOfStateOfSociallyConstructedObject.hasValue(MEMBER__OF) &&
        this.classOfStateOfSociallyConstructedObject.values(MEMBER__OF)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member__of");
    }
    if (this.classOfStateOfSociallyConstructedObject.hasValue(MEMBER_OF) &&
        this.classOfStateOfSociallyConstructedObject.values(MEMBER_OF)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member_of");
    }
    if (this.classOfStateOfSociallyConstructedObject.hasValue(MEMBER_OF_) &&
        this.classOfStateOfSociallyConstructedObject.values(MEMBER_OF_)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: member_of_");
    }
    if (this.classOfStateOfSociallyConstructedObject.hasValue(
            PART__OF_BY_CLASS) &&
