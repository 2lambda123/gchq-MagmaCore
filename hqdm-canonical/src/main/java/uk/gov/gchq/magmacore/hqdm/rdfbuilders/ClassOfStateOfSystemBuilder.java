...
public class ClassOfStateOfSystemBuilder {
   ...
   * @return This builder.
   */
  public final ClassOfStateOfSystemBuilder
  ...
  public final ClassOfStateOfSystemBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfStateOfSystem.addValue(
  ...
  /**
   * Returns an instance of ClassOfStateOfSystem created from the properties set
   * on this builder.
   *
   * @return The built ClassOfStateOfSystem.
   * @throws HqdmException If the ClassOfStateOfSystem is missing any mandatory
   *     properties.
   */
