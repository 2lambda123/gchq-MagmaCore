...
public class ClassOfStateOfSystemComponentBuilder {
  ...
  public ClassOfStateOfSystemComponentBuilder(final IRI iri) {
    this.classOfStateOfSystemComponent =
        ClassServices.createClassOfStateOfSystemComponent(iri);
  }
  ...
  public final ClassOfStateOfSystemComponentBuilder consists__Of_By_Class(
    ...
    this.classOfStateOfSystemComponent.addValue(
   ...
   * @return This builder.
   */
  public final ClassOfStateOfSystemComponentBuilder
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.classOfStateOfSystemComponent.addValue(MEMBER_OF,
                                                classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ClassOfStateOfSystemComponent created from the
   * properties set on this builder.
   *
   * @return The built ClassOfStateOfSystemComponent.
   * @throws HqdmException If the ClassOfStateOfSystemComponent is missing any
  ...
  public ClassOfStateOfSystemComponent build() throws HqdmException {
    ...
    if (this.classOfStateOfSystemComponent.hasValue(PART__OF_BY_CLASS) &&
        this.classOfStateOfSystemComponent.values(PART__OF_BY_CLASS)
            .isEmpty()) {
