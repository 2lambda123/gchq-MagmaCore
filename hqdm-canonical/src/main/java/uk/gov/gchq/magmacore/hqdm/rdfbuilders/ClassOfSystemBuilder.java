...
public class ClassOfSystemBuilder {
  ...
  public final ClassOfSystemBuilder consists__Of_By_Class(
    ...
    this.classOfSystem.addValue(CONSISTS__OF_BY_CLASS,
  ...
  public final ClassOfSystemBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.classOfSystem.addValue(MEMBER_OF_,
  ...
  public final ClassOfSystemBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.classOfSystem.addValue(PART__OF_BY_CLASS,
                                classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of ClassOfSystem created from the properties set on
   * this builder.
   *
   * @return The built ClassOfSystem.
   * @throws HqdmException If the ClassOfSystem is missing any mandatory
   *     properties.
   */
