...
public class ClassificationBuilder {
  ...
  /**
   * A relationship type where a {@link Classification} has exactly one
   * classifier.
   *
   ...
   *
   * <p>
   * Note: This relationship is the same as the entity type {@link
   * Classification}.
   * </p>
   * clazz.
   *
   ...
   * @return This builder.
   */
  public final ClassificationBuilder
  ...
  /**
   * Returns an instance of Classification created from the properties set on
   * this builder.
   *
   * @return The built Classification.
   * @throws HqdmException If the Classification is missing any mandatory
   *     properties.
   */
