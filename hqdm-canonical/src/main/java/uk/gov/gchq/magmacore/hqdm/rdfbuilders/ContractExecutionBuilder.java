...
public class ContractExecutionBuilder {
  ...
  public ContractExecutionBuilder(final IRI iri) {
    this.contractExecution =
        SpatioTemporalExtentServices.createContractExecution(iri);
  }
   ...
   * @return This builder.
   */
  public final ContractExecutionBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.contractExecution.addValue(AGGREGATED_INTO,
  ...
  consists_Of_Participant(final Participant participant) {
    this.contractExecution.addValue(CONSISTS_OF_PARTICIPANT,
                                    participant.getId());
    return this;
  }
  ...
  member_Of(final ClassOfContractExecution classOfContractExecution) {
    this.contractExecution.addValue(MEMBER_OF,
   ...
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} relationship type
   * where a
   * {@link ContractExecution} is {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} exactly one
   ...
   */
  public final ContractExecutionBuilder
  part_Of_M(final ContractProcess contractProcess) {
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.contractExecution.addValue(PART_OF_POSSIBLE_WORLD,
                                    possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.contractExecution.addValue(TEMPORAL__PART_OF,
                                    spatioTemporalExtent.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ContractExecution created from the properties set on
   * this builder.
   *
   * @return The built ContractExecution.
   * @throws HqdmException If the ContractExecution is missing any mandatory
   *     properties.
   */
