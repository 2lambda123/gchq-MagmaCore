...
public class ContractProcessBuilder {
  ...
  public ContractProcessBuilder(final IRI iri) {
    this.contractProcess =
        SpatioTemporalExtentServices.createContractProcess(iri);
  }
   ...
   * @return This builder.
   */
  public final ContractProcessBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.contractProcess.addValue(AGGREGATED_INTO,
   ...
   * type where a
   * {@link ContractProcess} {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#CONSISTS_OF} exactly one
   * {@link AgreeContract}.
   *
   ...
   */
  public final ContractProcessBuilder
  consists_Of(final AgreeContract agreeContract) {
   ...
   */
  public final ContractProcessBuilder
  consists_Of_(final ContractExecution contractExecution) {
   ...
   * type where a contract process may be a {@link
   ...
   */
  public final ContractProcessBuilder
  member_Of(final ClassOfContractProcess classOfContractProcess) {
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.contractProcess.addValue(PART_OF_POSSIBLE_WORLD,
                                  possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.contractProcess.addValue(TEMPORAL__PART_OF,
                                  spatioTemporalExtent.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ContractProcess created from the properties set on
   * this builder.
   *
   * @return The built ContractProcess.
   * @throws HqdmException If the ContractProcess is missing any mandatory
   *     properties.
   */
