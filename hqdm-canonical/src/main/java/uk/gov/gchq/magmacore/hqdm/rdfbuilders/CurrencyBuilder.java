...
public class CurrencyBuilder {
  ...
  public final CurrencyBuilder consists__Of_By_Class(
    ...
    this.currency.addValue(CONSISTS__OF_BY_CLASS,
  ...
  public final CurrencyBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.currency.addValue(MEMBER_OF_,
  ...
  public final CurrencyBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.currency.addValue(PART__OF_BY_CLASS,
                           classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of Currency created from the properties set on this
   * builder.
   *
