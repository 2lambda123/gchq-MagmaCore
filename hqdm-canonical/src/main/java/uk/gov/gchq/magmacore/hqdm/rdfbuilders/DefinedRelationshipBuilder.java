...
public class DefinedRelationshipBuilder {
  ...
  public DefinedRelationshipBuilder(final IRI iri) {
    this.definedRelationship =
        RelationshipServices.createDefinedRelationship(iri);
  }
   ...
   * @return This builder.
   */
  public final DefinedRelationshipBuilder
  involves_M(final Classification classification) {
   ...
   * type where a relationship is a {@link
   ...
   */
  public final DefinedRelationshipBuilder
  member_Of(final ClassOfRelationship classOfRelationship) {
   ...
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} relationship
   * type where each
   * {@link DefinedRelationship} is a {@link
  ...
  public final DefinedRelationshipBuilder member_Of_Kind_M(
    ...
    this.definedRelationship.addValue(RDFS.RDF_TYPE,
                                      kindOfRelationshipWithSignature.getId());
    return this;
  }

  /**
   * Returns an instance of DefinedRelationship created from the properties set
   * on this builder.
   *
   * @return The built DefinedRelationship.
   * @throws HqdmException If the DefinedRelationship is missing any mandatory
   *     properties.
   */
