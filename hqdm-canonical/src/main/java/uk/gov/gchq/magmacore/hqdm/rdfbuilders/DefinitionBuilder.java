...
public class DefinitionBuilder {
  ...
  public final DefinitionBuilder consists_Of_In_Members_M(
    ...
    this.definition.addValue(CONSISTS_OF_IN_MEMBERS,
                             recognizingLanguageCommunity.getId());
    return this;
  }

  /**
   * A relationship type where exactly one {@link Class} is defined by the
   * {@link Definition}.
   *
  ...
  /**
   * Returns an instance of Definition created from the properties set on this
   * builder.
   *
   * @return The built Definition.
   * @throws HqdmException If the Definition is missing any mandatory
   *     properties.
   */
