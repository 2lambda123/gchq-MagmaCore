...
public class DescriptionBuilder {
   ...
   * @return This builder.
   */
  public final DescriptionBuilder
  ...
  public final DescriptionBuilder consists_Of_In_Members_M(
    ...
    this.description.addValue(CONSISTS_OF_IN_MEMBERS,
  ...
  /**
   * Returns an instance of Description created from the properties set on this
   * builder.
   *
   * @return The built Description.
   * @throws HqdmException If the Description is missing any mandatory
   *     properties.
   */
