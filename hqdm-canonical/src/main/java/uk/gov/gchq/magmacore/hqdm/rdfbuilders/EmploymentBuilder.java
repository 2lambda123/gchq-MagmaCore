...
public class EmploymentBuilder {
   ...
   * @return This builder.
   */
  public final EmploymentBuilder
   ...
   * relationship type where an {@link Employment} consists of exactly one
   * {@link Employer}.
   *
   ...
   */
  public final EmploymentBuilder
  consists_Of_Participant(final Employer employer) {
   ...
   */
  public final EmploymentBuilder
  consists_Of_Participant_(final Employee employee) {
  ...
  /**
   * Returns an instance of Employment created from the properties set on this
   * builder.
   *
   * @return The built Employment.
   * @throws HqdmException If the Employment is missing any mandatory
   *     properties.
   */
