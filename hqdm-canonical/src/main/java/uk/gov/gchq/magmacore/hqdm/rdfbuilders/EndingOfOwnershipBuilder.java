...
public class EndingOfOwnershipBuilder {
  ...
  public EndingOfOwnershipBuilder(final IRI iri) {
    this.endingOfOwnership =
        SpatioTemporalExtentServices.createEndingOfOwnership(iri);
  }
   ...
   * @return This builder.
   */
  public final EndingOfOwnershipBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.endingOfOwnership.addValue(AGGREGATED_INTO,
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.endingOfOwnership.addValue(PART_OF_POSSIBLE_WORLD,
                                    possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.endingOfOwnership.addValue(TEMPORAL__PART_OF,
                                    spatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of EndingOfOwnership created from the properties set on
   * this builder.
   *
   * @return The built EndingOfOwnership.
   * @throws HqdmException If the EndingOfOwnership is missing any mandatory
   *     properties.
   */
