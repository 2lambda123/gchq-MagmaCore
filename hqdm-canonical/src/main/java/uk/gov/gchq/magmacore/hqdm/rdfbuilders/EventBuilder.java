...
public class EventBuilder {
  ...
  /**
   * Returns an instance of Event created from the properties set on this
   * builder.
   *
  ...
  public Event build() throws HqdmException {
    ...
    if (this.event.hasValue(ENDING) && this.event.values(ENDING).isEmpty()) {
