...
public class ExchangeOfGoodsAndMoneyBuilder {
  ...
  public ExchangeOfGoodsAndMoneyBuilder(final IRI iri) {
    exchangeOfGoodsAndMoney =
        SpatioTemporalExtentServices.createExchangeOfGoodsAndMoney(iri);
  }
  ...
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.exchangeOfGoodsAndMoney.addValue(AGGREGATED_INTO,
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.exchangeOfGoodsAndMoney.addValue(CONSISTS__OF,
                                          spatioTemporalExtent.getId());
    return this;
  }
   ...
   * type where an
   * {@link ExchangeOfGoodsAndMoney} consists of exactly one {@link
   * TransferOfOwnership} as a part.
   *
   * @param transferOfOwnership The TransferOfOwnership.
   * @return Builder
   */
  public final ExchangeOfGoodsAndMoneyBuilder
  consists_Of(final TransferOfOwnership transferOfOwnership) {
    this.exchangeOfGoodsAndMoney.addValue(CONSISTS_OF,
   ...
   */
  public final ExchangeOfGoodsAndMoneyBuilder
  consists_Of_(final TransferOfOwnershipOfMoney transferOfOwnershipOfMoney) {
    this.exchangeOfGoodsAndMoney.addValue(CONSISTS_OF_,
                                          transferOfOwnershipOfMoney.getId());
    return this;
  }
  ...
  consists_Of_Participant(final Participant participant) {
    this.exchangeOfGoodsAndMoney.addValue(CONSISTS_OF_PARTICIPANT,
                                          participant.getId());
    return this;
  }
   ...
   */
  public final ExchangeOfGoodsAndMoneyBuilder
  member_Of(final ClassOfContractExecution classOfContractExecution) {
    this.exchangeOfGoodsAndMoney.addValue(MEMBER_OF,
                                          classOfContractExecution.getId());
    return this;
  }
  ...
  member_Of_Kind_M(final KindOfActivity kindOfActivity) {
    this.exchangeOfGoodsAndMoney.addValue(MEMBER_OF_KIND,
                                          kindOfActivity.getId());
    this.exchangeOfGoodsAndMoney.addValue(RDFS.RDF_TYPE,
                                          kindOfActivity.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.exchangeOfGoodsAndMoney.addValue(PART__OF,
                                          spatioTemporalExtent.getId());
    return this;
  }
   ...
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} relationship type
   * where an
   * {@link ExchangeOfGoodsAndMoney} is a {@link
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.exchangeOfGoodsAndMoney.addValue(PART_OF_POSSIBLE_WORLD,
                                          possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.exchangeOfGoodsAndMoney.addValue(TEMPORAL__PART_OF,
                                          spatioTemporalExtent.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ExchangeOfGoodsAndMoney created from the properties
   * set on this builder.
   *
   * @return The built ExchangeOfGoodsAndMoney.
   * @throws HqdmException If the ExchangeOfGoodsAndMoney is missing any
