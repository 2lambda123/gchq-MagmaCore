...
public class FunctionalObjectBuilder {
   ...
   * @return This builder.
   */
  public final FunctionalObjectBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.functionalObject.addValue(AGGREGATED_INTO,
  ...
  /**
   * A relationship type where a {@link FunctionalObject} has one or more
   * intended {@link Role}.
   *
   * @param role The Role.
   * @return This builder.
   ...
   * type where a
   * {@link FunctionalObject} may be a {@link
   ...
   */
  public final FunctionalObjectBuilder
  member_Of(final ClassOfFunctionalObject classOfFunctionalObject) {
   ...
   */
  public final FunctionalObjectBuilder
  member_Of_Kind(final KindOfFunctionalObject kindOfFunctionalObject) {
    this.functionalObject.addValue(MEMBER_OF_KIND,
                                   kindOfFunctionalObject.getId());
    this.functionalObject.addValue(RDFS.RDF_TYPE,
                                   kindOfFunctionalObject.getId());
    return this;
  }
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.functionalObject.addValue(PART_OF_POSSIBLE_WORLD,
                                   possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.functionalObject.addValue(TEMPORAL__PART_OF,
                                   spatioTemporalExtent.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of FunctionalObject created from the properties set on
   * this builder.
   *
   * @return The built FunctionalObject.
   * @throws HqdmException If the FunctionalObject is missing any mandatory
   *     properties.
   */
