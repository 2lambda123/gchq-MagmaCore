...
public class IdentificationBuilder {
   ...
   * @return This builder.
   */
  public final IdentificationBuilder
  ...
  /**
   * Returns an instance of Identification created from the properties set on
   * this builder.
   *
   * @return The built Identification.
   * @throws HqdmException If the Identification is missing any mandatory
   *     properties.
   */
