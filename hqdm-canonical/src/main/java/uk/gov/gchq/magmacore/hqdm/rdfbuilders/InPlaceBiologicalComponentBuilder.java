...
public class InPlaceBiologicalComponentBuilder {
  ...
  public InPlaceBiologicalComponentBuilder(final IRI iri) {
    inPlaceBiologicalComponent =
        SpatioTemporalExtentServices.createInPlaceBiologicalComponent(iri);
  }
   ...
   * @return This builder.
   */
  public final InPlaceBiologicalComponentBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.inPlaceBiologicalComponent.addValue(AGGREGATED_INTO,
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.inPlaceBiologicalComponent.addValue(CONSISTS__OF,
                                             spatioTemporalExtent.getId());
    return this;
  }
   ...
   *
   * @param classOfInPlaceBiologicalComponent The
   *     ClassOfInPlaceBiologicalComponent.
   * @return This builder.
   */
  public final InPlaceBiologicalComponentBuilder member_Of(
      final ClassOfInPlaceBiologicalComponent
          classOfInPlaceBiologicalComponent) {
    this.inPlaceBiologicalComponent.addValue(
        MEMBER_OF, classOfInPlaceBiologicalComponent.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.inPlaceBiologicalComponent.addValue(PART__OF,
                                             spatioTemporalExtent.getId());
    return this;
  }
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.inPlaceBiologicalComponent.addValue(PART_OF_POSSIBLE_WORLD,
                                             possibleWorld.getId());
    return this;
  }
   ...
   * relationship type where a
   * {@link uk.gov.gchq.magmacore.hqdm.model.StateOfBiologicalSystemComponent}
   * may be a
  ...
  /**
   * Returns an instance of InPlaceBiologicalComponent created from the
   * properties set on this builder.
   *
   * @return The built InPlaceBiologicalComponent.
   * @throws HqdmException If the InPlaceBiologicalComponent is missing any
