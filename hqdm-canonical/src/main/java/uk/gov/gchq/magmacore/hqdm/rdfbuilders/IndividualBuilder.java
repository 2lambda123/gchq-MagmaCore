...
public class IndividualBuilder {
   ...
   * @return This builder.
   */
  public final IndividualBuilder
   ...
   */
  public final IndividualBuilder
  member_Of(final ClassOfIndividual classOfIndividual) {
  ...
  /**
   * Returns an instance of Individual created from the properties set on this
   * builder.
   *
   * @return The built Individual.
   * @throws HqdmException If the Individual is missing any mandatory
   *     properties.
   */
