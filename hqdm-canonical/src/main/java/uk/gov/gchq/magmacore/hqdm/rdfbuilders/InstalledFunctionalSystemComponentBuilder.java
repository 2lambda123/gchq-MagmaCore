...
public class InstalledFunctionalSystemComponentBuilder {
  ...
  private final InstalledFunctionalSystemComponent
   ...
   * @return This builder.
   */
  public final InstalledFunctionalSystemComponentBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.installedFunctionalSystemComponent.addValue(
  ...
  public final InstalledFunctionalSystemComponentBuilder
  member_Of(final ClassOfInstalledFunctionalSystemComponent
                classOfInstalledFunctionalSystemComponent) {
    this.installedFunctionalSystemComponent.addValue(
        MEMBER_OF, classOfInstalledFunctionalSystemComponent.getId());
    return this;
  }
   ...
   */
  public final InstalledFunctionalSystemComponentBuilder
  temporal_Part_Of(final FunctionalSystemComponent functionalSystemComponent) {
    this.installedFunctionalSystemComponent.addValue(
        TEMPORAL_PART_OF, functionalSystemComponent.getId());
    return this;
  }

  /**
   * Returns an instance of InstalledFunctionalSystemComponent created from the
   * properties set on this builder.
   *
   * @return The built InstalledFunctionalSystemComponent.
   * @throws HqdmException If the InstalledFunctionalSystemComponent is missing
   *     any mandatory
   *                       properties.
   */
  public InstalledFunctionalSystemComponent build() throws HqdmException {
    if (this.installedFunctionalSystemComponent.hasValue(AGGREGATED_INTO) &&
        this.installedFunctionalSystemComponent.values(AGGREGATED_INTO)
            .isEmpty()) {
