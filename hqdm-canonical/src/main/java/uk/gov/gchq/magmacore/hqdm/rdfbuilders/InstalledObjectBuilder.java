...
public class InstalledObjectBuilder {
   ...
   * @return This builder.
   */
  public final InstalledObjectBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.installedObject.addValue(AGGREGATED_INTO,
   ...
   * type where an
   * {@link InstalledObject} may be a {@link
   ...
   */
  public final InstalledObjectBuilder
  member_Of(final ClassOfInstalledObject classOfInstalledObject) {
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.installedObject.addValue(PART_OF_POSSIBLE_WORLD,
                                  possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.installedObject.addValue(TEMPORAL__PART_OF,
                                  spatioTemporalExtent.getId());
    return this;
  }
   ...
   * relationship type where a
   * {@link uk.gov.gchq.magmacore.hqdm.model.StateOfOrdinaryPhysicalObject} may
   * be a
  ...
  temporal_Part_Of(final OrdinaryPhysicalObject ordinaryPhysicalObject) {
    this.installedObject.addValue(TEMPORAL_PART_OF,
                                  ordinaryPhysicalObject.getId());
    return this;
  }

  /**
   * Returns an instance of InstalledObject created from the properties set on
   * this builder.
   *
   * @return The built InstalledObject.
   * @throws HqdmException If the InstalledObject is missing any mandatory
   *     properties.
   */
