...
public class IntentionallyConstructedObjectBuilder {
  ...
  public IntentionallyConstructedObjectBuilder(final IRI iri) {
    intentionallyConstructedObject =
        SpatioTemporalExtentServices.createIntentionallyConstructedObject(iri);
  }
   ...
   * @return This builder.
   */
  public final IntentionallyConstructedObjectBuilder
   ...
   *
   * @param classOfIntentionallyConstructedObject The
   *     ClassOfIntentionallyConstructedObject.
   * @return This builder.
   */
  public final IntentionallyConstructedObjectBuilder member_Of(
      final ClassOfIntentionallyConstructedObject
          classOfIntentionallyConstructedObject) {
    this.intentionallyConstructedObject.addValue(
        MEMBER_OF, classOfIntentionallyConstructedObject.getId());
    return this;
  }

  /**
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF_KIND}
   * relationship type where an
   * {@link IntentionallyConstructedObject} may be a
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} one or more
   * {@link KindOfIntentionallyConstructedObject}.
   *
   * @param kindOfIntentionallyConstructedObject The
   *     KindOfIntentionallyConstructedObject.
   * @return This builder.
   */
  public final IntentionallyConstructedObjectBuilder member_Of_Kind(
      final KindOfIntentionallyConstructedObject
          kindOfIntentionallyConstructedObject) {
    this.intentionallyConstructedObject.addValue(
        MEMBER_OF_KIND, kindOfIntentionallyConstructedObject.getId());
    this.intentionallyConstructedObject.addValue(
        RDFS.RDF_TYPE, kindOfIntentionallyConstructedObject.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.intentionallyConstructedObject.addValue(PART__OF,
                                                 spatioTemporalExtent.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of IntentionallyConstructedObject created from the
   * properties set on this builder.
   *
   * @return The built IntentionallyConstructedObject.
   * @throws HqdmException If the IntentionallyConstructedObject is missing any
  ...
  public IntentionallyConstructedObject build() throws HqdmException {
    ...
    if (this.intentionallyConstructedObject.hasValue(TEMPORAL__PART_OF) &&
        this.intentionallyConstructedObject.values(TEMPORAL__PART_OF)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: temporal__part_of");
    }
    if (this.intentionallyConstructedObject.hasValue(TEMPORAL_PART_OF) &&
        this.intentionallyConstructedObject.values(TEMPORAL_PART_OF)
            .isEmpty()) {
