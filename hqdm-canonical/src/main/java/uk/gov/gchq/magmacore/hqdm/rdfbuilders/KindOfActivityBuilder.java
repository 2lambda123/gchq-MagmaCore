...
public class KindOfActivityBuilder {
   ...
   * {@link KindOfActivity} causes a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} the
   * {@link ClassOfEvent}.
   *
   ...
   * @return This builder.
   */
  public final KindOfActivityBuilder
  causes_By_Class(final ClassOfEvent classOfEvent) {
  ...
  /**
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#CONSISTS_OF_BY_CLASS}
   * relationship type where a
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} a {@link
   * KindOfActivity} has a
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} a {@link Role} as
   * a
   ...
   * A relationship type where a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} the
   * {@link KindOfActivity} determines a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} the
   * {@link Class}.
   *
  ...
  public final KindOfActivityBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.kindOfActivity.addValue(MEMBER_OF_,
  ...
  public final KindOfActivityBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.kindOfActivity.addValue(PART__OF_BY_CLASS,
                                 classOfSpatioTemporalExtent.getId());
    return this;
  }
   ...
   * A relationship type where a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} the
   * {@link KindOfActivity} references a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} the
   * {@link Class}.
   *
   * @param clazz The Class.
  ...
  /**
   * Returns an instance of KindOfActivity created from the properties set on
   * this builder.
   *
   * @return The built KindOfActivity.
   * @throws HqdmException If the KindOfActivity is missing any mandatory
   *     properties.
   */
