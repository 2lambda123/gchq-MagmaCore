...
public class KindOfAssociationBuilder {
   ...
   * KindOfAssociation} has a
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} the {@link Role}
   * as a part.
   *
   * @param role The Role.
   * @return This builder.
   ...
   * @return This builder.
   */
  public final KindOfAssociationBuilder
  ...
  public final KindOfAssociationBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.kindOfAssociation.addValue(MEMBER_OF_,
  ...
  public final KindOfAssociationBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.kindOfAssociation.addValue(PART__OF_BY_CLASS,
                                    classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of KindOfAssociation created from the properties set on
   * this builder.
   *
   * @return The built KindOfAssociation.
   * @throws HqdmException If the KindOfAssociation is missing any mandatory
   *     properties.
   */
