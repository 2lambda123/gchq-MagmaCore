...
public class KindOfBiologicalSystemBuilder {
  ...
  public final KindOfBiologicalSystemBuilder has_Component_By_Class_M(
    ...
    this.kindOfBiologicalSystem.addValue(
        HAS_COMPONENT_BY_CLASS, kindOfBiologicalSystemComponent.getId());
    return this;
  }
   ...
   * @return This builder.
   */
  public final KindOfBiologicalSystemBuilder
   ...
   */
  public final KindOfBiologicalSystemBuilder
  natural_Role_By_Class_M(final Role role) {
  ...
  /**
   * Returns an instance of KindOfBiologicalSystem created from the properties
   * set on this builder.
   *
   * @return The built KindOfBiologicalSystem.
   * @throws HqdmException If the KindOfBiologicalSystem is missing any
