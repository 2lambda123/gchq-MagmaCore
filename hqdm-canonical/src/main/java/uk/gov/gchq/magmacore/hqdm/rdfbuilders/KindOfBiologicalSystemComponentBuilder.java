...
public class KindOfBiologicalSystemComponentBuilder {
  ...
  public KindOfBiologicalSystemComponentBuilder(final IRI iri) {
    kindOfBiologicalSystemComponent =
        ClassServices.createKindOfBiologicalSystemComponent(iri);
  }
  ...
  public final KindOfBiologicalSystemComponentBuilder consists__Of_By_Class(
    ...
    this.kindOfBiologicalSystemComponent.addValue(
  ...
  has_Superclass(final Class clazz) {
    this.kindOfBiologicalSystemComponent.addValue(HAS_SUPERCLASS,
                                                  clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.kindOfBiologicalSystemComponent.addValue(MEMBER_OF,
                                                  classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of KindOfBiologicalSystemComponent created from the
   * properties set on this builder.
   *
   * @return The built KindOfBiologicalSystemComponent.
   * @throws HqdmException If the KindOfBiologicalSystemComponent is missing any
  ...
  public KindOfBiologicalSystemComponent build() throws HqdmException {
    ...
    if (this.kindOfBiologicalSystemComponent.hasValue(PART__OF_BY_CLASS) &&
        this.kindOfBiologicalSystemComponent.values(PART__OF_BY_CLASS)
            .isEmpty()) {
