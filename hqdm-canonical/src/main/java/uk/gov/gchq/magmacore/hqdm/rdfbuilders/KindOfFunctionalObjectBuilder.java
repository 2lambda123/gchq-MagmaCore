...
public class KindOfFunctionalObjectBuilder {
   ...
   * A relationship type where each {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} a
   * {@link KindOfFunctionalObject} is intended to play one or more {@link
   * Role}.
   *
   * @param role The Role.
   * @return This builder.
  ...
  public final KindOfFunctionalObjectBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.kindOfFunctionalObject.addValue(
  ...
  /**
   * Returns an instance of KindOfFunctionalObject created from the properties
   * set on this builder.
   *
   * @return The built KindOfFunctionalObject.
   * @throws HqdmException If the KindOfFunctionalObject is missing any
