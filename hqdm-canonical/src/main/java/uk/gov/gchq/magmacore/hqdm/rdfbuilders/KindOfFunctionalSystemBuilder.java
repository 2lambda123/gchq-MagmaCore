...
public class KindOfFunctionalSystemBuilder {
   ...
   * KindOfFunctionalSystem} has a {@link
  ...
  public final KindOfFunctionalSystemBuilder has_Component_By_Class_M(
    ...
    this.kindOfFunctionalSystem.addValue(
        HAS_COMPONENT_BY_CLASS, kindOfFunctionalSystemComponent.getId());
    return this;
  }
   ...
   * @return This builder.
   */
  public final KindOfFunctionalSystemBuilder
  ...
  /**
   * Returns an instance of KindOfFunctionalSystem created from the properties
   * set on this builder.
   *
   * @return The built KindOfFunctionalSystem.
   * @throws HqdmException If the KindOfFunctionalSystem is missing any
