...
public class KindOfFunctionalSystemComponentBuilder {
  ...
  public KindOfFunctionalSystemComponentBuilder(final IRI iri) {
    kindOfFunctionalSystemComponent =
        ClassServices.createKindOfFunctionalSystemComponent(iri);
  }
  ...
  public final KindOfFunctionalSystemComponentBuilder consists__Of_By_Class(
    ...
    this.kindOfFunctionalSystemComponent.addValue(
   ...
   * @return This builder.
   */
  public final KindOfFunctionalSystemComponentBuilder
  has_Superclass(final Class clazz) {
    this.kindOfFunctionalSystemComponent.addValue(HAS_SUPERCLASS,
                                                  clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.kindOfFunctionalSystemComponent.addValue(MEMBER_OF,
                                                  classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of KindOfFunctionalSystemComponent created from the
   * properties set on this builder.
   *
   * @return The built KindOfFunctionalSystemComponent.
   * @throws HqdmException If the KindOfFunctionalSystemComponent is missing any
  ...
  public KindOfFunctionalSystemComponent build() throws HqdmException {
    ...
    if (this.kindOfFunctionalSystemComponent.hasValue(PART__OF_BY_CLASS) &&
        this.kindOfFunctionalSystemComponent.values(PART__OF_BY_CLASS)
            .isEmpty()) {
