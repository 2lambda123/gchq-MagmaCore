...
public class KindOfIndividualBuilder {
  ...
  public final KindOfIndividualBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.kindOfIndividual.addValue(MEMBER_OF_,
  ...
  public final KindOfIndividualBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.kindOfIndividual.addValue(PART__OF_BY_CLASS,
                                   classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of KindOfIndividual created from the properties set on
   * this builder.
   *
   * @return The built KindOfIndividual.
   * @throws HqdmException If the KindOfIndividual is missing any mandatory
   *     properties.
   */
