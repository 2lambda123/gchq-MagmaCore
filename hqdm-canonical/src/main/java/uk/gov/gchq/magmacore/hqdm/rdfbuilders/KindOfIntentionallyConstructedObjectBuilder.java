...
public class KindOfIntentionallyConstructedObjectBuilder {
  ...
  private final KindOfIntentionallyConstructedObject
  ...
  public KindOfIntentionallyConstructedObjectBuilder(final IRI iri) {
    kindOfIntentionallyConstructedObject =
        ClassServices.createKindOfIntentionallyConstructedObject(iri);
  }
   ...
   * @return This builder.
   */
  public final KindOfIntentionallyConstructedObjectBuilder
  ...
  has_Superclass(final Class clazz) {
    this.kindOfIntentionallyConstructedObject.addValue(HAS_SUPERCLASS,
                                                       clazz.getId());
    return this;
  }
  ...
  member__Of(final Class clazz) {
    this.kindOfIntentionallyConstructedObject.addValue(MEMBER__OF,
                                                       clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.kindOfIntentionallyConstructedObject.addValue(MEMBER_OF,
                                                       classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of KindOfIntentionallyConstructedObject created from
   * the properties set on this builder.
   *
   * @return The built KindOfIntentionallyConstructedObject.
   * @throws HqdmException If the KindOfIntentionallyConstructedObject is
  ...
  public KindOfIntentionallyConstructedObject build() throws HqdmException {
    if (this.kindOfIntentionallyConstructedObject.hasValue(HAS_SUPERCLASS) &&
        this.kindOfIntentionallyConstructedObject.values(HAS_SUPERCLASS)
            .isEmpty()) {
      throw new HqdmException("Property Not Set: has_superclass");
    }
    if (this.kindOfIntentionallyConstructedObject.hasValue(MEMBER__OF) &&
        this.kindOfIntentionallyConstructedObject.values(MEMBER__OF)
            .isEmpty()) {
    ...
    if (this.kindOfIntentionallyConstructedObject.hasValue(MEMBER_OF_) &&
        this.kindOfIntentionallyConstructedObject.values(MEMBER_OF_)
            .isEmpty()) {
