...
public class KindOfOrdinaryBiologicalObjectBuilder {
  ...
  public KindOfOrdinaryBiologicalObjectBuilder(final IRI iri) {
    kindOfOrdinaryBiologicalObject =
        ClassServices.createKindOfOrdinaryBiologicalObject(iri);
  }
  ...
  public final KindOfOrdinaryBiologicalObjectBuilder consists__Of_By_Class(
    ...
    this.kindOfOrdinaryBiologicalObject.addValue(
   ...
   * @return This builder.
   */
  public final KindOfOrdinaryBiologicalObjectBuilder
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.kindOfOrdinaryBiologicalObject.addValue(MEMBER_OF,
                                                 classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of KindOfOrdinaryBiologicalObject created from the
   * properties set on this builder.
   *
   * @return The built KindOfOrdinaryBiologicalObject.
   * @throws HqdmException If the KindOfOrdinaryBiologicalObject is missing any
  ...
  public KindOfOrdinaryBiologicalObject build() throws HqdmException {
    ...
    if (this.kindOfOrdinaryBiologicalObject.hasValue(PART__OF_BY_CLASS) &&
        this.kindOfOrdinaryBiologicalObject.values(PART__OF_BY_CLASS)
            .isEmpty()) {
