...
public class KindOfOrdinaryFunctionalObjectBuilder {
  ...
  public KindOfOrdinaryFunctionalObjectBuilder(final IRI iri) {
    kindOfOrdinaryFunctionalObject =
        ClassServices.createKindOfOrdinaryFunctionalObject(iri);
  }
  ...
  public final KindOfOrdinaryFunctionalObjectBuilder consists__Of_By_Class(
    ...
    this.kindOfOrdinaryFunctionalObject.addValue(
   ...
   * @return This builder.
   */
  public final KindOfOrdinaryFunctionalObjectBuilder
   ...
   * A relationship type where each {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} a
   * {@link uk.gov.gchq.magmacore.hqdm.model.KindOfFunctionalObject} is intended
   * to play one or more
   * {@link Role}(s).
   *
   * @param role The Role.
   ...
   */
  public final KindOfOrdinaryFunctionalObjectBuilder
  intended_Role_By_Class_M(final Role role) {
    this.kindOfOrdinaryFunctionalObject.addValue(INTENDED_ROLE_BY_CLASS,
                                                 role.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.kindOfOrdinaryFunctionalObject.addValue(MEMBER_OF,
                                                 classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of KindOfOrdinaryFunctionalObject created from the
   * properties set on this builder.
   *
   * @return The built KindOfOrdinaryFunctionalObject.
   * @throws HqdmException If the KindOfOrdinaryFunctionalObject is missing any
  ...
  public KindOfOrdinaryFunctionalObject build() throws HqdmException {
    ...
    if (this.kindOfOrdinaryFunctionalObject.hasValue(PART__OF_BY_CLASS) &&
        this.kindOfOrdinaryFunctionalObject.values(PART__OF_BY_CLASS)
            .isEmpty()) {
