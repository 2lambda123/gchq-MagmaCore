...
public class KindOfOrdinaryPhysicalObjectBuilder {
  ...
  public KindOfOrdinaryPhysicalObjectBuilder(final IRI iri) {
    kindOfOrdinaryPhysicalObject =
        ClassServices.createKindOfOrdinaryPhysicalObject(iri);
  }
  ...
  public final KindOfOrdinaryPhysicalObjectBuilder consists__Of_By_Class(
    ...
    this.kindOfOrdinaryPhysicalObject.addValue(
   ...
   * @return This builder.
   */
  public final KindOfOrdinaryPhysicalObjectBuilder
  ...
  /**
   * Returns an instance of KindOfOrdinaryPhysicalObject created from the
   * properties set on this builder.
   *
   * @return The built KindOfOrdinaryPhysicalObject.
   * @throws HqdmException If the KindOfOrdinaryPhysicalObject is missing any
