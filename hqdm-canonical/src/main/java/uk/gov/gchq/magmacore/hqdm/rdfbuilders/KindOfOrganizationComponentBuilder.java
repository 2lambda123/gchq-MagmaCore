...
public class KindOfOrganizationComponentBuilder {
  ...
  public KindOfOrganizationComponentBuilder(final IRI iri) {
    kindOfOrganizationComponent =
        ClassServices.createKindOfOrganizationComponent(iri);
  }
  ...
  public final KindOfOrganizationComponentBuilder consists__Of_By_Class(
    ...
    this.kindOfOrganizationComponent.addValue(
   ...
   * @return This builder.
   */
  public final KindOfOrganizationComponentBuilder
  ...
  /**
   * Returns an instance of KindOfOrganizationComponent created from the
   * properties set on this builder.
   *
   * @return The built KindOfOrganizationComponent.
   * @throws HqdmException If the KindOfOrganizationComponent is missing any
