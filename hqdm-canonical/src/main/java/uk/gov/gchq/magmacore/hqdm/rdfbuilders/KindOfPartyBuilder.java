...
public class KindOfPartyBuilder {
  ...
  public final KindOfPartyBuilder consists__Of_By_Class(
    ...
    this.kindOfParty.addValue(CONSISTS__OF_BY_CLASS,
   ...
   * @return This builder.
   */
  public final KindOfPartyBuilder
  has_Component_By_Class_M(final KindOfSystemComponent kindOfSystemComponent) {
    this.kindOfParty.addValue(HAS_COMPONENT_BY_CLASS,
  ...
  public final KindOfPartyBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.kindOfParty.addValue(MEMBER_OF_,
  ...
  public final KindOfPartyBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.kindOfParty.addValue(PART__OF_BY_CLASS,
                              classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of KindOfParty created from the properties set on this
   * builder.
   *
   * @return The built KindOfParty.
   * @throws HqdmException If the KindOfParty is missing any mandatory
   *     properties.
   */
