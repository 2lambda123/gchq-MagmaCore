...
public class KindOfPersonBuilder {
  ...
  public final KindOfPersonBuilder consists__Of_By_Class(
    ...
    this.kindOfPerson.addValue(CONSISTS__OF_BY_CLASS,
   ...
   * @return This builder.
   */
  public final KindOfPersonBuilder
  has_Component_By_Class_M(final KindOfSystemComponent kindOfSystemComponent) {
    this.kindOfPerson.addValue(HAS_COMPONENT_BY_CLASS,
  ...
  public final KindOfPersonBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.kindOfPerson.addValue(MEMBER_OF_,
  ...
  public final KindOfPersonBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.kindOfPerson.addValue(PART__OF_BY_CLASS,
                               classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of KindOfPerson created from the properties set on this
   * builder.
   *
   * @return The built KindOfPerson.
   * @throws HqdmException If the KindOfPerson is missing any mandatory
   *     properties.
   */
