...
public class KindOfPhysicalObjectBuilder {
   ...
   * @return This builder.
   */
  public final KindOfPhysicalObjectBuilder
  ...
  public final KindOfPhysicalObjectBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.kindOfPhysicalObject.addValue(
  ...
  /**
   * Returns an instance of KindOfPhysicalObject created from the properties set
   * on this builder.
   *
   * @return The built KindOfPhysicalObject.
   * @throws HqdmException If the KindOfPhysicalObject is missing any mandatory
   *     properties.
   */
