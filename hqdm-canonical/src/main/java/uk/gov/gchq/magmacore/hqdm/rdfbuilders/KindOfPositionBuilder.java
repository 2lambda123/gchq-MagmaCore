...
public class KindOfPositionBuilder {
   ...
   * @return This builder.
   */
  public final KindOfPositionBuilder
  ...
  public final KindOfPositionBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.kindOfPosition.addValue(MEMBER_OF_,
  ...
  public final KindOfPositionBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.kindOfPosition.addValue(PART__OF_BY_CLASS,
                                 classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of KindOfPosition created from the properties set on
   * this builder.
   *
   * @return The built KindOfPosition.
   * @throws HqdmException If the KindOfPosition is missing any mandatory
   *     properties.
   */
