...
public class KindOfSociallyConstructedObjectBuilder {
  ...
  public KindOfSociallyConstructedObjectBuilder(final IRI iri) {
    kindOfSociallyConstructedObject =
        ClassServices.createKindOfSociallyConstructedObject(iri);
  }
  ...
  public final KindOfSociallyConstructedObjectBuilder consists__Of_By_Class(
    ...
    this.kindOfSociallyConstructedObject.addValue(
   ...
   * @return This builder.
   */
  public final KindOfSociallyConstructedObjectBuilder
  has_Superclass(final Class clazz) {
    this.kindOfSociallyConstructedObject.addValue(HAS_SUPERCLASS,
                                                  clazz.getId());
    return this;
  }
  ...
  member_Of(final ClassOfClass classOfClass) {
    this.kindOfSociallyConstructedObject.addValue(MEMBER_OF,
                                                  classOfClass.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of KindOfSociallyConstructedObject created from the
   * properties set on this builder.
   *
   * @return The built KindOfSociallyConstructedObject.
   * @throws HqdmException If the KindOfSociallyConstructedObject is missing any
  ...
  public KindOfSociallyConstructedObject build() throws HqdmException {
    ...
    if (this.kindOfSociallyConstructedObject.hasValue(PART__OF_BY_CLASS) &&
        this.kindOfSociallyConstructedObject.values(PART__OF_BY_CLASS)
            .isEmpty()) {
