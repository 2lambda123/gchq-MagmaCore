...
public class KindOfSystemBuilder {
  ...
  public final KindOfSystemBuilder consists__Of_By_Class(
    ...
    this.kindOfSystem.addValue(CONSISTS__OF_BY_CLASS,
   ...
   * relationship type where each {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} a {@link KindOfSystem}
   * has a
  ...
  has_Component_By_Class_M(final KindOfSystemComponent kindOfSystemComponent) {
    this.kindOfSystem.addValue(HAS_COMPONENT_BY_CLASS,
                               kindOfSystemComponent.getId());
    return this;
  }
  ...
  public final KindOfSystemBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.kindOfSystem.addValue(MEMBER_OF_,
  ...
  public final KindOfSystemBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.kindOfSystem.addValue(PART__OF_BY_CLASS,
                               classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of KindOfSystem created from the properties set on this
   * builder.
   *
   * @return The built KindOfSystem.
   * @throws HqdmException If the KindOfSystem is missing any mandatory
   *     properties.
   */
