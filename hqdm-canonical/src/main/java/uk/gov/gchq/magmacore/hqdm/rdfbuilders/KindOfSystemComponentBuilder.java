...
public class KindOfSystemComponentBuilder {
   ...
   * @return This builder.
   */
  public final KindOfSystemComponentBuilder
  ...
  public final KindOfSystemComponentBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.kindOfSystemComponent.addValue(
  ...
  /**
   * Returns an instance of KindOfSystemComponent created from the properties
   * set on this builder.
   *
   * @return The built KindOfSystemComponent.
   * @throws HqdmException If the KindOfSystemComponent is missing any mandatory
   *     properties.
   */
