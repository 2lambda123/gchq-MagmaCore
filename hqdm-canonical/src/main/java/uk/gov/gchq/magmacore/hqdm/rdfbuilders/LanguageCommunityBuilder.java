...
public class LanguageCommunityBuilder {
  ...
  public LanguageCommunityBuilder(final IRI iri) {
    languageCommunity =
        SpatioTemporalExtentServices.createLanguageCommunity(iri);
  }
   ...
   * @return This builder.
   */
  public final LanguageCommunityBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.languageCommunity.addValue(AGGREGATED_INTO,
  ...
  member_Of(final ClassOfStateOfOrganization classOfStateOfOrganization) {
    this.languageCommunity.addValue(MEMBER_OF,
   ...
   */
  public final LanguageCommunityBuilder
  member_Of_Kind(final KindOfOrganization kindOfOrganization) {
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.languageCommunity.addValue(PART_OF_POSSIBLE_WORLD,
                                    possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.languageCommunity.addValue(TEMPORAL__PART_OF,
                                    spatioTemporalExtent.getId());
    return this;
  }
  ...
  temporal_Part_Of(final LanguageCommunity languageCommunity) {
    this.languageCommunity.addValue(TEMPORAL_PART_OF,
                                    languageCommunity.getId());
    return this;
  }

  /**
   * Returns an instance of LanguageCommunity created from the properties set on
   * this builder.
   *
   * @return The built LanguageCommunity.
   * @throws HqdmException If the LanguageCommunity is missing any mandatory
   *     properties.
   */
