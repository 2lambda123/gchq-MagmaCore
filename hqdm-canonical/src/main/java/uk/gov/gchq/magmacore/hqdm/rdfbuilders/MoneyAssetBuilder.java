...
public class MoneyAssetBuilder {
   ...
   * @return This builder.
   */
  public final MoneyAssetBuilder
   ...
   * relationship type where an asset is a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PARTICIPANT_IN} exactly one
   * {@link Ownership}.
   *
  ...
  /**
   * Returns an instance of MoneyAsset created from the properties set on this
   * builder.
   *
   * @return The built MoneyAsset.
   * @throws HqdmException If the MoneyAsset is missing any mandatory
   *     properties.
   */
