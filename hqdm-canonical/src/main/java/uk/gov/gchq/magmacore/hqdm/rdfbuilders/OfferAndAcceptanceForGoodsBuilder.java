...
public class OfferAndAcceptanceForGoodsBuilder {
  ...
  public OfferAndAcceptanceForGoodsBuilder(final IRI iri) {
    offerAndAcceptanceForGoods =
        SpatioTemporalExtentServices.createOfferAndAcceptanceForGoods(iri);
  }
   ...
   * @return This builder.
   */
  public final OfferAndAcceptanceForGoodsBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.offerAndAcceptanceForGoods.addValue(AGGREGATED_INTO,
   ...
   * uk.gov.gchq.magmacore.hqdm.model.Activity} is the cause of one or more
   * {@link Event}.
   *
   * @param event The Event.
   * @return This builder.
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.offerAndAcceptanceForGoods.addValue(CONSISTS__OF,
                                             spatioTemporalExtent.getId());
    return this;
  }
   ...
   * type where an
   * {@link OfferAndAcceptanceForGoods} consists of exactly one {@link
   ...
   */
  public final OfferAndAcceptanceForGoodsBuilder
  consists_Of(final AcceptanceOfOfferForGoods acceptanceOfOfferForGoods) {
  ...
  /**
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#CONSISTS_OF_} relationship
   * type where an
   * {@link OfferAndAcceptanceForGoods} consists_of exactly one {@link
   * OfferForGoods}.
   *
   ...
   */
  public final OfferAndAcceptanceForGoodsBuilder
  consists_Of_(final OfferForGoods offerForGoods) {
    this.offerAndAcceptanceForGoods.addValue(CONSISTS_OF_,
                                             offerForGoods.getId());
    return this;
  }
   ...
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#CONSISTS_OF} one or more
   * {@link Participant}s.
   *
   ...
   */
  public final OfferAndAcceptanceForGoodsBuilder
  consists_Of_Participant(final Participant participant) {
    this.offerAndAcceptanceForGoods.addValue(CONSISTS_OF_PARTICIPANT,
                                             participant.getId());
    return this;
  }

  /**
   * A relationship type where an {@link
   * uk.gov.gchq.magmacore.hqdm.model.Activity} may determine one or more {@link
   ...
   */
  public final OfferAndAcceptanceForGoodsBuilder
  member_Of(final ClassOfAgreeContract classOfAgreeContract) {
    this.offerAndAcceptanceForGoods.addValue(MEMBER_OF,
                                             classOfAgreeContract.getId());
    return this;
  }
  ...
  member_Of_Kind_M(final KindOfActivity kindOfActivity) {
    this.offerAndAcceptanceForGoods.addValue(MEMBER_OF_KIND,
                                             kindOfActivity.getId());
    this.offerAndAcceptanceForGoods.addValue(RDFS.RDF_TYPE,
                                             kindOfActivity.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.offerAndAcceptanceForGoods.addValue(PART__OF,
                                             spatioTemporalExtent.getId());
    return this;
  }
   ...
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} relationship type
   * where an
   * {@link OfferAndAcceptanceForGoods} is a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} exactly one {@link
   * SaleOfGoods}.
   *
   ...
   */
  public final OfferAndAcceptanceForGoodsBuilder
  part_Of_M(final SaleOfGoods saleOfGoods) {
  ...
  part_Of_(final AgreementExecution agreementExecution) {
    this.offerAndAcceptanceForGoods.addValue(PART_OF_,
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.offerAndAcceptanceForGoods.addValue(PART_OF_POSSIBLE_WORLD,
                                             possibleWorld.getId());
    return this;
  }
  ...
  /**
   * A relationship type where an {@link
   * uk.gov.gchq.magmacore.hqdm.model.Activity} may reference one or more {@link
   * Thing}.
   *
   * @param thing The Thing.
   * @return This builder.
  ...
  temporal_Part_Of(final Individual individual) {
    this.offerAndAcceptanceForGoods.addValue(TEMPORAL_PART_OF,
                                             individual.getId());
    return this;
  }

  /**
   * Returns an instance of OfferAndAcceptanceForGoods created from the
   * properties set on this builder.
   *
   * @return The built OfferAndAcceptanceForGoods.
   * @throws HqdmException If the OfferAndAcceptanceForGoods is missing any
