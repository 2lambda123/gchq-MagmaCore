...
public class OfferForGoodsBuilder {
   ...
   * @return This builder.
   */
  public final OfferForGoodsBuilder
   ...
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} relationship type
   * where an
   * {@link OfferForGoods} may be {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} no more than one {@link
   ...
   */
  public final OfferForGoodsBuilder
  part_Of(final OfferAndAcceptanceForGoods offerAndAcceptanceForGoods) {
  ...
  /**
   * A references relationship type to exactly one {@link
   * ExchangeOfGoodsAndMoney} offered.
   *
   * @param exchangeOfGoodsAndMoney The ExchangeOfGoodsAndMoney.
   * @return This builder.
   */
  public final OfferForGoodsBuilder
  references_M(final ExchangeOfGoodsAndMoney exchangeOfGoodsAndMoney) {
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.offerForGoods.addValue(TEMPORAL__PART_OF,
  ...
  /**
   * Returns an instance of OfferForGoods created from the properties set on
   * this builder.
   *
   * @return The built OfferForGoods.
   * @throws HqdmException If the OfferForGoods is missing any mandatory
   *     properties.
   */
