...
public class OfferingBuilder {
  ...
  /**
   * A relationship type where an {@link Offering} has exactly one {@link
   * ClassOfIndividual} some
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} which is offered.
   *
   * @param classOfIndividual The ClassOfIndividual.
   * @return This builder.
   */
  public final OfferingBuilder
  class_Of_Offered_M(final ClassOfIndividual classOfIndividual) {
    this.offering.addValue(CLASS_OF_OFFERED, classOfIndividual.getId());
    return this;
  }

  /**
   * A relationship type where an {@link Offering} has exactly one {@link Price}
   * at which the
  ...
  public final OfferingBuilder consists__Of_By_Class(
    ...
    this.offering.addValue(CONSISTS__OF_BY_CLASS,
  ...
  public final OfferingBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.offering.addValue(MEMBER_OF_,
                           classOfClassOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * A relationship type where an {@link Offering} has exactly one {@link Party}
   * who makes the
   * {@link Offering}.
   *
  ...
  public final OfferingBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.offering.addValue(PART__OF_BY_CLASS,
                           classOfSpatioTemporalExtent.getId());
    return this;
  }
  ...
  part_Of_By_Class_(final ClassOfAgreementExecution classOfAgreementExecution) {
    this.offering.addValue(PART_OF_BY_CLASS_,
  ...
  /**
   * Returns an instance of Offering created from the properties set on this
   * builder.
   *
