...
public class OrdinaryBiologicalObjectBuilder {
  ...
  public OrdinaryBiologicalObjectBuilder(final IRI iri) {
    ordinaryBiologicalObject =
        SpatioTemporalExtentServices.createOrdinaryBiologicalObject(iri);
  }
   ...
   * @return This builder.
   */
  public final OrdinaryBiologicalObjectBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.ordinaryBiologicalObject.addValue(AGGREGATED_INTO,
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.ordinaryBiologicalObject.addValue(CONSISTS__OF,
                                           spatioTemporalExtent.getId());
    return this;
  }
  ...
  public final OrdinaryBiologicalObjectBuilder member_Of(
    ...
    this.ordinaryBiologicalObject.addValue(
        MEMBER_OF, classOfOrdinaryBiologicalObject.getId());
    return this;
  }
  ...
  public final OrdinaryBiologicalObjectBuilder member_Of_Kind(
    ...
    this.ordinaryBiologicalObject.addValue(
        MEMBER_OF_KIND, kindOfOrdinaryBiologicalObject.getId());
    this.ordinaryBiologicalObject.addValue(
        RDFS.RDF_TYPE, kindOfOrdinaryBiologicalObject.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.ordinaryBiologicalObject.addValue(PART__OF,
                                           spatioTemporalExtent.getId());
    return this;
  }
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.ordinaryBiologicalObject.addValue(PART_OF_POSSIBLE_WORLD,
                                           possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.ordinaryBiologicalObject.addValue(TEMPORAL__PART_OF,
                                           spatioTemporalExtent.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of OrdinaryBiologicalObject created from the properties
   * set on this builder.
   *
   * @return The built OrdinaryBiologicalObject.
   * @throws HqdmException If the OrdinaryBiologicalObject is missing any
