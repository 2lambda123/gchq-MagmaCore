...
public class OrdinaryFunctionalObjectBuilder {
  ...
  public OrdinaryFunctionalObjectBuilder(final IRI iri) {
    ordinaryFunctionalObject =
        SpatioTemporalExtentServices.createOrdinaryFunctionalObject(iri);
  }
   ...
   * @return This builder.
   */
  public final OrdinaryFunctionalObjectBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.ordinaryFunctionalObject.addValue(AGGREGATED_INTO,
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.ordinaryFunctionalObject.addValue(CONSISTS__OF,
                                           spatioTemporalExtent.getId());
    return this;
  }
  ...
  public final OrdinaryFunctionalObjectBuilder member_Of(
    ...
    this.ordinaryFunctionalObject.addValue(
        MEMBER_OF, classOfOrdinaryFunctionalObject.getId());
    return this;
  }
  ...
  public final OrdinaryFunctionalObjectBuilder member_Of_Kind(
    ...
    this.ordinaryFunctionalObject.addValue(
        MEMBER_OF_KIND, kindOfOrdinaryFunctionalObject.getId());
    this.ordinaryFunctionalObject.addValue(
        RDFS.RDF_TYPE, kindOfOrdinaryFunctionalObject.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.ordinaryFunctionalObject.addValue(PART__OF,
                                           spatioTemporalExtent.getId());
    return this;
  }
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.ordinaryFunctionalObject.addValue(PART_OF_POSSIBLE_WORLD,
                                           possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.ordinaryFunctionalObject.addValue(TEMPORAL__PART_OF,
                                           spatioTemporalExtent.getId());
    return this;
  }
  ...
  temporal_Part_Of(final Individual individual) {
    this.ordinaryFunctionalObject.addValue(TEMPORAL_PART_OF,
                                           individual.getId());
    return this;
  }

  /**
   * Returns an instance of OrdinaryFunctionalObject created from the properties
   * set on this builder.
   *
   * @return The built OrdinaryFunctionalObject.
   * @throws HqdmException If the OrdinaryFunctionalObject is missing any
