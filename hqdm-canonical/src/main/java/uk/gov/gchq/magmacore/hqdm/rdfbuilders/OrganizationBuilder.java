...
public class OrganizationBuilder {
   ...
   * @return This builder.
   */
  public final OrganizationBuilder
   ...
   * type where
   * {@link Organization} may be a {@link
   ...
   */
  public final OrganizationBuilder
  member_Of(final ClassOfOrganization classOfOrganization) {
  ...
  /**
   * Returns an instance of Organization created from the properties set on this
   * builder.
   *
   * @return The built Organization.
   * @throws HqdmException If the Organization is missing any mandatory
   *     properties.
   */
