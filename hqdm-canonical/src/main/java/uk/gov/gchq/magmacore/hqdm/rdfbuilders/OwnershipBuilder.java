...
public class OwnershipBuilder {
  ...
  /**
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#BEGINNING} relationship
   * type where an
   * {@link Ownership} has as {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#BEGINNING} exactly one
   ...
   */
  public final OwnershipBuilder
  beginning_M(final BeginningOfOwnership beginningOfOwnership) {
   ...
   * relationship type where an {@link Ownership} {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#CONSISTS_OF_PARTICIPANT} exactly
   * one {@link Owner}.
   *
  ...
  /**
   * An {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#ENDING} relationship type
   * where an
   * {@link Ownership} has as {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#ENDING} not more than one
   ...
   */
  public final OwnershipBuilder
  member_Of(final ClassOfAssociation classOfAssociation) {
  ...
  /**
   * Returns an instance of Ownership created from the properties set on this
   * builder.
   *
