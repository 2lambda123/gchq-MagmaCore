...
public class ParticipantBuilder {
   ...
   * @return This builder.
   */
  public final ParticipantBuilder
   ...
   * type where a
   * {@link Participant} may be a {@link
   ...
   */
  public final ParticipantBuilder
  member_Of(final ClassOfParticipant classOfParticipant) {
   ...
   *
   * @param participantInActivityOrAssociation The
   *     Participant.nActivityOrAssociation.
   * @return This builder.
   */
  public final ParticipantBuilder participant_In(
      final ParticipantInActivityOrAssociation
          participantInActivityOrAssociation) {
    this.participant.addValue(PARTICIPANT_IN,
                              participantInActivityOrAssociation.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of Participant created from the properties set on this
   * builder.
   *
   * @return The built Participant.
   * @throws HqdmException If the Participant is missing any mandatory
   *     properties.
   */
