...
public class PartyBuilder {
  ...
  /**
   * Returns an instance of Party created from the properties set on this
   * builder.
   *
  ...
  public Party build() throws HqdmException {
    ...
    if (this.party.hasValue(ENDING) && this.party.values(ENDING).isEmpty()) {
