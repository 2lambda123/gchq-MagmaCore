...
public class PatternBuilder {
  ...
  public final PatternBuilder consists__Of_By_Class(
    ...
    this.pattern.addValue(CONSISTS__OF_BY_CLASS,
  ...
  public final PatternBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.pattern.addValue(MEMBER_OF_,
  ...
  public final PatternBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.pattern.addValue(PART__OF_BY_CLASS,
                          classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of Pattern created from the properties set on this
   * builder.
   *
