...
public class PeriodOfTimeBuilder {
   ...
   * @return This builder.
   */
  public final PeriodOfTimeBuilder
   ...
   * type where a
   * {@link PeriodOfTime} may be a {@link
   ...
   */
  public final PeriodOfTimeBuilder
  member_Of(final ClassOfPeriodOfTime classOfPeriodOfTime) {
   ...
   * relationship type where a
   * {@link PeriodOfTime} may be a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#TEMPORAL_PART_OF} one or more
   * {@link PossibleWorld}.
   *
   * @param possibleWorld The PossibleWorld.
   * @return This builder.
  ...
  /**
   * Returns an instance of PeriodOfTime created from the properties set on this
   * builder.
   *
   * @return The built PeriodOfTime.
   * @throws HqdmException If the PeriodOfTime is missing any mandatory
   *     properties.
   */
