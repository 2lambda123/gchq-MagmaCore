...
public class PersonBuilder {
   ...
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} relationship
   * type where a
   * {@link uk.gov.gchq.magmacore.hqdm.model.BiologicalSystem} has a natural
   * {@link Role} that it plays.
   *
   * <p>
   * Example: My circulatory system has the
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#NATURAL_ROLE} of circulating
  ...
  /**
   * Returns an instance of Person created from the properties set on this
   * builder.
   *
  ...
  public Person build() throws HqdmException {
    ...
    if (this.person.hasValue(ENDING) && this.person.values(ENDING).isEmpty()) {
