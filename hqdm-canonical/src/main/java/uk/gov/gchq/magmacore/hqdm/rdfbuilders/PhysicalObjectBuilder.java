...
public class PhysicalObjectBuilder {
   ...
   * @return This builder.
   */
  public final PhysicalObjectBuilder
   ...
   * type where a
   * {@link PhysicalObject} may be a {@link
   ...
   */
  public final PhysicalObjectBuilder
  member_Of(final ClassOfPhysicalObject classOfPhysicalObject) {
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.physicalObject.addValue(TEMPORAL__PART_OF,
  ...
  /**
   * Returns an instance of PhysicalObject created from the properties set on
   * this builder.
   *
   * @return The built PhysicalObject.
   * @throws HqdmException If the PhysicalObject is missing any mandatory
   *     properties.
   */
