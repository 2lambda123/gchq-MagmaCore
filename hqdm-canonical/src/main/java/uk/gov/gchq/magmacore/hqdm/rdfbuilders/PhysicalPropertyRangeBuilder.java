...
public class PhysicalPropertyRangeBuilder {
  ...
  public PhysicalPropertyRangeBuilder(final IRI iri) {
    physicalPropertyRange =
        SpatioTemporalExtentServices.createPhysicalPropertyRange(iri);
  }
   ...
   * @return This builder.
   */
  public final PhysicalPropertyRangeBuilder
  ...
  public final PhysicalPropertyRangeBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.physicalPropertyRange.addValue(
   ...
   * {@link PhysicalPropertyRange} are members of the {@link
   * PhysicalPropertyRange}.
   *
  ...
  /**
   * Returns an instance of PhysicalPropertyRange created from the properties
   * set on this builder.
   *
   * @return The built PhysicalPropertyRange.
   * @throws HqdmException If the PhysicalPropertyRange is missing any mandatory
   *     properties.
   */
