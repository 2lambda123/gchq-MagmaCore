...
public class PhysicalQuantityBuilder {
   ...
   * type where a
   * {@link PhysicalQuantity} may be a {@link
   ...
   * @return This builder.
   */
  public final PhysicalQuantityBuilder
  member_Of(final ClassOfPhysicalQuantity classOfPhysicalQuantity) {
  ...
  public final PhysicalQuantityBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.physicalQuantity.addValue(MEMBER_OF_,
   ...
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} relationship
   * type where a
   * {@link PhysicalQuantity} is a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} exactly one {@link
   * KindOfPhysicalQuantity}.
   *
   * @param kindOfPhysicalQuantity The KindOfPhysicalQuantity.
   * @return This builder.
   */
  public final PhysicalQuantityBuilder
  member_Of_Kind_M(final KindOfPhysicalQuantity kindOfPhysicalQuantity) {
    this.physicalQuantity.addValue(MEMBER_OF_KIND,
                                   kindOfPhysicalQuantity.getId());
    this.physicalQuantity.addValue(RDFS.RDF_TYPE,
                                   kindOfPhysicalQuantity.getId());
    return this;
  }
  ...
  public final PhysicalQuantityBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.physicalQuantity.addValue(PART__OF_BY_CLASS,
                                   classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of PhysicalQuantity created from the properties set on
   * this builder.
   *
   * @return The built PhysicalQuantity.
   * @throws HqdmException If the PhysicalQuantity is missing any mandatory
   *     properties.
   */
