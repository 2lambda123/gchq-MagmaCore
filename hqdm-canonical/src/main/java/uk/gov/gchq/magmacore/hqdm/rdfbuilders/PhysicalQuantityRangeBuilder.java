...
public class PhysicalQuantityRangeBuilder {
  ...
  public PhysicalQuantityRangeBuilder(final IRI iri) {
    physicalQuantityRange =
        SpatioTemporalExtentServices.createPhysicalQuantityRange(iri);
  }
  ...
  /**
   * A supertype_of relationship type where each {@link PhysicalQuantityRange}
   * must have as
   ...
   * @return This builder.
   */
  public final PhysicalQuantityRangeBuilder
  lower_Bound_M(final PhysicalQuantity physicalQuantity) {
  ...
  /**
   * A supertype_of relationship type where the members of each {@link
   * PhysicalProperty} in the
   * {@link uk.gov.gchq.magmacore.hqdm.model.PhysicalPropertyRange} are members
   * of the
   ...
   */
  public final PhysicalQuantityRangeBuilder
  ranges_Over_M(final PhysicalProperty physicalProperty) {
   ...
   */
  public final PhysicalQuantityRangeBuilder
  upper_Bound_M(final PhysicalQuantity physicalQuantity) {
    this.physicalQuantityRange.addValue(UPPER_BOUND, physicalQuantity.getId());
    return this;
  }

  /**
   * Returns an instance of PhysicalQuantityRange created from the properties
   * set on this builder.
   *
   * @return The built PhysicalQuantityRange.
   * @throws HqdmException If the PhysicalQuantityRange is missing any mandatory
   *     properties.
   */
