...
public class PlanBuilder {
  ...
  /**
   * Returns an instance of Plan created from the properties set on this
   * builder.
   *
  ...
  public Plan build() throws HqdmException {
    ...
    if (this.plan.hasValue(ENDING) && this.plan.values(ENDING).isEmpty()) {
    ...
    if (this.plan.hasValue(PART__OF) && this.plan.values(PART__OF).isEmpty()) {
