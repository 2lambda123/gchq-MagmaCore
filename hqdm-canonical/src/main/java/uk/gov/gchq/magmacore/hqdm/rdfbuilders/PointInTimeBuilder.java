...
public class PointInTimeBuilder {
   ...
   * @return This builder.
   */
  public final PointInTimeBuilder
   ...
   * type where a
   * {@link PointInTime} may be a {@link
   ...
   */
  public final PointInTimeBuilder
  member_Of(final ClassOfPointInTime classOfPointInTime) {
  ...
  /**
   * Returns an instance of PointInTime created from the properties set on this
   * builder.
   *
   * @return The built PointInTime.
   * @throws HqdmException If the PointInTime is missing any mandatory
   *     properties.
   */
