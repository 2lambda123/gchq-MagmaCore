...
public class PositionBuilder {
   ...
   * type where an
   * {@link OrganizationComponent} is a replaceable component of exactly {@link
   * Organization}.
   *
   ...
   */
  public final PositionBuilder
  member_Of(final ClassOfPosition classOfPosition) {
   ...
   */
  public final PositionBuilder
  member_Of_Kind(final KindOfPosition kindOfPosition) {
  ...
  /**
   * Returns an instance of Position created from the properties set on this
   * builder.
   *
