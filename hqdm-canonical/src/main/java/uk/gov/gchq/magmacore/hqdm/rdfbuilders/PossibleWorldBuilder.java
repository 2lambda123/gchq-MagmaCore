...
public class PossibleWorldBuilder {
   ...
   * @return This builder.
   */
  public final PossibleWorldBuilder
   ...
   */
  public final PossibleWorldBuilder
  member_Of_Kind(final KindOfIndividual kindOfIndividual) {
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.possibleWorld.addValue(TEMPORAL__PART_OF,
   ...
   */
  public final PossibleWorldBuilder
  temporal_Part_Of_(final PossibleWorld possibleWorld) {
    this.possibleWorld.addValue(TEMPORAL_PART_OF_, possibleWorld.getId());
    return this;
  }

  /**
   * Returns an instance of PossibleWorld created from the properties set on
   * this builder.
   *
   * @return The built PossibleWorld.
   * @throws HqdmException If the PossibleWorld is missing any mandatory
   *     properties.
   */
