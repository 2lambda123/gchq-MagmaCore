...
public class PriceBuilder {
  ...
  public final PriceBuilder consists__Of_By_Class(
    ...
    this.price.addValue(CONSISTS__OF_BY_CLASS,
   ...
   * @return This builder.
   */
  public final PriceBuilder member_Of_(final ClassOfClassOfSpatioTemporalExtent
                                           classOfClassOfSpatioTemporalExtent) {
  ...
  /**
   * Returns an instance of Price created from the properties set on this
   * builder.
   *
