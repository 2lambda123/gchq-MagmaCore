...
public class ProductBrandBuilder {
  ...
  public final ProductBrandBuilder consists__Of_By_Class(
    ...
    this.productBrand.addValue(CONSISTS__OF_BY_CLASS,
  ...
  public final ProductBrandBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.productBrand.addValue(MEMBER_OF_,
  ...
  public final ProductBrandBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.productBrand.addValue(PART__OF_BY_CLASS,
                               classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of ProductBrand created from the properties set on this
   * builder.
   *
   * @return The built ProductBrand.
   * @throws HqdmException If the ProductBrand is missing any mandatory
   *     properties.
   */
