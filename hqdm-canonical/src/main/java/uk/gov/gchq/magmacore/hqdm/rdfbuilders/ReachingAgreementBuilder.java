...
public class ReachingAgreementBuilder {
  ...
  public ReachingAgreementBuilder(final IRI iri) {
    reachingAgreement =
        SpatioTemporalExtentServices.createReachingAgreement(iri);
  }
   ...
   * @return This builder.
   */
  public final ReachingAgreementBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.reachingAgreement.addValue(AGGREGATED_INTO,
  ...
  consists_Of_Participant(final Participant participant) {
    this.reachingAgreement.addValue(CONSISTS_OF_PARTICIPANT,
                                    participant.getId());
    return this;
  }
   ...
   * type where a
   * {@link ReachingAgreement} may be a {@link
   ...
   */
  public final ReachingAgreementBuilder
  member_Of(final ClassOfReachingAgreement classOfReachingAgreement) {
    this.reachingAgreement.addValue(MEMBER_OF,
   ...
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} relationship type
   * where a
   * {@link ReachingAgreement} is a {@link
   ...
   */
  public final ReachingAgreementBuilder
  part_Of_M(final AgreementProcess agreementProcess) {
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.reachingAgreement.addValue(PART_OF_POSSIBLE_WORLD,
                                    possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.reachingAgreement.addValue(TEMPORAL__PART_OF,
                                    spatioTemporalExtent.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of ReachingAgreement created from the properties set on
   * this builder.
   *
   * @return The built ReachingAgreement.
   * @throws HqdmException If the ReachingAgreement is missing any mandatory
   *     properties.
   */
