...
public class RecognizingLanguageCommunityBuilder {
  ...
  public RecognizingLanguageCommunityBuilder(final IRI iri) {
    recognizingLanguageCommunity =
        SpatioTemporalExtentServices.createRecognizingLanguageCommunity(iri);
  }
   ...
   * @return This builder.
   */
  public final RecognizingLanguageCommunityBuilder
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.recognizingLanguageCommunity.addValue(CONSISTS__OF,
                                               spatioTemporalExtent.getId());
    return this;
  }
   ...
   */
  public final RecognizingLanguageCommunityBuilder
  member_Of(final ClassOfStateOfOrganization classOfStateOfOrganization) {
    this.recognizingLanguageCommunity.addValue(
        MEMBER_OF, classOfStateOfOrganization.getId());
    return this;
  }
   ...
   */
  public final RecognizingLanguageCommunityBuilder
  member_Of_Kind_M(final Role role) {
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.recognizingLanguageCommunity.addValue(PART__OF,
                                               spatioTemporalExtent.getId());
    return this;
  }
   ...
   */
  public final RecognizingLanguageCommunityBuilder
  participant_In(final RepresentationBySign representationBySign) {
   ...
   */
  public final RecognizingLanguageCommunityBuilder
  temporal_Part_Of(final LanguageCommunity languageCommunity) {
    this.recognizingLanguageCommunity.addValue(TEMPORAL_PART_OF,
                                               languageCommunity.getId());
    return this;
  }

  /**
   * Returns an instance of RecognizingLanguageCommunity created from the
   * properties set on this builder.
   *
   * @return The built RecognizingLanguageCommunity.
   * @throws HqdmException If the RecognizingLanguageCommunity is missing any
