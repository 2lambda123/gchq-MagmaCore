...
public class RepresentationByPatternBuilder {
   ...
   * RepresentationByPattern} has a {@link
   * uk.gov.gchq.magmacore.hqdm.model.Sign} that is a
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} the {@link
   * Pattern}.
   *
   ...
   * @return This builder.
   */
  public final RepresentationByPatternBuilder
  consists_Of_By_Class_M(final Pattern pattern) {
    this.representationByPattern.addValue(CONSISTS_OF_BY_CLASS,
                                          pattern.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of RepresentationByPattern created from the properties
   * set on this builder.
   *
   * @return The built RepresentationByPattern.
   * @throws HqdmException If the RepresentationByPattern is missing any
