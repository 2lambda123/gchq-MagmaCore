...
public class RequirementBuilder {
   ...
   * @return This builder.
   */
  public final RequirementBuilder
   ...
   * type where a
   * {@link Requirement} is {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#DEFINED_BY} exactly one
   ...
   */
  public final RequirementBuilder
  defined_By_M(final RequirementSpecification requirementSpecification) {
   ...
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} relationship
   * type where a
   * {@link SpatioTemporalExtent} is a {@link
   ...
   */
  public final RequirementBuilder
  member_Of(final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
   ...
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} relationship type
   * where a
   * {@link Requirement} must be {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} one or more
   * {@link Plan}.
   *
   * @param plan The Plan.
   * @return This builder.
  ...
  /**
   * Returns an instance of Requirement created from the properties set on this
   * builder.
   *
   * @return The built Requirement.
   * @throws HqdmException If the Requirement is missing any mandatory
   *     properties.
   */
