...
public class RequirementSpecificationBuilder {
  ...
  public RequirementSpecificationBuilder(final IRI iri) {
    requirementSpecification =
        SpatioTemporalExtentServices.createRequirementSpecification(iri);
  }
   ...
   * @return This builder.
   */
  public final RequirementSpecificationBuilder
  ...
  /**
   * A subtype_of relationship type where each {@link RequirementSpecification}
   * is the
   ...
   */
  public final RequirementSpecificationBuilder
  intersection_Of_M(final ClassOfState classOfState) {
    this.requirementSpecification.addValue(INTERSECTION_OF,
                                           classOfState.getId());
    return this;
  }
  ...
  public final RequirementSpecificationBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.requirementSpecification.addValue(
  ...
  /**
   * Returns an instance of RequirementSpecification created from the properties
   * set on this builder.
   *
   * @return The built RequirementSpecification.
   * @throws HqdmException If the RequirementSpecification is missing any
