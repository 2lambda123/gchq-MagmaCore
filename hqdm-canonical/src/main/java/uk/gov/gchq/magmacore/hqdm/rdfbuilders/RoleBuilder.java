...
public class RoleBuilder {
   ...
   */
  public RoleBuilder(final IRI iri) { role = ClassServices.createRole(iri); }
  ...
  public final RoleBuilder consists__Of_By_Class(
    ...
    this.role.addValue(CONSISTS__OF_BY_CLASS,
   ...
   * @return This builder.
   */
  public final RoleBuilder member_Of_(final ClassOfClassOfSpatioTemporalExtent
                                          classOfClassOfSpatioTemporalExtent) {
   ...
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} a {@link Role} is
   * a
   ...
   * @return This builder.
   */
  public final RoleBuilder
  part_Of_By_Class(final KindOfActivity kindOfActivity) {
   ...
   */
  public final RoleBuilder
  part_Of_By_Class_(final KindOfAssociation kindOfAssociation) {
    this.role.addValue(PART_OF_BY_CLASS_, kindOfAssociation.getId());
    return this;
  }

  /**
   * Returns an instance of Role created from the properties set on this
   * builder.
   *
