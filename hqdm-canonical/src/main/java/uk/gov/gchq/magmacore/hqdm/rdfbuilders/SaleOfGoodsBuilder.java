...
public class SaleOfGoodsBuilder {
   ...
   * @return This builder.
   */
  public final SaleOfGoodsBuilder
   ...
   */
  public final SaleOfGoodsBuilder
  consists_Of(final OfferAndAcceptanceForGoods offerAndAcceptanceForGoods) {
   ...
   */
  public final SaleOfGoodsBuilder
  consists_Of_(final ExchangeOfGoodsAndMoney exchangeOfGoodsAndMoney) {
  ...
  /**
   * Returns an instance of SaleOfGoods created from the properties set on this
   * builder.
   *
   * @return The built SaleOfGoods.
   * @throws HqdmException If the SaleOfGoods is missing any mandatory
   *     properties.
   */
