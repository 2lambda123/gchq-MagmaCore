...
public class SalesProductBuilder {
  ...
  public final SalesProductBuilder consists__Of_By_Class(
    ...
    this.salesProduct.addValue(CONSISTS__OF_BY_CLASS,
   ...
   * {@link RequirementSpecification}, each {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} a {@link SalesProduct}
   * is a {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} the
   * {@link RequirementSpecification}.
   *
   * @param requirementSpecification The RequirementSpecification.
   * @return This builder.
   */
  public final SalesProductBuilder
  meets_Specification(final RequirementSpecification requirementSpecification) {
    this.salesProduct.addValue(MEETS_SPECIFICATION,
                               requirementSpecification.getId());
    return this;
  }
  ...
  public final SalesProductBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.salesProduct.addValue(MEMBER_OF_,
  ...
  public final SalesProductBuilder part__Of_By_Class(
      final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.salesProduct.addValue(PART__OF_BY_CLASS,
                               classOfSpatioTemporalExtent.getId());
    return this;
  }

  /**
   * A {@link uk.gov.gchq.magmacore.hqdm.model.Specialization} where the {@link
   * SalesProduct} is sold under a {@link ProductBrand}.
   *
  ...
  /**
   * Returns an instance of SalesProduct created from the properties set on this
   * builder.
   *
   * @return The built SalesProduct.
   * @throws HqdmException If the SalesProduct is missing any mandatory
   *     properties.
   */
