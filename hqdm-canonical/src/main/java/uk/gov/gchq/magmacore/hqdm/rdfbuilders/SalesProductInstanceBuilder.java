...
public class SalesProductInstanceBuilder {
  ...
  public SalesProductInstanceBuilder(final IRI iri) {
    salesProductInstance =
        SpatioTemporalExtentServices.createSalesProductInstance(iri);
  }
   ...
   * @return This builder.
   */
  public final SalesProductInstanceBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.salesProductInstance.addValue(AGGREGATED_INTO,
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.salesProductInstance.addValue(CONSISTS__OF,
                                       spatioTemporalExtent.getId());
    return this;
  }
   ...
   * type where a
   * {@link SalesProductInstance} may be a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} one or more {@link
   * ClassOfSalesProductInstance}.
   *
   * @param classOfSalesProductInstance The ClassOfSalesProductInstance.
   * @return This builder.
   */
  public final SalesProductInstanceBuilder
  member_Of(final ClassOfSalesProductInstance classOfSalesProductInstance) {
    this.salesProductInstance.addValue(MEMBER_OF,
                                       classOfSalesProductInstance.getId());
    return this;
  }
  ...
  public final SalesProductInstanceBuilder member_Of_Kind(
    ...
    this.salesProductInstance.addValue(RDFS.RDF_TYPE,
                                       kindOfOrdinaryFunctionalObject.getId());
    return this;
  }
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.salesProductInstance.addValue(PART_OF_POSSIBLE_WORLD,
                                       possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.salesProductInstance.addValue(TEMPORAL__PART_OF,
                                       spatioTemporalExtent.getId());
    return this;
  }
   ...
   * relationship type where a
   * {@link uk.gov.gchq.magmacore.hqdm.model.StateOfSalesProductInstance} may be
   * a
   ...
   */
  public final SalesProductInstanceBuilder
  temporal_Part_Of(final SalesProductInstance salesProductInstance) {
    this.salesProductInstance.addValue(TEMPORAL_PART_OF,
                                       salesProductInstance.getId());
    return this;
  }

  /**
   * Returns an instance of SalesProductInstance created from the properties set
   * on this builder.
   *
   * @return The built SalesProductInstance.
   * @throws HqdmException If the SalesProductInstance is missing any mandatory
   *     properties.
   */
