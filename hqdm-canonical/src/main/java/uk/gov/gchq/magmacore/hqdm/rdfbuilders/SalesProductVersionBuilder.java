...
public class SalesProductVersionBuilder {
  ...
  public SalesProductVersionBuilder(final IRI iri) {
    salesProductVersion =
        SpatioTemporalExtentServices.createSalesProductVersion(iri);
  }
   ...
   * @return This builder.
   */
  public final SalesProductVersionBuilder
  ...
  public final SalesProductVersionBuilder member_Of_(
      final ClassOfClassOfSpatioTemporalExtent
          classOfClassOfSpatioTemporalExtent) {
    this.salesProductVersion.addValue(
   ...
   * SalesProductVersion} may be sold as a {@link SalesProduct}.
   *
   * @param salesProduct The SalesProduct.
   * @return This builder.
   */
  public final SalesProductVersionBuilder
  sold_As(final SalesProduct salesProduct) {
    this.salesProductVersion.addValue(SOLD_AS, salesProduct.getId());
    return this;
  }

  /**
   * A relationship type where a {@link SalesProductVersion} may have exactly
   * one successor.
   *
   ...
   */
  public final SalesProductVersionBuilder
  successor(final SalesProductVersion salesProductVersion) {
    this.salesProductVersion.addValue(SUCCESSOR, salesProductVersion.getId());
    return this;
  }

  /**
   * Returns an instance of SalesProductVersion created from the properties set
   * on this builder.
   *
   * @return The built SalesProductVersion.
   * @throws HqdmException If the SalesProductVersion is missing any mandatory
   *     properties.
   */
