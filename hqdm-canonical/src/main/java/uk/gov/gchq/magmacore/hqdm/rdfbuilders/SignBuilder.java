...
public class SignBuilder {
   ...
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} relationship
   * type where a
   * {@link Sign} is a {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF}
   * one or more
   * {@link Pattern}.
   *
  ...
  /**
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PARTICIPANT_IN}
   * relationship type where a
   * {@link Sign} is a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PARTICIPANT_IN} one or more
   ...
   */
  public final SignBuilder
  participant_In_M(final RepresentationBySign representationBySign) {
  ...
  /**
   * Returns an instance of Sign created from the properties set on this
   * builder.
   *
  ...
  public Sign build() throws HqdmException {
    ...
    if (this.sign.hasValue(ENDING) && this.sign.values(ENDING).isEmpty()) {
    ...
    if (this.sign.hasValue(PART__OF) && this.sign.values(PART__OF).isEmpty()) {
