...
public class SociallyConstructedActivityBuilder {
  ...
  public SociallyConstructedActivityBuilder(final IRI iri) {
    sociallyConstructedActivity =
        SpatioTemporalExtentServices.createSociallyConstructedActivity(iri);
  }
   ...
   * @return This builder.
   */
  public final SociallyConstructedActivityBuilder
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.sociallyConstructedActivity.addValue(CONSISTS__OF,
                                              spatioTemporalExtent.getId());
    return this;
  }
  ...
  consists_Of_Participant(final Participant participant) {
    this.sociallyConstructedActivity.addValue(CONSISTS_OF_PARTICIPANT,
                                              participant.getId());
    return this;
  }
  ...
  public final SociallyConstructedActivityBuilder member_Of(
      final ClassOfSociallyConstructedActivity
          classOfSociallyConstructedActivity) {
    this.sociallyConstructedActivity.addValue(
  ...
  member_Of_Kind_M(final KindOfActivity kindOfActivity) {
    this.sociallyConstructedActivity.addValue(MEMBER_OF_KIND,
                                              kindOfActivity.getId());
    this.sociallyConstructedActivity.addValue(RDFS.RDF_TYPE,
                                              kindOfActivity.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.sociallyConstructedActivity.addValue(PART__OF,
                                              spatioTemporalExtent.getId());
    return this;
  }
   ...
   */
  public final SociallyConstructedActivityBuilder
  part_Of(final ReachingAgreement reachingAgreement) {
    this.sociallyConstructedActivity.addValue(PART_OF,
                                              reachingAgreement.getId());
    return this;
  }
  ...
  part_Of_(final AgreementExecution agreementExecution) {
    this.sociallyConstructedActivity.addValue(PART_OF_,
  ...
  /**
   * A relationship type where an {@link Activity} may reference one or more
   * {@link Thing}.
   *
   * @param thing The Thing.
   * @return This builder.
  ...
  temporal_Part_Of(final Individual individual) {
    this.sociallyConstructedActivity.addValue(TEMPORAL_PART_OF,
                                              individual.getId());
    return this;
  }

  /**
   * Returns an instance of SociallyConstructedActivity created from the
   * properties set on this builder.
   *
   * @return The built SociallyConstructedActivity.
   * @throws HqdmException If the SociallyConstructedActivity is missing any
