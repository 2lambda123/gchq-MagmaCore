...
public class SociallyConstructedObjectBuilder {
  ...
  public SociallyConstructedObjectBuilder(final IRI iri) {
    sociallyConstructedObject =
        SpatioTemporalExtentServices.createSociallyConstructedObject(iri);
  }
   ...
   * @return This builder.
   */
  public final SociallyConstructedObjectBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.sociallyConstructedObject.addValue(AGGREGATED_INTO,
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.sociallyConstructedObject.addValue(CONSISTS__OF,
                                            spatioTemporalExtent.getId());
    return this;
  }
   ...
   *
   * @param classOfSociallyConstructedObject The
  ...
  public final SociallyConstructedObjectBuilder member_Of(
    ...
    this.sociallyConstructedObject.addValue(
        MEMBER_OF, classOfSociallyConstructedObject.getId());
    return this;
  }
  ...
  public final SociallyConstructedObjectBuilder member_Of_Kind(
    ...
    this.sociallyConstructedObject.addValue(
        MEMBER_OF_KIND, kindOfSociallyConstructedObject.getId());
    this.sociallyConstructedObject.addValue(
        RDFS.RDF_TYPE, kindOfSociallyConstructedObject.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.sociallyConstructedObject.addValue(PART__OF,
                                            spatioTemporalExtent.getId());
    return this;
  }
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.sociallyConstructedObject.addValue(PART_OF_POSSIBLE_WORLD,
                                            possibleWorld.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of SociallyConstructedObject created from the
   * properties set on this builder.
   *
   * @return The built SociallyConstructedObject.
   * @throws HqdmException If the SociallyConstructedObject is missing any
