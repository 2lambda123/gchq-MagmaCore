...
public class SpatioTemporalExtentBuilder {
  ...
  public SpatioTemporalExtentBuilder(final IRI iri) {
    spatioTemporalExtent =
        SpatioTemporalExtentServices.createSpatioTemporalExtent(iri);
  }
   ...
   * @return This builder.
   */
  public final SpatioTemporalExtentBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.spatioTemporalExtent.addValue(AGGREGATED_INTO,
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.spatioTemporalExtent.addValue(CONSISTS__OF,
                                       spatioTemporalExtent.getId());
    return this;
  }
  ...
  member_Of(final ClassOfSpatioTemporalExtent classOfSpatioTemporalExtent) {
    this.spatioTemporalExtent.addValue(MEMBER_OF,
  ...
  /**
   * An {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#AGGREGATED_INTO}relationship type
   * where a
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.spatioTemporalExtent.addValue(PART_OF_POSSIBLE_WORLD,
                                       possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.spatioTemporalExtent.addValue(TEMPORAL__PART_OF,
                                       spatioTemporalExtent.getId());
    return this;
  }

  /**
   * Returns an instance of SpatioTemporalExtent created from the properties set
   * on this builder.
   *
   * @return The built SpatioTemporalExtent.
   * @throws HqdmException If the SpatioTemporalExtent is missing any mandatory
   *     properties.
   */
