...
public class StateBuilder {
   ...
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} {@link State} as well as
   * {@link Individual}. This applies to all subtypes of
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#TEMPORAL_PART_OF} that are
   * between a
  ...
  /**
   * Returns an instance of State created from the properties set on this
   * builder.
   *
  ...
  public State build() throws HqdmException {
    ...
    if (this.state.hasValue(ENDING) && this.state.values(ENDING).isEmpty()) {
