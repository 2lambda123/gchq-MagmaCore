...
public class StateOfActivityBuilder {
   ...
   * @return This builder.
   */
  public final StateOfActivityBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfActivity.addValue(AGGREGATED_INTO,
   ...
   * type where a
   * {@link StateOfActivity} may be a {@link
   ...
   */
  public final StateOfActivityBuilder
  member_Of(final ClassOfStateOfActivity classOfStateOfActivity) {
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.stateOfActivity.addValue(PART_OF_POSSIBLE_WORLD,
                                  possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfActivity.addValue(TEMPORAL__PART_OF,
                                  spatioTemporalExtent.getId());
    return this;
  }
   ...
   */
  public final StateOfActivityBuilder
  temporal_Part_Of(final Activity activity) {
    this.stateOfActivity.addValue(TEMPORAL_PART_OF, activity.getId());
    return this;
  }

  /**
   * Returns an instance of StateOfActivity created from the properties set on
   * this builder.
   *
   * @return The built StateOfActivity.
   * @throws HqdmException If the StateOfActivity is missing any mandatory
   *     properties.
   */
