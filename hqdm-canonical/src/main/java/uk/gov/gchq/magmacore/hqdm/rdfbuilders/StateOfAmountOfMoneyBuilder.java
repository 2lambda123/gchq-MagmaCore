...
public class StateOfAmountOfMoneyBuilder {
  ...
  public StateOfAmountOfMoneyBuilder(final IRI iri) {
    stateOfAmountOfMoney =
        SpatioTemporalExtentServices.createStateOfAmountOfMoney(iri);
  }
   ...
   * @return This builder.
   */
  public final StateOfAmountOfMoneyBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfAmountOfMoney.addValue(AGGREGATED_INTO,
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfAmountOfMoney.addValue(CONSISTS__OF,
                                       spatioTemporalExtent.getId());
    return this;
  }
   ...
   * type where a
   * {@link StateOfAmountOfMoney} may be a {@link
   ...
   */
  public final StateOfAmountOfMoneyBuilder
  member_Of(final ClassOfStateOfAmountOfMoney classOfStateOfAmountOfMoney) {
    this.stateOfAmountOfMoney.addValue(MEMBER_OF,
                                       classOfStateOfAmountOfMoney.getId());
    return this;
  }
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.stateOfAmountOfMoney.addValue(PART_OF_POSSIBLE_WORLD,
                                       possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfAmountOfMoney.addValue(TEMPORAL__PART_OF,
                                       spatioTemporalExtent.getId());
    return this;
  }
   ...
   */
  public final StateOfAmountOfMoneyBuilder
  temporal_Part_Of(final AmountOfMoney amountOfMoney) {
    this.stateOfAmountOfMoney.addValue(TEMPORAL_PART_OF, amountOfMoney.getId());
    return this;
  }

  /**
   * Returns an instance of StateOfAmountOfMoney created from the properties set
   * on this builder.
   *
   * @return The built StateOfAmountOfMoney.
   * @throws HqdmException If the StateOfAmountOfMoney is missing any mandatory
   *     properties.
   */
