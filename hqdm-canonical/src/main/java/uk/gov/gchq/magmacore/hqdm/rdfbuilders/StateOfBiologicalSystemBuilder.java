...
public class StateOfBiologicalSystemBuilder {
  ...
  public StateOfBiologicalSystemBuilder(final IRI iri) {
    stateOfBiologicalSystem =
        SpatioTemporalExtentServices.createStateOfBiologicalSystem(iri);
  }
   ...
   * @return This builder.
   */
  public final StateOfBiologicalSystemBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfBiologicalSystem.addValue(AGGREGATED_INTO,
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfBiologicalSystem.addValue(CONSISTS__OF,
                                          spatioTemporalExtent.getId());
    return this;
  }
  ...
  public final StateOfBiologicalSystemBuilder member_Of(
    ...
    this.stateOfBiologicalSystem.addValue(
        MEMBER_OF, classOfStateOfBiologicalSystem.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfBiologicalSystem.addValue(PART__OF,
                                          spatioTemporalExtent.getId());
    return this;
  }
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.stateOfBiologicalSystem.addValue(PART_OF_POSSIBLE_WORLD,
                                          possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfBiologicalSystem.addValue(TEMPORAL__PART_OF,
                                          spatioTemporalExtent.getId());
    return this;
  }
   ...
   */
  public final StateOfBiologicalSystemBuilder
  temporal_Part_Of(final BiologicalSystem biologicalSystem) {
    this.stateOfBiologicalSystem.addValue(TEMPORAL_PART_OF,
                                          biologicalSystem.getId());
    return this;
  }

  /**
   * Returns an instance of StateOfBiologicalSystem created from the properties
   * set on this builder.
   *
   * @return The built StateOfBiologicalSystem.
   * @throws HqdmException If the StateOfBiologicalSystem is missing any
