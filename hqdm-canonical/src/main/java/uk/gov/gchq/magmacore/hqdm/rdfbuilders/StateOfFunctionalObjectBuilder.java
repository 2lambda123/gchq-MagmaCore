...
public class StateOfFunctionalObjectBuilder {
  ...
  public StateOfFunctionalObjectBuilder(final IRI iri) {
    stateOfFunctionalObject =
        SpatioTemporalExtentServices.createStateOfFunctionalObject(iri);
  }
   ...
   * @return This builder.
   */
  public final StateOfFunctionalObjectBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfFunctionalObject.addValue(AGGREGATED_INTO,
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfFunctionalObject.addValue(CONSISTS__OF,
                                          spatioTemporalExtent.getId());
    return this;
  }
  ...
  public final StateOfFunctionalObjectBuilder member_Of(
    ...
    this.stateOfFunctionalObject.addValue(
        MEMBER_OF, classOfStateOfFunctionalObject.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfFunctionalObject.addValue(PART__OF,
                                          spatioTemporalExtent.getId());
    return this;
  }
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.stateOfFunctionalObject.addValue(PART_OF_POSSIBLE_WORLD,
                                          possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfFunctionalObject.addValue(TEMPORAL__PART_OF,
                                          spatioTemporalExtent.getId());
    return this;
  }
   ...
   */
  public final StateOfFunctionalObjectBuilder
  temporal_Part_Of(final FunctionalObject functionalObject) {
    this.stateOfFunctionalObject.addValue(TEMPORAL_PART_OF,
                                          functionalObject.getId());
    return this;
  }

  /**
   * Returns an instance of StateOfFunctionalObject created from the properties
   * set on this builder.
   *
   * @return The built StateOfFunctionalObject.
   * @throws HqdmException If the StateOfFunctionalObject is missing any
