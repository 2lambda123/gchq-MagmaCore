...
public class StateOfFunctionalSystemBuilder {
  ...
  public StateOfFunctionalSystemBuilder(final IRI iri) {
    stateOfFunctionalSystem =
        SpatioTemporalExtentServices.createStateOfFunctionalSystem(iri);
  }
   ...
   * @return This builder.
   */
  public final StateOfFunctionalSystemBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfFunctionalSystem.addValue(AGGREGATED_INTO,
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfFunctionalSystem.addValue(CONSISTS__OF,
                                          spatioTemporalExtent.getId());
    return this;
  }
  ...
  public final StateOfFunctionalSystemBuilder member_Of(
    ...
    this.stateOfFunctionalSystem.addValue(
        MEMBER_OF, classOfStateOfFunctionalSystem.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfFunctionalSystem.addValue(PART__OF,
                                          spatioTemporalExtent.getId());
    return this;
  }
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.stateOfFunctionalSystem.addValue(PART_OF_POSSIBLE_WORLD,
                                          possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfFunctionalSystem.addValue(TEMPORAL__PART_OF,
                                          spatioTemporalExtent.getId());
    return this;
  }
   ...
   */
  public final StateOfFunctionalSystemBuilder
  temporal_Part_Of(final FunctionalSystem functionalSystem) {
    this.stateOfFunctionalSystem.addValue(TEMPORAL_PART_OF,
                                          functionalSystem.getId());
    return this;
  }

  /**
   * Returns an instance of StateOfFunctionalSystem created from the properties
   * set on this builder.
   *
   * @return The built StateOfFunctionalSystem.
   * @throws HqdmException If the StateOfFunctionalSystem is missing any
