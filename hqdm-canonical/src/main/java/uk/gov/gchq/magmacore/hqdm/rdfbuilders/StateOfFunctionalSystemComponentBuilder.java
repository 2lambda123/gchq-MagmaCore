...
public class StateOfFunctionalSystemComponentBuilder {
  ...
  private final StateOfFunctionalSystemComponent
   ...
   * @return This builder.
   */
  public final StateOfFunctionalSystemComponentBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfFunctionalSystemComponent.addValue(
  ...
  public final StateOfFunctionalSystemComponentBuilder
  member_Of(final ClassOfStateOfFunctionalSystemComponent
                classOfStateOfFunctionalSystemComponent) {
    this.stateOfFunctionalSystemComponent.addValue(
        MEMBER_OF, classOfStateOfFunctionalSystemComponent.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of StateOfFunctionalSystemComponent created from the
   * properties set on this builder.
   *
   * @return The built StateOfFunctionalSystemComponent.
   * @throws HqdmException If the StateOfFunctionalSystemComponent is missing
   *     any mandatory
   *                       properties.
   */
  public StateOfFunctionalSystemComponent build() throws HqdmException {
    if (this.stateOfFunctionalSystemComponent.hasValue(AGGREGATED_INTO) &&
        this.stateOfFunctionalSystemComponent.values(AGGREGATED_INTO)
            .isEmpty()) {
