...
public class StateOfLanguageCommunityBuilder {
  ...
  public StateOfLanguageCommunityBuilder(final IRI iri) {
    stateOfLanguageCommunity =
        SpatioTemporalExtentServices.createStateOfLanguageCommunity(iri);
  }
   ...
   * @return This builder.
   */
  public final StateOfLanguageCommunityBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfLanguageCommunity.addValue(AGGREGATED_INTO,
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfLanguageCommunity.addValue(CONSISTS__OF,
                                           spatioTemporalExtent.getId());
    return this;
  }
  ...
  member_Of(final ClassOfStateOfOrganization classOfStateOfOrganization) {
    this.stateOfLanguageCommunity.addValue(MEMBER_OF,
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfLanguageCommunity.addValue(PART__OF,
                                           spatioTemporalExtent.getId());
    return this;
  }
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.stateOfLanguageCommunity.addValue(PART_OF_POSSIBLE_WORLD,
                                           possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfLanguageCommunity.addValue(TEMPORAL__PART_OF,
                                           spatioTemporalExtent.getId());
    return this;
  }
  ...
  temporal_Part_Of(final LanguageCommunity languageCommunity) {
    this.stateOfLanguageCommunity.addValue(TEMPORAL_PART_OF,
                                           languageCommunity.getId());
    return this;
  }

  /**
   * Returns an instance of StateOfLanguageCommunity created from the properties
   * set on this builder.
   *
   * @return The built StateOfLanguageCommunity.
   * @throws HqdmException If the StateOfLanguageCommunity is missing any
