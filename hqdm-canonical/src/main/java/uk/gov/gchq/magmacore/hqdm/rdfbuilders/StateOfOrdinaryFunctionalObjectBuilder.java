...
public class StateOfOrdinaryFunctionalObjectBuilder {
  ...
  public StateOfOrdinaryFunctionalObjectBuilder(final IRI iri) {
    stateOfOrdinaryFunctionalObject =
        SpatioTemporalExtentServices.createStateOfOrdinaryFunctionalObject(iri);
  }
   ...
   * @return This builder.
   */
  public final StateOfOrdinaryFunctionalObjectBuilder
   ...
   *
   * @param classOfStateOfOrdinaryFunctionalObject The
   *     ClassOfStateOfOrdinaryFunctionalObject.
   * @return This builder.
   */
  @SuppressWarnings("LineLength")
  public final StateOfOrdinaryFunctionalObjectBuilder
  member_Of(final ClassOfStateOfOrdinaryFunctionalObject
                classOfStateOfOrdinaryFunctionalObject) {
    this.stateOfOrdinaryFunctionalObject.addValue(
        MEMBER_OF, classOfStateOfOrdinaryFunctionalObject.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfOrdinaryFunctionalObject.addValue(PART__OF,
                                                  spatioTemporalExtent.getId());
    return this;
  }
   ...
   * relationship type where a
   * {@link StateOfOrdinaryFunctionalObject} may be a temporal part of one or
   * more
   ...
   */
  public final StateOfOrdinaryFunctionalObjectBuilder
  temporal_Part_Of(final OrdinaryFunctionalObject ordinaryFunctionalObject) {
    this.stateOfOrdinaryFunctionalObject.addValue(
        TEMPORAL_PART_OF, ordinaryFunctionalObject.getId());
    return this;
  }

  /**
   * Returns an instance of StateOfOrdinaryFunctionalObject created from the
   * properties set on this builder.
   *
   * @return The built StateOfOrdinaryFunctionalObject.
   * @throws HqdmException If the StateOfOrdinaryFunctionalObject is missing any
  ...
  public StateOfOrdinaryFunctionalObject build() throws HqdmException {
    if (this.stateOfOrdinaryFunctionalObject.hasValue(AGGREGATED_INTO) &&
        this.stateOfOrdinaryFunctionalObject.values(AGGREGATED_INTO)
            .isEmpty()) {
