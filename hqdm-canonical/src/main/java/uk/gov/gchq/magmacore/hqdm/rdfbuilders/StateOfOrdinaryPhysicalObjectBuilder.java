...
public class StateOfOrdinaryPhysicalObjectBuilder {
  ...
  public StateOfOrdinaryPhysicalObjectBuilder(final IRI iri) {
    stateOfOrdinaryPhysicalObject =
        SpatioTemporalExtentServices.createStateOfOrdinaryPhysicalObject(iri);
  }
   ...
   * @return This builder.
   */
  public final StateOfOrdinaryPhysicalObjectBuilder
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfOrdinaryPhysicalObject.addValue(CONSISTS__OF,
                                                spatioTemporalExtent.getId());
    return this;
  }
   ...
   *
   * @param classOfStateOfOrdinaryPhysicalObject The
   *     ClassOfStateOfOrdinaryPhysicalObject.
   * @return This builder.
   */
  public final StateOfOrdinaryPhysicalObjectBuilder member_Of(
      final ClassOfStateOfOrdinaryPhysicalObject
          classOfStateOfOrdinaryPhysicalObject) {
    this.stateOfOrdinaryPhysicalObject.addValue(
        MEMBER_OF, classOfStateOfOrdinaryPhysicalObject.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfOrdinaryPhysicalObject.addValue(PART__OF,
                                                spatioTemporalExtent.getId());
    return this;
  }
   ...
   */
  public final StateOfOrdinaryPhysicalObjectBuilder
  temporal_Part_Of(final OrdinaryPhysicalObject ordinaryPhysicalObject) {
  ...
  /**
   * Returns an instance of StateOfOrdinaryPhysicalObject created from the
   * properties set on this builder.
   *
   * @return The built StateOfOrdinaryPhysicalObject.
   * @throws HqdmException If the StateOfOrdinaryPhysicalObject is missing any
  ...
  public StateOfOrdinaryPhysicalObject build() throws HqdmException {
    ...
    if (this.stateOfOrdinaryPhysicalObject.hasValue(TEMPORAL__PART_OF) &&
        this.stateOfOrdinaryPhysicalObject.values(TEMPORAL__PART_OF)
            .isEmpty()) {
