...
public class StateOfOrganizationBuilder {
  ...
  public StateOfOrganizationBuilder(final IRI iri) {
    stateOfOrganization =
        SpatioTemporalExtentServices.createStateOfOrganization(iri);
  }
   ...
   * @return This builder.
   */
  public final StateOfOrganizationBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfOrganization.addValue(AGGREGATED_INTO,
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfOrganization.addValue(CONSISTS__OF,
                                      spatioTemporalExtent.getId());
    return this;
  }
   ...
   * type where a
   * {@link StateOfOrganization} may be a {@link
  ...
  member_Of(final ClassOfStateOfOrganization classOfStateOfOrganization) {
    this.stateOfOrganization.addValue(MEMBER_OF,
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.stateOfOrganization.addValue(PART_OF_POSSIBLE_WORLD,
                                      possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfOrganization.addValue(TEMPORAL__PART_OF,
                                      spatioTemporalExtent.getId());
    return this;
  }
   ...
   */
  public final StateOfOrganizationBuilder
  temporal_Part_Of(final Organization organization) {
    this.stateOfOrganization.addValue(TEMPORAL_PART_OF, organization.getId());
    return this;
  }

  /**
   * Returns an instance of StateOfOrganization created from the properties set
   * on this builder.
   *
   * @return The built StateOfOrganization.
   * @throws HqdmException If the StateOfOrganization is missing any mandatory
   *     properties.
   */
