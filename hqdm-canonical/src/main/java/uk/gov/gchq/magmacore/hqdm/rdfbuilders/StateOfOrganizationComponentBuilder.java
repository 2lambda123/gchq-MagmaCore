...
public class StateOfOrganizationComponentBuilder {
  ...
  public StateOfOrganizationComponentBuilder(final IRI iri) {
    stateOfOrganizationComponent =
        SpatioTemporalExtentServices.createStateOfOrganizationComponent(iri);
  }
   ...
   * @return This builder.
   */
  public final StateOfOrganizationComponentBuilder
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfOrganizationComponent.addValue(CONSISTS__OF,
                                               spatioTemporalExtent.getId());
    return this;
  }
   ...
   *
   * @param classOfStateOfOrganizationComponent The
   *     ClassOfStateOfOrganizationComponent.
   * @return This builder.
   */
  public final StateOfOrganizationComponentBuilder member_Of(
      final ClassOfStateOfOrganizationComponent
          classOfStateOfOrganizationComponent) {
    this.stateOfOrganizationComponent.addValue(
        MEMBER_OF, classOfStateOfOrganizationComponent.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfOrganizationComponent.addValue(PART__OF,
                                               spatioTemporalExtent.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of StateOfOrganizationComponent created from the
   * properties set on this builder.
   *
   * @return The built StateOfOrganizationComponent.
   * @throws HqdmException If the StateOfOrganizationComponent is missing any
