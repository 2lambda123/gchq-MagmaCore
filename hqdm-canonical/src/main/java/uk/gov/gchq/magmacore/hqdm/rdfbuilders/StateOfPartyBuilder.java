...
public class StateOfPartyBuilder {
   ...
   * @return This builder.
   */
  public final StateOfPartyBuilder
   ...
   * type where a
   * {@link StateOfParty} may be a {@link
  ...
  /**
   * Returns an instance of StateOfParty created from the properties set on this
   * builder.
   *
   * @return The built StateOfParty.
   * @throws HqdmException If the StateOfParty is missing any mandatory
   *     properties.
   */
