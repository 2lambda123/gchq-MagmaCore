...
public class StateOfPersonBuilder {
   ...
   * @return This builder.
   */
  public final StateOfPersonBuilder
   ...
   * type where a
   * {@link StateOfPerson} may be a {@link
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfPerson.addValue(TEMPORAL__PART_OF,
  ...
  /**
   * Returns an instance of StateOfPerson created from the properties set on
   * this builder.
   *
   * @return The built StateOfPerson.
   * @throws HqdmException If the StateOfPerson is missing any mandatory
   *     properties.
   */
