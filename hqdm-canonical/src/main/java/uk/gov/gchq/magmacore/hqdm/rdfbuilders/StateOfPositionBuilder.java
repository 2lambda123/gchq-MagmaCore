...
public class StateOfPositionBuilder {
   ...
   * @return This builder.
   */
  public final StateOfPositionBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfPosition.addValue(AGGREGATED_INTO,
   ...
   * type where a
   * {@link StateOfPosition} may be a {@link
   ...
   */
  public final StateOfPositionBuilder
  member_Of(final ClassOfStateOfPosition classOfStateOfPosition) {
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.stateOfPosition.addValue(PART_OF_POSSIBLE_WORLD,
                                  possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfPosition.addValue(TEMPORAL__PART_OF,
                                  spatioTemporalExtent.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of StateOfPosition created from the properties set on
   * this builder.
   *
   * @return The built StateOfPosition.
   * @throws HqdmException If the StateOfPosition is missing any mandatory
   *     properties.
   */
