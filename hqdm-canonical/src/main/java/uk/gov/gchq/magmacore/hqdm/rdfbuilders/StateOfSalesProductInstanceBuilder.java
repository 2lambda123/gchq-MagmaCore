...
public class StateOfSalesProductInstanceBuilder {
  ...
  public StateOfSalesProductInstanceBuilder(final IRI iri) {
    stateOfSalesProductInstance =
        SpatioTemporalExtentServices.createStateOfSalesProductInstance(iri);
  }
   ...
   * @return This builder.
   */
  public final StateOfSalesProductInstanceBuilder
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfSalesProductInstance.addValue(CONSISTS__OF,
                                              spatioTemporalExtent.getId());
    return this;
  }
   ...
   *
   * @param classOfStateOfSalesProductInstance The
   *     ClassOfStateOfSalesProductInstance.
   * @return This builder.
   */
  public final StateOfSalesProductInstanceBuilder member_Of(
      final ClassOfStateOfSalesProductInstance
          classOfStateOfSalesProductInstance) {
    this.stateOfSalesProductInstance.addValue(
        MEMBER_OF, classOfStateOfSalesProductInstance.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfSalesProductInstance.addValue(PART__OF,
                                              spatioTemporalExtent.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of StateOfSalesProductInstance created from the
   * properties set on this builder.
   *
   * @return The built StateOfSalesProductInstance.
   * @throws HqdmException If the StateOfSalesProductInstance is missing any
