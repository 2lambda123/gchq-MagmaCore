...
public class StateOfSignBuilder {
   ...
   * @return This builder.
   */
  public final StateOfSignBuilder
   ...
   * type where a
   * {@link StateOfSign} may be a {@link
   ...
   */
  public final StateOfSignBuilder
  member_Of(final ClassOfStateOfSign classOfStateOfSign) {
  ...
  /**
   * Returns an instance of StateOfSign created from the properties set on this
   * builder.
   *
   * @return The built StateOfSign.
   * @throws HqdmException If the StateOfSign is missing any mandatory
   *     properties.
   */
