...
public class StateOfSociallyConstructedActivityBuilder {
  ...
  private final StateOfSociallyConstructedActivity
   ...
   * @return This builder.
   */
  public final StateOfSociallyConstructedActivityBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfSociallyConstructedActivity.addValue(
   ...
   * type where a
   * {@link uk.gov.gchq.magmacore.hqdm.model.StateOfSociallyConstructedObject}
   * may be a
  ...
  public final StateOfSociallyConstructedActivityBuilder
  member_Of(final ClassOfStateOfSociallyConstructedObject
                classOfStateOfSociallyConstructedObject) {
    this.stateOfSociallyConstructedActivity.addValue(
        MEMBER_OF, classOfStateOfSociallyConstructedObject.getId());
    return this;
  }
   ...
   */
  public final StateOfSociallyConstructedActivityBuilder
  temporal_Part_Of(final SociallyConstructedObject sociallyConstructedObject) {
    this.stateOfSociallyConstructedActivity.addValue(
        TEMPORAL_PART_OF, sociallyConstructedObject.getId());
    return this;
  }

  /**
   * Returns an instance of StateOfSociallyConstructedActivity created from the
   * properties set on this builder.
   *
   * @return The built StateOfSociallyConstructedActivity.
   * @throws HqdmException If the StateOfSociallyConstructedActivity is missing
   *     any mandatory
   *                       properties.
   */
  public StateOfSociallyConstructedActivity build() throws HqdmException {
    if (this.stateOfSociallyConstructedActivity.hasValue(AGGREGATED_INTO) &&
        this.stateOfSociallyConstructedActivity.values(AGGREGATED_INTO)
            .isEmpty()) {
