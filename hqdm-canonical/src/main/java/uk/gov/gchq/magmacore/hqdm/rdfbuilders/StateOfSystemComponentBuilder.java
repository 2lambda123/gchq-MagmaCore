...
public class StateOfSystemComponentBuilder {
  ...
  public StateOfSystemComponentBuilder(final IRI iri) {
    stateOfSystemComponent =
        SpatioTemporalExtentServices.createStateOfSystemComponent(iri);
  }
   ...
   * @return This builder.
   */
  public final StateOfSystemComponentBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfSystemComponent.addValue(AGGREGATED_INTO,
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfSystemComponent.addValue(CONSISTS__OF,
                                         spatioTemporalExtent.getId());
    return this;
  }
   ...
   * type where a
   * {@link StateOfSystemComponent} may be a {@link
   ...
   */
  public final StateOfSystemComponentBuilder
  member_Of(final ClassOfStateOfSystemComponent classOfStateOfSystemComponent) {
    this.stateOfSystemComponent.addValue(MEMBER_OF,
                                         classOfStateOfSystemComponent.getId());
    return this;
  }
  ...
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfSystemComponent.addValue(PART__OF,
                                         spatioTemporalExtent.getId());
    return this;
  }
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.stateOfSystemComponent.addValue(PART_OF_POSSIBLE_WORLD,
                                         possibleWorld.getId());
    return this;
  }
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.stateOfSystemComponent.addValue(TEMPORAL__PART_OF,
                                         spatioTemporalExtent.getId());
    return this;
  }
   ...
   */
  public final StateOfSystemComponentBuilder
  temporal_Part_Of(final SystemComponent systemComponent) {
    this.stateOfSystemComponent.addValue(TEMPORAL_PART_OF,
                                         systemComponent.getId());
    return this;
  }

  /**
   * Returns an instance of StateOfSystemComponent created from the properties
   * set on this builder.
   *
   * @return The built StateOfSystemComponent.
   * @throws HqdmException If the StateOfSystemComponent is missing any
