...
public class SystemBuilder {
  ...
  /**
   * Returns an instance of System created from the properties set on this
   * builder.
   *
  ...
  public System build() throws HqdmException {
    ...
    if (this.system.hasValue(ENDING) && this.system.values(ENDING).isEmpty()) {
