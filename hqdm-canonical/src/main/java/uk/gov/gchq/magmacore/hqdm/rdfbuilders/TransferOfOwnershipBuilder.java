...
public class TransferOfOwnershipBuilder {
  ...
  public TransferOfOwnershipBuilder(final IRI iri) {
    transferOfOwnership =
        SpatioTemporalExtentServices.createTransferOfOwnership(iri);
  }
   ...
   * @return This builder.
   */
  public final TransferOfOwnershipBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.transferOfOwnership.addValue(AGGREGATED_INTO,
  ...
  causes_Beginning_M(final BeginningOfOwnership beginningOfOwnership) {
    this.transferOfOwnership.addValue(CAUSES_BEGINNING,
                                      beginningOfOwnership.getId());
    return this;
  }

  /**
   * A causes relationship type where a {@link TransferOfOwnership} causes
   * exactly one
  ...
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.transferOfOwnership.addValue(CONSISTS__OF,
                                      spatioTemporalExtent.getId());
    return this;
  }
   ...
   * relationship type where a {@link TransferOfOwnership}
  ...
  consists_Of_Participant(final Transferor transferor) {
    this.transferOfOwnership.addValue(CONSISTS_OF_PARTICIPANT,
                                      transferor.getId());
    return this;
  }
  ...
  consists_Of_Participant_(final Transferee transferee) {
    this.transferOfOwnership.addValue(CONSISTS_OF_PARTICIPANT_,
                                      transferee.getId());
    return this;
  }
  ...
  public final TransferOfOwnershipBuilder member_Of(
      final ClassOfSociallyConstructedActivity
          classOfSociallyConstructedActivity) {
    this.transferOfOwnership.addValue(
   ...
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} relationship type
   * where a
   * {@link TransferOfOwnership} may be {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} not more than one {@link
  ...
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.transferOfOwnership.addValue(PART_OF_POSSIBLE_WORLD,
                                      possibleWorld.getId());
    return this;
  }

  /**
   * A references relationship type where a {@link TransferOfOwnership}
  ...
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.transferOfOwnership.addValue(TEMPORAL__PART_OF,
                                      spatioTemporalExtent.getId());
    return this;
  }
  ...
  /**
   * Returns an instance of TransferOfOwnership created from the properties set
   * on this builder.
   *
   * @return The built TransferOfOwnership.
   * @throws HqdmException If the TransferOfOwnership is missing any mandatory
   *     properties.
   */
