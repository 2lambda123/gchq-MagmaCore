...
public class TransferOfOwnershipOfMoneyBuilder {
  ...
  public TransferOfOwnershipOfMoneyBuilder(final IRI iri) {
    transferOfOwnershipOfMoney =
        SpatioTemporalExtentServices.createTransferOfOwnershipOfMoney(iri);
  }

  /**
   * A relationship type where a {@link SpatioTemporalExtent} may be aggregated
   * into one or more others. <p> Note: This has the same meaning as, but
   * different representation to, the
   ...
   * @return This builder.
   */
  public final TransferOfOwnershipOfMoneyBuilder
  aggregated_Into(final SpatioTemporalExtent spatioTemporalExtent) {
    this.transferOfOwnershipOfMoney.addValue(AGGREGATED_INTO,
                                             spatioTemporalExtent.getId());
    return this;
  }

  /**
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} relationship type
   * where a
   * {@link SpatioTemporalExtent} has exactly one {@link Event} that is its
   * beginning.
   *
  ...
  /**
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#CAUSES} relationship type
   * where a
   * {@link uk.gov.gchq.magmacore.hqdm.model.TransferOfOwnership}
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#CAUSES} exactly one {@link
   ...
   */
  public final TransferOfOwnershipOfMoneyBuilder
  causes_Beginning_M(final BeginningOfOwnership beginningOfOwnership) {
   ...
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#CAUSES} relationship type
   * where a
   * {@link uk.gov.gchq.magmacore.hqdm.model.TransferOfOwnership} causes exactly
   * one
   ...
   */
  public final TransferOfOwnershipOfMoneyBuilder
  causes_Ending_M(final EndingOfOwnership endingOfOwnership) {
    this.transferOfOwnershipOfMoney.addValue(CAUSES_ENDING,
                                             endingOfOwnership.getId());
    return this;
  }

  /**
   * A relationship type where a {@link SpatioTemporalExtent} may consist of one
   * or more others.
   *
   * <p>
   * Note: This is the inverse of {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART__OF}.
   * </p>
   *
   * @param spatioTemporalExtent The SpatioTemporalExtent.
   * @return This builder.
   */
  public final TransferOfOwnershipOfMoneyBuilder
  consists__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.transferOfOwnershipOfMoney.addValue(CONSISTS__OF,
                                             spatioTemporalExtent.getId());
    return this;
  }

  /**
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#CONSISTS_OF} relationship
   * type where an
   * {@link Activity} may {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#CONSISTS_OF} one or more other
   * {@link Activity}.
   *
   ...
   */
  public final TransferOfOwnershipOfMoneyBuilder
  consists_Of(final Activity activity) {
   ...
   * relationship type where a {@link
   * uk.gov.gchq.magmacore.hqdm.model.TransferOfOwnership}
   ...
   */
  public final TransferOfOwnershipOfMoneyBuilder
  consists_Of_Participant(final Transferor transferor) {
    this.transferOfOwnershipOfMoney.addValue(CONSISTS_OF_PARTICIPANT,
                                             transferor.getId());
    return this;
  }
   ...
   */
  public final TransferOfOwnershipOfMoneyBuilder
  consists_Of_Participant_(final Transferee transferee) {
    this.transferOfOwnershipOfMoney.addValue(CONSISTS_OF_PARTICIPANT_,
                                             transferee.getId());
    return this;
  }

  /**
   * A relationship type where an {@link Activity} may determine one or more
   * {@link Thing} to be the case.
   *
  ...
  /**
   * A relationship type where a {@link Thing} may be a member of one or more
   * {@link Class}.
   *
   ...
   * type where a
   * {@link uk.gov.gchq.magmacore.hqdm.model.SociallyConstructedActivity} may be
   * a
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF} one or more
   * {@link ClassOfSociallyConstructedActivity}.
   *
   * @param classOfSociallyConstructedActivity The
   *     ClassOfSociallyConstructedActivity.
   * @return This builder.
   */
  public final TransferOfOwnershipOfMoneyBuilder member_Of(
      final ClassOfSociallyConstructedActivity
          classOfSociallyConstructedActivity) {
    this.transferOfOwnershipOfMoney.addValue(
        MEMBER_OF, classOfSociallyConstructedActivity.getId());
    return this;
  }

  /**
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF_KIND}
   * relationship type where each
   * {@link Activity} is a {@link
   ...
   */
  public final TransferOfOwnershipOfMoneyBuilder
  member_Of_Kind_M(final KindOfActivity kindOfActivity) {
    this.transferOfOwnershipOfMoney.addValue(MEMBER_OF_KIND,
                                             kindOfActivity.getId());
    this.transferOfOwnershipOfMoney.addValue(RDFS.RDF_TYPE,
                                             kindOfActivity.getId());
    return this;
  }

  /**
   * An {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#AGGREGATED_INTO}
   * relationship type where a
   * {@link SpatioTemporalExtent} may be part of another and the whole has
   ...
   */
  public final TransferOfOwnershipOfMoneyBuilder
  part__Of(final SpatioTemporalExtent spatioTemporalExtent) {
    this.transferOfOwnershipOfMoney.addValue(PART__OF,
                                             spatioTemporalExtent.getId());
    return this;
  }
   ...
   */
  public final TransferOfOwnershipOfMoneyBuilder
  part_Of(final ExchangeOfGoodsAndMoney exchangeOfGoodsAndMoney) {
    this.transferOfOwnershipOfMoney.addValue(PART_OF,
                                             exchangeOfGoodsAndMoney.getId());
    return this;
  }
   ...
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} one or more {@link
   * AgreementExecution}.
   *
   ...
   */
  public final TransferOfOwnershipOfMoneyBuilder
  part_Of_(final AgreementExecution agreementExecution) {
    this.transferOfOwnershipOfMoney.addValue(PART_OF_,
                                             agreementExecution.getId());
    return this;
  }
   ...
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} relationship type
   * where a
   * {@link SpatioTemporalExtent} may be {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} one or more {@link
   * PossibleWorld}.
   *
   * <p>
   * Note: The relationship is optional because a {@link PossibleWorld} is not
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PART_OF} any other {@link
   ...
   */
  public final TransferOfOwnershipOfMoneyBuilder
  part_Of_Possible_World_M(final PossibleWorld possibleWorld) {
    this.transferOfOwnershipOfMoney.addValue(PART_OF_POSSIBLE_WORLD,
                                             possibleWorld.getId());
    return this;
  }

  /**
   * A references relationship type where a {@link
   * TransferOfOwnershipOfMoney}references exactly one
   * {@link MoneyAsset}.
   *
   ...
   */
  public final TransferOfOwnershipOfMoneyBuilder
  references_M(final MoneyAsset moneyAsset) {
   ...
   */
  public final TransferOfOwnershipOfMoneyBuilder
  temporal__Part_Of(final SpatioTemporalExtent spatioTemporalExtent) {
  ...
  /**
   * A {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#TEMPORAL_PART_OF}
   * relationship type where a
   * {@link uk.gov.gchq.magmacore.hqdm.model.State} may be a
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#TEMPORAL_PART_OF} one or
   * more {@link Individual}.
   *
   * <p>
   * Note: The relationship is optional because an {@link Individual} is not
   * necessarily a
   * {@link uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#TEMPORAL_PART_OF} another
   * {@link Individual}, yet is a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#MEMBER_OF}
   * {@link uk.gov.gchq.magmacore.hqdm.model.State} as well as {@link
   * Individual}. This applies to all subtypes of {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#TEMPORAL_PART_OF} that are between
   * a
   ...
   */
  public final TransferOfOwnershipOfMoneyBuilder
  temporal_Part_Of(final Individual individual) {
    this.transferOfOwnershipOfMoney.addValue(TEMPORAL_PART_OF,
                                             individual.getId());
    return this;
  }

  /**
   * Returns an instance of TransferOfOwnershipOfMoney created from the
   * properties set on this builder.
   *
   * @return The built TransferOfOwnershipOfMoney.
   * @throws HqdmException If the TransferOfOwnershipOfMoney is missing any
