...
public class TransfereeBuilder {
   ...
   * relationship type where a
   * {@link Transferee} is a {@link
   * uk.gov.gchq.magmacore.hqdm.rdf.iri.HQDM#PARTICIPANT_IN} one or more {@link
   * TransferOfOwnership}.
   *
  ...
  /**
   * Returns an instance of Transferee created from the properties set on this
   * builder.
   *
   * @return The built Transferee.
   * @throws HqdmException If the Transferee is missing any mandatory
   *     properties.
   */
